...
\- All Neighbours means all the neighbours from System Information
...
The decision what Relative North/East Values are included in this
...
Table 26: DGPS Correction Data
  ...
  DGPS Corrections          Satellite ID   6               \-\--     1 - 64       \-\--         N\_SAT     C         4.2.1.9
                            IODE           8               \-\--     0 - 239      \-\--                              
                            UDRE           2               \-\--     0 - 3        \-\--                              
...
^(1)^ = Positive range only)
  ...
  **Parameter**       **Bits**   **Resolution**   **Range**                   **Units**          **Occurrences**   **Presence**
  ...
  t~oc~               16^(1)^    2^4^             0 -- 604784                 seconds            1                 M
...
######## Annex A (informative): Overview of Broadcast Assistance for E-OTD and GPS
...
Based on the information in the broadcast message and the E-OTD
...
The SMSCB used for LCS uses the basic CBCH or extended CBCH. The support
...
######## Annex C (informative): Example of GPS Assistance Data Broadcast Message

This annex gives an example of how the information IE should be packed
into the GPS Assistance Data message. The example shown in table C.1
includes corrections for 12 satellites.

Table C.1: Example of a GPS Assistance Data (DGPS Correction) message
with 11 satellites

+-------+--------------+--------------+--------------+--------------+
| Octet | MSB          |              | LSB          |              |
+-------+--------------+--------------+--------------+--------------+
| 1     | Cipher       | Cipher Key   | Ciphering    |              |
|       | On/Off       | Flag         | Serial       |              |
|       |              |              | Number (MSB, |              |
|       |              |              | bits 15-10)  |              |
|       |              |              |              |              |
...
|       | Spare        |              |              |              |
+-------+--------------+--------------+--------------+--------------+
| 3     | BTS Clock    | BTS Clock    | GSM Time     | Ciphering    |
|       | Drift (bits  | Drift        | Present      | Serial       |
|       | 3-0)         | Present      |              | Number (bits |
|       |              |              |              | 1-0)         |
|       | or           |              |              |              |
|       |              |              |              | or           |
|       | Spare        |              |              |              |
...
|       | Spare        |              |              |              |
+-------+--------------+--------------+--------------+--------------+
| 12    | BN (MSB bits | TN (bits     | FN (LSB bits |              |
|       | 7 - 5)       | 3-0)         | 1--0)        |              |
|       |              |              |              |              |
|       | or           | or           | or           |              |
|       |              |              |              |              |
...
|       | (bits 8-1)   |              |              |              |
+-------+--------------+--------------+--------------+--------------+
| 16    | N\_SAT (bits | Correction   | GPS TOW (LSB |              |
|       | 3-0)         | S            | bit0)        |              |
|       |              | tatus/Health |              |              |
|       |              |              |              |              |
|       |              | (bits 2-0)   |              |              |
+-------+--------------+--------------+--------------+--------------+
| 17    | Satellite ID | UDRE (Sat 1) |              |              |
|       | (Sat 1)      |              |              |              |
+-------+--------------+--------------+--------------+--------------+
| 18    | IODE (Sat 1) |              |              |              |
+-------+--------------+--------------+--------------+--------------+
...
|       | -- 0)        |              |              |              |
+-------+--------------+--------------+--------------+--------------+
| 20    | PRC (Sat 1   | RRC (Sat 1   |              |              |
|       | -- MSBs, 7   | -- LSBs,     |              |              |
|       | -- 4)        | 3-0)         |              |              |
+-------+--------------+--------------+--------------+--------------+
| 21    | RRC (Sat 1   | Delta PRC    |              |              |
|       | -- LSBs, 7   | (Sat 1 -     |              |              |
|       | -- 4)        | LSBs, 3-0)   |              |              |
+-------+--------------+--------------+--------------+--------------+
| 22    | Delta PRC    | Delta RRC    |              |              |
|       | (Sat 1 -     | (Sat 1)      |              |              |
|       | MSBs, 7 --   |              |              |              |
|       | 4)           |              |              |              |
+-------+--------------+--------------+--------------+--------------+
...
|       | -- 0)        |              |              |              |
+-------+--------------+--------------+--------------+--------------+
| 80    | PRC (Sat 12  | RRC (Sat 12  |              |              |
|       | -- MSBs, 7   | -- LSBs,     |              |              |
|       | -- 4)        | 3-0)         |              |              |
+-------+--------------+--------------+--------------+--------------+
| 81    | RRC (Sat     | Delta PRC    |              |              |
|       | 12-- LSBs, 7 | (Sat 12 -    |              |              |
|       | -- 4)        | LSBs, 3-0)   |              |              |
+-------+--------------+--------------+--------------+--------------+
| 82    | Delta PRC    | Delta RRC    |              |              |
|       | (Sat 12 --   | (Sat 12)     |              |              |
|       | MSBs, 7 --   |              |              |              |
|       | 4)           |              |              |              |
+-------+--------------+--------------+--------------+--------------+
