...
notifyOccupancyLevelCrossed (M) 6.6.1.1 Definition 6.6.1.2 Input
...
|                      | determined.          |                      |
+----------------------+----------------------+----------------------+
| filter               | It specifies a       | Filter constraint    |
