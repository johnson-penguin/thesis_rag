...
\[19\] 3GPP TS 32.157: \"Telecommunication management; Integration
...
\[66\] 3GPP TS 32.122: \"Telecommunication management; Advanced Alarm
...
\[117\] 3GPP TS 32.502: \"Telecommunication management;
...
\[132\] 3GPP TS 32.642: \"Telecommunication management; Configuration
Management (CM); UTRAN network resources Integration Reference Point
...
\[148\] 3GPP TS 28.651: \"Telecommunication management; Universal
...
\[162\] 3GPP TS 28.673: \"Telecommunication management; Home Node B
(HNB) Subsystem (HNS) Network Resource Model (NRM) Integration Reference
Point (IRP); Solution Set (SS) definitions\".
...
\[177\] 3GPP TS 28.733: \"Telecommunication management; Transport
Network (TN) interface Network Resource Model (NRM) Integration
Reference Point (IRP); Solution Set (SS) definitions\".
...
\[191\] 3GPP TS 28.511: \"Telecommunication management; Configuration
Management (CM) for mobile networks that include virtualized network
...
\[206\] 3GPP TS 32.581: \"Telecommunication management; Home Node B
...
28-series IRPs (supporting FMC) consisting of 3-specification sets,
...
**Configuration Management (CM) for mobile networks that include
...
| ](http://www.3gpp.or | (TN) interface       | plan to apply        |
| g/ftp/Specs/html-inf | Network Resource     | network sharing      |
...
| .3gpp.org/ftp/Specs/ | management;          | modification         |
| html-info/32407.htm) | Performance          |                      |
|                      | Management (PM);     |                      |
|                      | Performance          |                      |
|                      | measurements; Core   |                      |
|                      | Network (CN) Circuit |                      |
...
|                      | format definition    |                      |
+----------------------+----------------------+----------------------+
| [32.436](http://www  | Telecommunication    | TBD                  |
| .3gpp.org/ftp/Specs/ | management;          |                      |
...
+----------------------+----------------------+----------------------+
| [32.450](http://www  | Key Performance      | TBD                  |
| .3gpp.org/ftp/Specs/ | Indicators (KPI) for |                      |
| html-info/32450.htm) | Evolved Universal    |                      |
|                      | Terrestrial Radio    |                      |
|                      | Access Network       |                      |
|                      | (E-UTRAN):           |                      |
|                      | Definitions          |                      |
+----------------------+----------------------+----------------------+
| [32.451](http://www  | Key Performance      | TBD                  |
| .3gpp.org/ftp/Specs/ | Indicators (KPI) for |                      |
| html-info/32451.htm) | Evolved Universal    |                      |
|                      | Terrestrial Radio    |                      |
|                      | Access Network       |                      |
|                      | (E-UTRAN);           |                      |
|                      | Requirements         |                      |
+----------------------+----------------------+----------------------+
| [32.452](http://www  | Performance          | Not Applicable       |
| .3gpp.org/ftp/Specs/ | Management (PM);     |                      |
| html-info/32452.htm) | Performance          |                      |
|                      | measurements Home    |                      |
|                      | Node B (HNB)         |                      |
|                      | Subsystem (HNS)      |                      |
+----------------------+----------------------+----------------------+
| [32.453](http://www  | Performance          | Not Applicable       |
| .3gpp.org/ftp/Specs/ | Management (PM);     |                      |
| html-info/32453.htm) | Performance          |                      |
|                      | measurements Home    |                      |
|                      | enhanced Node B      |                      |
|                      | (HeNB) Subsystem     |                      |
|                      | (HeNS)               |                      |
+----------------------+----------------------+----------------------+
| [32.454](http://www  | Key Performance      | Not required in this |
| .3gpp.org/ftp/Specs/ | Indicators (KPI) for | release.             |
| html-info/32454.htm) | the IP Multimedia    |                      |
|                      | Subsystem (IMS);     |                      |
|                      | Definitions          |                      |
+----------------------+----------------------+----------------------+
| [32.455](http://www  | Key Performance      | Not required in this |
| .3gpp.org/ftp/Specs/ | Indicators (KPI) for | release.             |
| html-info/32455.htm) | the Evolved Packet   |                      |
|                      | Core (EPC);          |                      |
|                      | Definitions          |                      |
+----------------------+----------------------+----------------------+
| [32.500](http://www  | Self-Organizing      | Not required in this |
| .3gpp.org/ftp/Specs/ | Networks (SON);      | release.             |
| html-info/32500.htm) | Concepts and         |                      |
|                      | requirements         |                      |
+----------------------+----------------------+----------------------+
| [32.501              | Self-configuration   | Supported with no    |
| ](http://www.3gpp.or | of network elements; | modification         |
| g/ftp/Specs/html-inf | Concepts and         |                      |
| o/32501.htm)/502/506 | requirements         |                      |
+----------------------+----------------------+----------------------+
| [32.511](http://www  | Automatic Neighbour  | TBD (handling of ANR |
| .3gpp.org/ftp/Specs/ | Relation (ANR)       | may be impacted by   |
| html-info/32511.htm) | management;          | RAN sharing)         |
+----------------------+----------------------+----------------------+
| 521/522/526          | Self-Organizing      | Not required in this |
|                      | Networks (SON)       | release.             |
|                      | Policy Network       |                      |
|                      | Resource Model (NRM) |                      |
|                      | Integration          |                      |
|                      | Reference Point      |                      |
|                      | (IRP);               |                      |
+----------------------+----------------------+----------------------+
| [32.531              | Software management  | Not Applicable       |
| ](http://www.3gpp.or | (SwM); Concepts and  |                      |
| g/ftp/Specs/html-inf | Integration          |                      |
| o/32531.htm)/532/536 | Reference Point      |                      |
|                      | (IRP)                |                      |
+----------------------+----------------------+----------------------+
| [32.541](http://www  | Self-Organizing      | Not Applicable       |
| .3gpp.org/ftp/Specs/ | Networks (SON);      |                      |
| html-info/32541.htm) | Self-healing         |                      |
|                      | concepts and         |                      |
|                      | requirements         |                      |
+----------------------+----------------------+----------------------+
| [32.551](http://www  | Energy Saving        | Not Applicable       |
| .3gpp.org/ftp/Specs/ | Management (ESM);    |                      |
| html-info/32551.htm) | Concepts and         |                      |
|                      | requirements         |                      |
+----------------------+----------------------+----------------------+
| [32                  | Home Node B (HNB)    | Not Applicable       |
| .571](http://www.3gp | and Home eNode B     |                      |
| p.org/ftp/Specs/html | (HeNB) management;   |                      |
| -info/32571.htm)/572 | Type 2 interface     |                      |
+----------------------+----------------------+----------------------+
| [32.581](ht          | Home Node B (HNB)    | Not Applicable       |
| tp://www.3gpp.org/ft | Operations,          |                      |
| p/Specs/html-info/32 | Administration,      |                      |
| 581.htm)/582/583/584 | Maintenance and      |                      |
|                      | Provisioning         |                      |
|                      | (OAM&P): Type 1      |                      |
|                      | interface            |                      |
+----------------------+----------------------+----------------------+
| [32.591](ht          | Home enhanced Node B | Not Applicable       |
| tp://www.3gpp.org/ft | (HeNB) Operations,   |                      |
| p/Specs/html-info/32 | Administration,      |                      |
| 591.htm)/582/593/594 | Maintenance and      |                      |
|                      | Provisioning         |                      |
|                      | (OAM&P): Type 1      |                      |
|                      | Interface            |                      |
+----------------------+----------------------+----------------------+
| [32.600](ht          | Configuration        | Supported with no    |
| tp://www.3gpp.org/ft | Management (CM)      | modification         |
| p/Specs/html-info/32 |                      |                      |
| 600.htm)/601/602/606 |                      |                      |
+----------------------+----------------------+----------------------+
| [32.611              | Configuration        | Supported with no    |
| ](http://www.3gpp.or | Management (CM);     | modification         |
| g/ftp/Specs/html-inf | Bulk CM Integration  |                      |
| o/32611.htm)/612/616 | Reference Point      |                      |
|                      | (IRP)                |                      |
+----------------------+----------------------+----------------------+
| [32.621              | Configuration        | Not required in this |
| ](http://www.3gpp.or | Management (CM);     | release.             |
| g/ftp/Specs/html-inf | Generic network      |                      |
| o/32621.htm)/622/626 | resources            |                      |
|                      | Integration          |                      |
|                      | Reference Point      |                      |
|                      | (IRP)                |                      |
+----------------------+----------------------+----------------------+
| [32.631              | Configuration        | Supported with no    |
| ](http://www.3gpp.or | Management (CM);     | modification         |
| g/ftp/Specs/html-inf | Core network         |                      |
| o/32631.htm)/632/636 | resources            |                      |
|                      | Integration          |                      |
|                      | Reference Point      |                      |
|                      | (IRP)                |                      |
+----------------------+----------------------+----------------------+
| [32.661              | Configuration        | Supported with no    |
| ](http://www.3gpp.or | Management (CM);     | modification         |
| g/ftp/Specs/html-inf | Kernel CM            |                      |
| o/32661.htm)/662/666 |                      |                      |
+----------------------+----------------------+----------------------+
| 32.690               | Telecommunication    | Not Applicable       |
|                      | management;          |                      |
|                      | Inventory Management |                      |
|                      | (IM); Requirements   |                      |
+----------------------+----------------------+----------------------+
| 32.691/692/696       | Inventory Management | Not Applicable       |
|                      | (IM) Network         |                      |
|                      | Resource Model (NRM) |                      |
|                      | Integration          |                      |
|                      | Reference Point      |                      |
...
########  Annex C (informative): Change history
  ...
  **Date**             **TSG \#**   **TSG Doc.**   **CR**   **Rev**   **Subject/Comment**                                              **Old**   **New**
  ...
  2012-06              SP-56        SP-120370      001      2         Add relation description between IRPs                            10.0.0    11.0.0
  2012-12              SP-58        SP-120783      003      2         CR R11 32.103 Add usage description for SON functions            11.0.0    11.1.0
  2013-03              SP-59        SP-130060      004      2         Enhancements for Converged Management                            11.1.0    11.2.0
  2013-09              SP-61        SP-130433      005      1         correction of references                                         11.2.0    11.3.0
  2014-06              SP-64        SP-140332      006      2         Add missing feature support matrix                               11.3.0    11.4.0
                                    SP-140359      007      \-        remove the feature support statements                                      
  2014-10                                                             Automatic upgrade (MCC)                                          11.4.0    12.0.0
  2014-12              SP-66        SP-140798      009      \-        Remove the mapping information between 32 series and 28 series   12.0.0    12.1.0
                                                   010      \-        Add feature support statements for Rel-12                                  
                                    SP-140797      012      \-        Update feature support statement for TS 32.300                             
                                    SP-140800      013      2         Add annex for network sharing management support table                     
  ...
  **Date**             **Meeting**   **TDoc**    **CR**   **Rev**   **Cat**   **Subject/Comment**                                                          **New version**
  2016-12              SA\#74        SP-160855   0015     \-        C         Alignment with latest SA5 specification list and various enhancements        14.0.0
  2018-01              SA\#78        SP-170964   0016     1         F         Update erroneous references                                                  14.1.0
  2018-06              \-            \-          \-       \-        \-        Update to Rel-15 version (MCC)                                               **15.0.0**
  2020-07              SA\#88-e      SP-200486   0018     1         F         Add 5G specification information                                             **15.1.0**
  2020-07              SA\#88-e      SP-200494   0017     1         B         Add QoE Specifications                                                       **16.0.0**
  2020-09              SA\#89e       SP-200728   0025     1         A         Correction of reference list and adding references throughout the document   **16.1.0**
  2020-12              SA\#90e       SP-201048   0031     \-        A         Correction of reference in the document                                      **16.2.0**
  2022-03              SA\#95e       SP-220185   0033     1         F         Remove 5G specification information                                          **16.3.0**
  -------------------- ------------- ----------- -------- --------- --------- ---------------------------------------------------------------------------- -----------------
