...
\[9\] 3GPP TS 52.402: \"Telecommunication management; Performance
...
With these two measures the operator can calculate the service
...
ThpVolDl is the volume on IP level and the ThpTimeDl is the time elapsed
