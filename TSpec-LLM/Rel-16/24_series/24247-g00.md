...
User Equipment (UE) 7.2.2 Media Resource Function Controller (MRFC)
...
The present document provides the protocol details for the messaging
...
\[10\] 3GPP TS 24.147: \"Conferencing using the IP Multimedia (IM) Core
...
NOTE: Some participants may always use session-based messaging, while
...
For the purpose of page-mode messaging, the UE shall implement the role
...
The handling of the 200 (OK) response shall be in accordance with
3GPP TS 24.229 \[5\].
...
\- the From header field set to the same value as the From header field
that was received in the incoming MESSAGE request;
...
When the terminating participant receives an initial INVITE request from
...
The MRFP may implement the role of an MSRP sender as described in
subclause 9.3.1.
...
a\) at what point in time the IP-CAN for the media component (MSRP) is
set up; or
...
9\. **INVITE request (I-CSCF\#2 to S-CSCF\#2) -- see example in table
A.4.2-9**
...
10\. **100 (Trying) response (S-CSCF\#2 to I-CSCF\#2) -- see example in
table A.4.2-10**
...
14\. **INVITE request (P-CSCF\#2 to UE\#2) -- see example in table
A.4.2-14**
...
26\. **ACK request (S-CSCF\#2 to P-CSCF\#2) -- see example in table
A.4.2-26**
...
8\. **INVITE request (AS\#1 to S-CSCF\#1) - see example in table
A.4.3-8**
...
18\. **INVITE request (AS\#2 to S-CSCF\#2) -- see example in table
A.4.3-18**
...
23\. **100 (Trying) response (UE\#2 to P-CSCF\#2) -- see example in
table A.4.3-23**
...
> From: \<sip:user1\_public1\@home1.net\>tag=7871654
>
> To: \<sip:user2\_public1\@home2.net\>;tag=999456
>
> Call-ID: 0s09glkj4903a2sdf33cb03a
>
> Cseq: 210 INVITE
...
26\. **200 (OK) response (P-CSCF\#2 to S-CSCF\#2) -- see example in
table A.4.3-26**
...
27\. **200 (OK) response (S-CSCF\#2 to AS\#2) -- see example in table
A.4.3-27**
...
28\. **ACK request (AS\#2 to S-CSCF\#2) -- see example in table
A.4.3-28**
...
> From: \<sip:user1\_public1\@home1.net\>;tag=7871654
>
> To: \<sip:user2\_public1\@home2.net\>;tag=2217770
>
> Call-ID: 0s09glkj4903a2sdf33cb03a
>
> Cseq: 210 ACK
...
29\. **ACK request (S-CSCF\#2 to P-CSCF\#2) -- see example in table
A.4.3-29**
...
30\. **ACK request (P-CSCF\#2 to UE\#2) -- see example in table
A.4.3.30**
...
> AS\#2 establishes a TCP connection using the IP-CAN bearers
> established in step 24 to the host address and port as specified in
> the MSRP URL received in the SDP Answer from UE\#2.

32\. **200 (OK) response (AS\#2 to S-CSCF\#2) -- see example in table
A.4.3-32**
...
>
> Record-Route: \<sip:scscf2.home2.net;lr\>,
> \<sip:scscf1.home1.net;lr\>, \<sip:as2.home2.net;lr\>
>
> P-Asserted-Identity: \"John Smith\" \<sip:user2\_public1\@home2.net\>,
> \<tel:+1-212-555-2222\>
>
...
> From: \<sip:user1\_public1\@home1.net\>tag=234567
>
> To: \<sip:user2\_public1\@home2.net\>;tag=98989823
>
> Call-ID: s09a233cbsdfglkj490303a0
>
> CSeq: 278 INVITE
...
**SDP** The SDP contains the set of answered content types supported by
UE\#2 in the accept-types attribute and indicates the maximum size
message that can be received by UE\#2 and allowed by the policy of
network home2 in the max-size attribute.

33\. **200 (OK) response (S-CSCF\#2 to I-CSCF\#2) -- see example in
table A.4.3-33**
...
34\. **200 (OK) response (I-CSCF\#2 to S-CSCF\#1) -- see example in
table A.4.3-34**
...
35\. **200 (OK) response (S-CSCF\#1 to AS\#1) -- see example in table
A.4.3-35**
...
> a=
>
> 36\. **ACK request (AS\#1 to S-CSCF\#1) - see example in table
> A.4.3-36**
...
> Content-Length: 0
>
> 37\. **ACK request (S-CSCF\#1 to S-CSCF\#2) - see example in table
> A.4.3-37**
...
> Content-Length:
>
> 38\. **ACK request (S-CSCF\#2 to AS\#2) - see example in table
> A.4.3-38**
...
> AS\#1 establishes a TCP connection to the host address and port as
> specified in the MSRP URL received in the SDP Answer from the AS\#2.

40\. **200 (OK) response (AS\#1 to S-CSCF\#1) -- see example in table
A.4.3-40**
...
> \[5555::aaa:bbb:ccc:ddd\]:1357;comp=sigcomp;branch=z9hG4bKnashds7
>
> Record-Route: \<sip:as1.home1.net;lr\>, \<sip:scscf1.home1.net;lr\>,
> \<sip:pcscf1.visited1.net;lr\>
>
> P-Asserted-Identity:
>
...
41\. **200 (OK) response (S-CSCF\#1 to P-CSCF\#1) -- see example in
table A.4.3-41**
...
42\. **200 (OK) response (P-CSCF\#1 to UE\#1) -- see example in table
A.4.3-42**
...
> a=
>
> 43\. **ACK request (UE\#1 to P-CSCF\#1) -- see example in table
> A.4.3-43**
...
> Content-Length: 0
>
> 44\. **ACK request (P-CSCF\#1 to S-CSCF\#1) -- see example in table
> A.4.3-44**
...
> Content-Length:
>
> 45\. **ACK request (S-CSCF\#1 to AS\#1) - see example in table
> A.4.3-45**
...
> ACK
> sip:user2\_public1\@home2.net;gr=urn:uuid:2ad8950e-48a5-4a74-8d99-ad76cc7fc7
> SIP/2.0
>
> Via: SIP/2.0/UDP scscf1.home1.net;branch=z9hG4bK344a65.1, SIP/2.0/UDP
> pcscf1.visited1.net;branch=z9hG4bK240f34.1, SIP/2.0/UDP
...
> Originating UE\#1 establishes a TCP connection using the IP-CAN
> bearers established in step 46 to the host address and port as
> specified in the MSRP URL received in the SDP Answer from AS\#1.

48\. **MSRP SEND (UE\#1 to AS\#1) -- see example in table A.4.3-48**

> The originating UE sends the first message over the MSRP session with
> a MSRP SEND request using the established TCP connection.
...
> Content-Type: \"text/plain\"
>
> I will never be a member of a club that accepts people like me as
...
> AS\#1 forwards the first MSRP SEND request to AS\#2 over the MSRP
> session using the established TCP connection.
...
> AS\#2 forwards the first MSRP SEND request to UE\#2 over the MSRP
> session using the established TCP connection.
...
> The receiving UE\#2 acknowledges the reception of the MSRP SEND
> request with a MSRP 200 (OK) response sent using the established TCP
> connection.
...
> AS\#2 acknowledges the reception of the MSRP SEND request with a MSRP
> 200 (OK) response to AS\#1 using the established TCP connection.
...
> AS\#1 acknowledges the reception of the MSRP SEND request with a MSRP
> 200 (OK) response to UE\#1 sent using the established TCP connection.
...
establishment flows with preconditions in 3GPP TS 24.228 \[4\] except
that the SDP contents are for setting up MSRP sessions over TCP rather
than RTP sessions over UDP.
...
Figure A.5.1-1: User connecting into a messaging conference - network
MRFC/AS is not located in user\'s home network - conference URI resolved
by the terminating home network

Figure A.5.1-1 shows an user calling into a messaging conference by
using a conference URI. The focus of that conference is at a MRFC/AS
which are located in another network. The conference URI in this example
cannot be resolved by the originating home network

The details of the flows are as follows:

1\. **INVITE request (UE to P-CSCF) - see example in table A.5.1-1**

A UE wants to join a messaging conference. For this purpose the UE is
aware of the related conference URI that was obtained by means outside
the present document (e.g. via other protocols, such as http).

The originating UE creates a local MSRP URL, which can be used for
communication for the messaging conference. It builds a SDP Offer
containing the generated MSRP URL and assigns a local port number for
...
A.5.1-7 (related to table A.5.1-6)**
...
> 12\. **200 (OK) response (MRFC/AS to I-CSCF) - see example in table
> A.5.1-12 (related to table A.5.1-9)**
>
> The MRFC/AS sends a 200 (OK) response for the INVITE request
> containing SDP that indicates that the MRFC/AS has accepted the
> message session and listens on the MSRP TCP port returned in the path
> attribute in the answer for a TCP SETUP from the originating UE. The
> MRFC/AS sends a 200 (OK) response final response to the INVITE request
> (9) to the I-CSCF.
...
> 16\. **200 (OK) response (P-CSCF to UE) - see example in table
> A.5.1-16**

The P-CSCF forwards the 200 (OK) response final response including the
media authorisation token to the session originator.
...
OK) response (16) with an ACK request sent to the P-CSCF.
...
> Content-Length: 0
>
> 18\. **ACK request (P-CSCF to S-CSCF) - see example in table
> A.5.1-18**
...
> Content-Length:
>
> 19\. **ACK request (S-CSCF to I-CSCF) - see example in table
> A.5.1-19**
...
> Content-Length:
>
> 20\. **ACK request (I-CSCF to MRFC/AS) - see example in table
> A.5.1-20**
...
The UE reserves an IP-CAN bearer for the message session media
component.

22\. **TCP setup**

> Originating UE establishes a TCP connection using the IP-CAN bearers
> established in step 21to the host address and port as specified in the
> MSRP URL received in the SDP Answer from MRFC/AS.
...
24\. **MSRP 200 (OK) response (MRFP to UE) -- see example in table
A.5.1-24**

> The MRFP acknowledges the reception of the MSRP SEND request with an
...
Figure A.5.2-1 shows an MRFC/AS inviting a user to a messaging
conference. The invitation is sent as a result of user1\@home1.net
sending a REFER request to the MRFC/AS. The MRFC/AS is located in a
different network than user\'s S-CSCF. The flows for inviting a user to
a conference using REFER are shown in TS 24.147 \[10\].

Figure A.5.2-1: MRFC/AS inviting a user to a messaging conference -
MRFC/AS routes directly to I-CSCF
...
The MRFC/AS invites a user to a messaging conference as it received a
REFER request from another user.

The MRFC/AS creates a local MSRP URL, which can be used for
communication for the messaging conference. It builds a SDP Offer
containing the generated MSRP URL and assigns a local port number for
the MSRP communication.
...
**SDP** The SDP contains a set of content types supported by the MRFC/AS
for this session in the accept-types attribute and indicates the maximum
size message that can be received by the MRFC/AS in the max-size
attribute.
...
10\. **INVITE request (P-CSCF to UE\#2) - see example in table
A.5.2-10**

P-CSCF forwards the request to UE\#2 including the Media Authorisation
token.
...
UE\#2 responds to the INVITE request (10) with a 100 (Trying)
provisional response.
...
>
> 13\. **200 (OK) response (UE\#2 to P-CSCF) - see example in table
> A.5.2-13 (related to table A.5.2-10)**
>
> After reserving an IP-CAN bearer for the message session media
> component the receipt of the MSRP 200 (OK) response to the MSRP VISIT
> request, the terminating UE\#2 sends a 200 (OK) response for the
> INVITE request containing SDP that indicates that UE\#2 has
> successfully visited AS\#2, accepted the message session and listens
> on the MSRP TCP port returned in the path attribute in the answer for
> a TCP SETUP from the MRFC/AS.
...
**SDP** The SDP contains a set of offered content types supported by
UE\#2 and desired by the user at UE\#2 for this session in the
accept-types attribute and indicates the maximum size message that can
be received by UE\#2 in the max-size attribute.
...
> a=
>
> **17.** **ACK request (MRFC/AS to S-CSCF) - see example in table
> A.5.2-17**

The MRFC/AS responds to the 200 (OK) response (16) with an ACK request
sent to the S-CSCF.
...
> Content-Length: 0
>
> **18.** **ACK request (S-CSCF to P-CSCF) - see example in table
> A.5.2-18**
...
> Content-Length:
>
> **19.** **ACK request (P-CSCF to UE\#2) - see example in table
> A.5.2-19**
...
20\. **H.248 interaction to create conference connection resources for
UE\#2**
...
> MRFP establishes a TCP connection using the IP-CAN bearers established
> in step 12 to the host address and port as specified in the MSRP URL
> received in the SDP Answer UE\#2.

22\. **MSRP SEND request (MRFP to UE\#2) -- see example in table
A.5.2-22**

> The MRFP sends the first message over the MSRP session with an MSRP
...
|       |       |       |       |       | .0.1. |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CN-27 | NP-0  | 011   | 1     | C     | 6.0.1 | 6.1.0 |
| 05-03 |       | 50073 |       |       | orrec |       |       |
|       |       |       |       |       | tions |       |       |
|       |       |       |       |       | to    |       |       |
|       |       |       |       |       | Me    |       |       |
...
|       |       |       |       |       | ns-09 |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CN-27 | NP-0  | 008   | 1     | Alig  | 6.0.1 | 6.1.0 |
| 05-03 |       | 50073 |       |       | nment |       |       |
|       |       |       |       |       | be    |       |       |
|       |       |       |       |       | tween |       |       |
|       |       |       |       |       | TS    |       |       |
...
|       |       |       |       |       | aging |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CN-27 | NP-0  | 001   | 1     | Resol | 6.0.1 | 6.1.0 |
| 05-03 |       | 50073 |       |       | ution |       |       |
|       |       |       |       |       | of    |       |       |
|       |       |       |       |       | refer |       |       |
|       |       |       |       |       | ences |       |       |
...
|       |       |       |       |       | 4.228 |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CN-27 | NP-0  | 003   |       | ME    | 6.0.1 | 6.1.0 |
| 05-03 |       | 50073 |       |       | SSAGE |       |       |
|       |       |       |       |       | to    |       |       |
|       |       |       |       |       | un    |       |       |
|       |       |       |       |       | regis |       |       |
...
|       |       |       |       |       | user  |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CN-27 | NP-0  | 010   | 2     | Rem   | 6.0.1 | 6.1.0 |
| 05-03 |       | 50073 |       |       | oving |       |       |
|       |       |       |       |       | CPCP  |       |       |
|       |       |       |       |       | from  |       |       |
|       |       |       |       |       | 2     |       |       |
|       |       |       |       |       | 4.247 |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CN-27 | NP-0  | 009   | 2     | Clar  | 6.0.1 | 6.1.0 |
| 05-03 |       | 50075 |       |       | ifica |       |       |
|       |       |       |       |       | tions |       |       |
|       |       |       |       |       | to TS |       |       |
|       |       |       |       |       | 2     |       |       |
...
|       |       |       |       |       | 9.3   |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CN-27 | NP-0  | 002   | 3     | ME    | 6.0.1 | 6.1.0 |
| 05-03 |       | 50075 |       |       | SSAGE |       |       |
|       |       |       |       |       | to    |       |       |
|       |       |       |       |       | mul   |       |       |
|       |       |       |       |       | tiple |       |       |
...
|       |       |       |       |       | ients |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CN-27 | NP-0  | 007   | 2     | Alig  | 6.0.1 | 6.1.0 |
| 05-03 |       | 50075 |       |       | nment |       |       |
|       |       |       |       |       | be    |       |       |
|       |       |       |       |       | tween |       |       |
|       |       |       |       |       | TS    |       |       |
...
|       |       |       |       |       | ing\" |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CP-28 | CP-0  | 13    | 1     | List  | 6.1.0 | 6.2.0 |
| 05-06 |       | 50060 |       |       | s     |       |       |
|       |       |       |       |       | erver |       |       |
|       |       |       |       |       | -     |       |       |
|       |       |       |       |       | se    |       |       |
...
|       |       |       |       |       | uests |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CP-28 | CP-0  | 15    | 1     | A     | 6.1.0 | 6.2.0 |
| 05-06 |       | 50060 |       |       | dding |       |       |
|       |       |       |       |       | of    |       |       |
|       |       |       |       |       | refe  |       |       |
|       |       |       |       |       | rence |       |       |
...
|       |       |       |       |       | 4.247 |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CP-28 | CP-0  | 16    | 1     | C     | 6.1.0 | 6.2.0 |
| 05-06 |       | 50060 |       |       | orrec |       |       |
|       |       |       |       |       | tions |       |       |
|       |       |       |       |       | to    |       |       |
|       |       |       |       |       | Me    |       |       |
...
|       |       |       |       |       | ns-10 |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CP-29 | CP-0  | 17    |       | C     | 6.2.0 | 6.3.0 |
| 05-09 |       | 50359 |       |       | orrec |       |       |
|       |       |       |       |       | tions |       |       |
|       |       |       |       |       | to TS |       |       |
|       |       |       |       |       | 2     |       |       |
...
|       |       |       |       |       | ns-11 |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CP-30 | CP-0  | 18    | 1     | Call  | 6.3.0 | 6.4.0 |
| 05-12 |       | 50544 |       |       | flow  |       |       |
|       |       |       |       |       | c     |       |       |
|       |       |       |       |       | orrec |       |       |
|       |       |       |       |       | tions |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CP-30 | CP-0  | 19    |       | C     | 6.3.0 | 6.4.0 |
| 05-12 |       | 50544 |       |       | orrec |       |       |
|       |       |       |       |       | tions |       |       |
|       |       |       |       |       | to TS |       |       |
|       |       |       |       |       | 2     |       |       |
...
|       |       |       |       |       | ons12 |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CP-31 | CP-0  | 20    |       | C     | 6.4.0 | 6.5.0 |
| 06-03 |       | 60110 |       |       | orrec |       |       |
|       |       |       |       |       | tions |       |       |
|       |       |       |       |       | to    |       |       |
|       |       |       |       |       | refer |       |       |
...
|       |       |       |       |       | ge-06 |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CP-33 | CP-0  | 22    |       | Re    | 6.5.0 | 6.6.0 |
| 06-09 |       | 60504 |       |       | moval |       |       |
|       |       |       |       |       | of    |       |       |
|       |       |       |       |       | Edit  |       |       |
|       |       |       |       |       | or\'s |       |       |
...
|       |       |       |       |       | 4.247 |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CP-34 | CP-0  | 23    | 1     | Corre | 6.6.0 | 6.7.0 |
| 06-11 |       | 60655 |       |       | ction |       |       |
|       |       |       |       |       | of    |       |       |
|       |       |       |       |       | the   |       |       |
|       |       |       |       |       | i-d   |       |       |
...
|       |       |       |       |       | (SIP  |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CP-34 | CP-0  | 24    | 2     | Add   | 6.7.0 | 7.0.0 |
| 06-11 |       | 60661 |       |       | ition |       |       |
|       |       |       |       |       | of    |       |       |
|       |       |       |       |       | MSRP  |       |       |
|       |       |       |       |       | file  |       |       |
...
|       |       |       |       |       | nsfer |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CP-35 | CP-0  | 26    |       | IETF  | 7.0.0 | 7.1.0 |
| 07-03 |       | 70130 |       |       | refe  |       |       |
|       |       |       |       |       | rence |       |       |
|       |       |       |       |       | c     |       |       |
|       |       |       |       |       | orrec |       |       |
|       |       |       |       |       | tions |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CP-36 | CP-0  | 27    |       | File  | 7.1.0 | 7.2.0 |
| 07-06 |       | 70430 |       |       | tra   |       |       |
|       |       |       |       |       | nsfer |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CP-38 | CP-0  | 32    |       | IETF  | 7.2.0 | 7.3.0 |
| 07-12 |       | 70788 |       |       | refe  |       |       |
|       |       |       |       |       | rence |       |       |
|       |       |       |       |       | up    |       |       |
|       |       |       |       |       | dates |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CP-38 | CP-0  | 29    |       | Inc   | 7.3.0 | 8.0.0 |
| 07-12 |       | 70810 |       |       | orpor |       |       |
|       |       |       |       |       | ation |       |       |
|       |       |       |       |       | of    |       |       |
|       |       |       |       |       | roles |       |       |
...
|       |       |       |       |       | ework |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CP-39 | CP-0  | 0033  | 1     | Mess  | 8.0.0 | 8.1.0 |
| 08-03 |       | 80140 |       |       | aging |       |       |
|       |       |       |       |       | refer |       |       |
|       |       |       |       |       | ences |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CP-42 | CP-0  | 0035  |       | Add   | 8.1.0 | 8.2.0 |
| 08-12 |       | 80854 |       |       | ition |       |       |
|       |       |       |       |       | of    |       |       |
|       |       |       |       |       | media |       |       |
|       |       |       |       |       | co    |       |       |
...
|       |       |       |       |       | aging |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CP-42 | CP-0  | 0038  |       | Refe  | 8.1.0 | 8.2.0 |
| 08-12 |       | 80841 |       |       | rence |       |       |
|       |       |       |       |       | up    |       |       |
|       |       |       |       |       | dates |       |       |
|       |       |       |       |       | (re   |       |       |
...
|       |       |       |       |       | cies) |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CP-42 | CP-0  | 0042  | 1     | C     | 8.1.0 | 8.2.0 |
| 08-12 |       | 80846 |       |       | orrec |       |       |
|       |       |       |       |       | tions |       |       |
|       |       |       |       |       | of    |       |       |
|       |       |       |       |       | refe  |       |       |
...
|       |       |       |       |       | MCC   |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CP-44 | CP-0  | 0044  | 1     | A     | 8.2.0 | 8.3.0 |
| 09-06 |       | 90424 |       |       | ltern |       |       |
|       |       |       |       |       | ative |       |       |
|       |       |       |       |       | conne |       |       |
|       |       |       |       |       | ction |       |       |
...
|       |       |       |       |       | MSRP  |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CP-46 |       |       |       | Up    | 8.3.0 | 9.0.0 |
| 09-12 |       |       |       |       | grade |       |       |
|       |       |       |       |       | to    |       |       |
|       |       |       |       |       | Rel-9 |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CP-48 | CP-1  | 0046  | 1     | MSRP  | 9.0.0 | 9.1.0 |
| 10-06 |       | 00351 |       |       | allig |       |       |
|       |       |       |       |       | nment |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CP-50 | CP-1  | 0050  | 1     | Incl  | 9.1.0 | 9.2.0 |
| 10-12 |       | 00726 |       |       | usion |       |       |
|       |       |       |       |       | of    |       |       |
|       |       |       |       |       | file  |       |       |
|       |       |       |       |       | tra   |       |       |
...
|       |       |       |       |       | butes |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CP-50 | CP-1  | 0052  | 2     | Refe  | 9.1.0 | 9.2.0 |
| 10-12 |       | 00874 |       |       | rence |       |       |
|       |       |       |       |       | up    |       |       |
|       |       |       |       |       | date: |       |       |
|       |       |       |       |       | dr    |       |       |
...
|       |       |       |       |       | p-acm |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CP-51 | CP-1  | 0054  |       | Refe  | 9.2.0 | 9.3.0 |
| 11-03 |       | 10172 |       |       | rence |       |       |
|       |       |       |       |       | up    |       |       |
|       |       |       |       |       | date: |       |       |
|       |       |       |       |       | dr    |       |       |
...
|       |       |       |       |       | el-10 |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CP-52 | CP-1  | 0057  |       | Refe  | 1     | 1     |
| 11-06 |       | 10454 |       |       | rence | 0.0.0 | 0.1.0 |
|       |       |       |       |       | up    |       |       |
|       |       |       |       |       | date: |       |       |
|       |       |       |       |       | RFC   |       |       |
|       |       |       |       |       | 6135  |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CP-53 | CP-1  | 0060  | 1     | Refe  | 1     | 1     |
| 11-09 |       | 10662 |       |       | rence | 0.1.0 | 0.2.0 |
|       |       |       |       |       | up    |       |       |
|       |       |       |       |       | date: |       |       |
|       |       |       |       |       | dr    |       |       |
|       |       |       |       |       | aft-i |       |       |
...
|       |       |       |       |       | match |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CP-54 | CP-1  | 0066  | 1     | Refe  | 1     | 1     |
| 11-12 |       | 10864 |       |       | rence | 0.2.0 | 0.3.0 |
|       |       |       |       |       | up    |       |       |
|       |       |       |       |       | date: |       |       |
|       |       |       |       |       | dr    |       |       |
|       |       |       |       |       | aft-i |       |       |
...
|       |       |       |       |       | -cema |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CP-54 | CP-1  | 0063  | 1     | Corre | 1     | 1     |
| 11-12 |       | 10881 |       |       | ction | 0.3.0 | 1.0.0 |
|       |       |       |       |       | of    |       |       |
|       |       |       |       |       | cha   |       |       |
|       |       |       |       |       | rging |       |       |
|       |       |       |       |       | he    |       |       |
|       |       |       |       |       | aders |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CP-57 | CP-1  | 0070  | 1     | Refe  | 1     | 1     |
| 12-06 |       | 20573 |       |       | rence | 1.0.0 | 1.1.0 |
|       |       |       |       |       | up    |       |       |
|       |       |       |       |       | date: |       |       |
|       |       |       |       |       | dr    |       |       |
|       |       |       |       |       | aft-i |       |       |
...
|       |       |       |       |       | -cema |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CP-58 | CP-1  | 0071  | 1     | C     | 1     | 1     |
| 12-12 |       | 20793 |       |       | orrec | 1.1.0 | 1.2.0 |
|       |       |       |       |       | tions |       |       |
|       |       |       |       |       | to    |       |       |
|       |       |       |       |       | refer |       |       |
|       |       |       |       |       | ences |       |       |
...
|       |       |       |       |       | rrors |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CP-58 | CP-1  | 0075  |       | Refe  | 1     | 1     |
| 12-12 |       | 20781 |       |       | rence | 1.1.0 | 1.2.0 |
|       |       |       |       |       | up    |       |       |
|       |       |       |       |       | date: |       |       |
|       |       |       |       |       | RFC   |       |       |
|       |       |       |       |       | 6714  |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CP-58 | CP-1  | 0079  | 1     | Proc  | 1     | 1     |
| 12-12 |       | 20781 |       |       | edure | 1.1.0 | 1.2.0 |
|       |       |       |       |       | up    |       |       |
|       |       |       |       |       | date: |       |       |
|       |       |       |       |       | RFC   |       |       |
|       |       |       |       |       | 6714  |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CP-62 | CP-1  | 0080  | 1     | MSRP  | 1     | 1     |
| 13-12 |       | 30763 |       |       | -CEMA | 1.2.0 | 2.0.0 |
|       |       |       |       |       | and   |       |       |
|       |       |       |       |       | pr    |       |       |
|       |       |       |       |       | ivacy |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
