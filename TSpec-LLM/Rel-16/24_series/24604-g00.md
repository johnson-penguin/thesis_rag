...
[26](#actions-at-the-diverting-ua)
...
[31](#communication-diversion-element)
...
(subscription option) 4.5.2.6.5.0 General 4.5.2.6.5.1 Void 4.5.2.6.5.2
...
\[28\] IETF RFC 7090 (April 2014): \"Public Safety Answering Point
(PSAP) Callback\".
...
For interrogation of the services CFU, CFB, CFNR, CFNL, CFNRc and CD,
...
NOTE: For the case when the session is not subject to diversion and
...
\- if communication forwarding unconditional, the cause value \"302 as
defined by RFC 4458 \[14\];
...
**b) History-Info header field** shall be modified in accordance with
...
<tr class="even">
<td><p>Information added:</p>
<p>hi-targeted-to-uri (NOTE 4)</p>
<p>Reason header (NOTE 2)</p>
<p>cause-param (NOTE 3)</p>
<p>Privacy</p>
<p>Hi-index (NOTE 1)</p>
<p>hi-target-param "mp"</p></td>
<td></td>
<td><p>B</p>
<p>V</p>
<p>W</p>
...
<tr class="odd">
<td><p>U = Value for the cause-param parameter as specified in 4.5.2.6.2.2 and 4.5.2.6.2.3</p>
<p>V = Value in accordance with the rules in RFC 7044 [3].</p>
<p>W = privacy value (history) or (none) or no entry.</p>
<p>NOTE 1: The hi-index field shall be set by using a new level "1" according to the rules specified in subclause 10.3 of RFC 7044 [3].</p>
<p>NOTE 2: The encoding of the reason header and the contained protocol-cause parameter are specified in RFC 3326 [24]. It is embedded in the hi-targeted-to-uri of the history info header in escaped format according to the rules in RFC 7044 [3].</p>
<p>NOTE 3: The cause-param is specified in RFC 4458 [14]. It is embedded in the hi-targeted-to-uri of the history info header in non-escaped format according to the rules in RFC 4458 [14].</p>
<p>NOTE 4: If the received hi-targeted-to-uri is a tel URI, it is converted to a SIP URI if the Reason or the Privacy header field has to be embedded</p></td>
<td></td>
<td></td>
<td></td>
<td></td>
...
If diverting user accepts the communication after sending the initial
...
\- the initial INVITE request shall include the parameter information as
...
c\) The following entries shall be added to the **History-Info** header
field:
...
\- When the diverting user is registering to the communication system,
...
NOTE 1: For the case when the session is not subject to diversion and
CDIV, according the requirements in this document, is the only service
being applied by the AS, then the AS only needs to act as a SIP proxy.
If additional services are applied, then the AS might need to act as a
routeing B2BUA.
...
If the CDIV service was activated before the activation of the OCB
...
However not all rules can be matched at the same moment in the call.
...
**not-registered**: This condition evaluates to true when the called
...
**NOTE 1: As described in** IETF **RFC 4745 \[18\] the case of
...
**notify-served-user**: An optional element that can be used to enable
...
schemaLocation=\"xdm\_commonPolicy-V1\_0.xsd\"/\>

\<!\-- communication diversion specific extensions to IETF common policy
conditions. The cp:conditionsType is expanded with the elements:
ss:not-registered, ss:busy, ss:no-answer, ss:not-reachable, ss:media as
optional elements \--\>
...
\<xs:element name=\"target\" type=\"xs:anyURI\" minOccurs=\"1\"
maxOccurs=\"1\"/\>

\<xs:element name=\"notify-caller\" type=\"xs:boolean\" default=\"true\"
minOccurs=\"0\"/\>

\<xs:element name=\"reveal-identity-to-caller\"
type=\"ss:reveal-URI-options-type\" default=\"true\" minOccurs=\"0\"/\>
...
This schema defines elements that are used to inform the UE which
conditions and actions the
...
\<xs:element name=\"communication-diversion-serv-cap\"
substitutionGroup=\"ss:absService\"\>
...
\<xs:element name=\"serv-cap-not-registered\"
type=\"ss:provisioned-type\"
...
\<xs:element name=\"serv-cap-not-reachable\"
type=\"ss:provisioned-type\"
...
\<xs:element name=\"serv-cap-target\"
type=\"ss:provisioned-target-type\"

minOccurs=\"0\"/\>

\<xs:element name=\"serv-cap-notify-caller\"
type=\"ss:provisioned-type\"

minOccurs=\"0\"/\>

\<xs:element name=\"serv-cap-notify-served-user\"
type=\"ss:provisioned-type\"
...
Figure A.1 shows an example signalling flow for a successful
communication forwarding unconditional based on an AS providing the
forwarding.

![](media/image4.wmf){width="6.691666666666666in"
...
1\) Initial INVITE request towards User B. **- see example in
table A.1.1-1**.

Table A.1.1-1: INVITE request (UE A to P-CSCF)

INVITE
sip:user2\_public1\@home1.net;gr=2ad8950e-48a5-4a74-8d99-ad76cc7fc74c
SIP/2.0
...
Contact:
\<sip:user1\_public1\@home1.net;gr=urn:uuid:f81d4fae-7dec-11d0-a765-00a0c91e6bf6;comp=sigcomp\>;+g.3gpp.icsi
...
2\) Initial INVITE request towards User B. The URI-B is subscribed to
the CFU service.
...
6 to 8) Depending on the value of subscription option "*Originating*
user receives notification that his communication has been diverted
(forwarded or deflected)", a 181 (Call Is Being Forwarded) response is
sent towards the User A indicating that the communication is diverted.

9\) An initial INVITE request including URI-C as destination is sent
back to the S-CSCF. Additional the History-Info header is included. **-
see example in table A.1.1-9.**
...
History-Info:
\<sip:user2\_public1\@home1.net;gr=2ad8950e-48a5-4a74-8d99-ad76cc7fc74c;
\>;index=1,\<sip:User-C\@example.com;cause=302\>;index=1.1;mp=1
...
Figures A.2a and A.2b describe the Immediate CD feature the only
difference compared to a regular CD is that in the regular CD case the
\"302 (Moved Temporarily) Moved Temporarily\" is preceded by a \"180
(Ringing) Ringing\".
...
1 to 2) Initial INVITE request towards User B. The URI-B is subscribed
to the CD service. - **see example in table A.1.1-1**
...
8 to 10) A 302 (Moved Temporarily) response with a contact header
including the URI of the forwarded to user is sent back to the AS.

11\) The CD logic is executed.

12 to 14) Depending on the value of subscription option \"*Originating*
user receives notification that his communication has been diverted
(forwarded or deflected)\", a 181 (Call Is Being Forwarded) response is
sent towards the User A indicating that the communication is diverted.

15\) An initial INVITE request including URI-C as destination is sent
back to the S-CSCF. Additional the History-Info header field is
included. - **see example in table A.1.2-15.**
...
History-Info:
\<sip:user2\_public1\@home1.net;gr=2ad8950e-48a5-4a74-8d99-ad76cc7fc74c?Reason=sip%3Bcause=302\>;index=1,\<sip:User-C\@example.com;cause=480\>;index=1.1;mp=1
...
16 to 18) An initial INVITE request including URI-C as destination is
routed to UE C.

19 to 24) A 180 (Ringing) response is sent back to the originating user
including a History-Info header field as shown above. If no restriction
is given the diverted to user will be presented at the UE of user A.
...
communication forwarding on no reply based on an AS providing the
forwarding as described in bullet 2) of the subclause 4.5.2.6.3.
...
1 to 2) Initial INVITE request towards User B. The URI-B is subscribed
to the CFU service. - **see example in table A.1.1-1**
...
7 to 9) A 180 (Ringing) response is sent back to the AS indicating that
the terminating UE is ringing.

10\) The no-reply timer in the AS is started.

11 to 13) The previous 180 (Ringing) response is sent towards the
originating user indicating that the terminating UE is ringing.

14\) The timer expires.

15 to 17) In this case, the option to not continue ringing the
forwarding user applies, therefore to release the communication to User
B the AS sends a CANCEL request

18 to 20) The 200 (OK) response for the CANCEL request is sent back to
the AS.

21 to 23) Depending on the value of subscription option \"*Originating*
user receives notification that his communication has been diverted
(forwarded or deflected)\", a 181 (Call Is Being Forwarded) response is
sent towards the User A indicating that the communication is diverted.

24 to 26) A 487 (Request Terminated) response with a ACK request
finalize the termination of the dialog between AS and UE:B.

27 to 29) The ACK for the 487 (Request Terminated) response is sent back
to User-B.

30\) An initial INVITE request including URI-C as destination is sent
back to the S-CSCF. Additional the History-Info header is included. -
**see example in table A.1.3-28.**

Table A.1.3-28: INVITE request (AS to S-CSCF)

INVITE
sip:User-C\@example.com;target=sip:user2\_public1\@home1.net%3bgr%362ad8950e-48a5-4a74-8d99-ad76cc7fc74;cause
408 SIP/2.0
...
History-Info:
\<sip:user2\_public1\@home1.net;gr=2ad8950e-48a5-4a74-8d99-ad76cc7fc74c;\>;index=1,\<sip:User-C\@example.com;target=sip:user2\_public1\@home1.net%3bgr%362ad8950e-48a5-4a74-8d99-ad76cc7fc74;cause=408\>;index=1.1;mp=1
...
32 to 34) An initial INVITE request including URI-C as destination is
routed to UE C.

34 to 19) A 180 (Ringing) response is sent back to the originating user
including a History-Info header as shown above. If no restriction is
...
communication forwarding on busy based on an AS providing the
forwarding.

![](media/image9.wmf){width="6.691666666666666in" height="7.1125in"}
...
Figures A.5 shows an example signalling flow for a successful
communication forwarding on not logged-in based on an AS providing the
forwarding.

![](media/image11.wmf){width="6.691666666666666in" height="6.525in"}
...
> GET
> /simservs.ngn.etsi.org/users/sip:user1\@home1.net/simservs.xml/\~\~/simservs/communication-diversion-serv-cap
> HTTP/1.1
>
...
> uri=\"/simservs.ngn.etsi.org/users/sip:user1\@home1.net/simservs.xml/\~\~/simservs/communication-diversion-serv-cap\",
...
The \<serv-cap-media\> child element of the \<serv-cap-conditions\>
element describes that audio and video media are allowed to be used as
Communication Diversion rule conditions. The other child elements of the
...
listed from the list of conditions specified in subclause 4.9.1.3 then
the condition is provisioned for the user. The following conditions are
provisioned: busy, not-registered, no-answer, not-reachable.

The \<serv-cap-target\> child element of the \<serv-cap-actions\>
element describes that the target needs to correspond to a telephone
number. The other child elements of the \<serv-cap-actions\> element
list the actions that are not provisioned for the user. If a service
capability for an action is not listed from the list of actions
specified in subclause 4.9.1.4 then the action is provisioned for the
user. In this example, there are no other actions provisioned.
...
id=\"rule1\" previously existed then the new rule replaces that rule.
The rule has an empty \<conditions\> element.

Table A.1.7-7: HTTP PUT request (UE to AP)

> PUT
> /simservs.ngn.etsi.org/users/sip:user1\@home1.net/simservs.xml/\~\~/simservs/communication-diversion/ruleset/rule%5b\@id=%22rule1%22%5d
> HTTP/1.1
>
> Host: xcap.mnc012.mcc345.ipxuni.3gppnetwork.org
>
...
> username=\"sip:user1\@home1.net\", qop=auth-int,\
> uri=\"/simservs.ngn.etsi.org/users/sip:user1\@home1.net/simservs.xml/\~\~/simservs/communication-diversion/ruleset\",
...
**9.** **HTTP 200 (OK) response (AS to AP) - see example in
table A.1.7-9**

The AS acknowledges the addition of the new CFU rule with a HTTP 200
(OK) response.
...
**10. HTTP 200 (OK) response (AP to UE) - see example in
table A.1.7-10**
...
Figure A.6b shows an example signalling flow for a successful
communication forwarding unconditional based on an AS providing the
forwarding, with the originating user in the PSTN.

![](media/image13.wmf){width="4.979861111111111in"
...
Figure A.7 shows an example signalling flow for a successful
communication deflection based on an AS providing the forwarding, with
the originating user in the PSTN.

![](media/image14.wmf){width="6.692361111111111in"
...
An example of an IFC when the CDIV supplementary service is active at
the diverting S-CSCF is:

\- Method: INVITE.

If the AS cannot suppress CDIV for a call identified as a PSAP callback,
an IFC bypassing the CDIV AS can be used. An example IFC using the PSAP
callback indicator specified in IETF RFC 7090 \[28\] is:

\- Method: \"INVITE\" and Priority header field not containing a
\"psap-callback\" header field value.

######## Annex C (informative): Coding considerations

This annex provides an interpretation of the coding of the cause-param
URI parameter specified in RFC 4458 \[14\]

The cause specified in RFC 4458 \[14\] has the following syntax:

cause-param = \"cause=\" Status-Code

The Status-Code is originally specified in RFC 3261 \[6\] as a sequence
of 3 digits. It is noted that the Status-Code simply indicates that it
is composed of 3 digits, without indicating the list of possible values.
In particular, Status-Code is not bound to and must not be confused with
the 3 digit numbers defined for SIP responses in RFC 3261 \[6\]. The
Status-Code is used to hold the redirecting reason.

For the purpose of legibility, the cause-param specified in
RFC 4458 \[14\] is interpreted according to the following syntax:
...
|       |       |       |       |       | MCC   |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CT-40 | CP-0  |       |       | CP-0  | 2.7.1 | 8.0.0 |
| 08-06 |       | 80325 |       |       | 80325 |       |       |
|       |       |       |       |       | was   |       |       |
|       |       |       |       |       | app   |       |       |
|       |       |       |       |       | roved |       |       |
...
|       |       |       |       |       | shing |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CT-41 | CP-0  | 0001  | 2     | Cla   | 8.0.0 | 8.1.0 |
| 08-09 |       | 80533 |       |       | rific |       |       |
|       |       |       |       |       | ation |       |       |
|       |       |       |       |       | of    |       |       |
|       |       |       |       |       | B2BUA |       |       |
...
|       |       |       |       |       | AS    |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CT-41 | CP-0  | 0002  |       | Corre | 8.0.0 | 8.1.0 |
| 08-09 |       | 80533 |       |       | ction |       |       |
|       |       |       |       |       | of    |       |       |
|       |       |       |       |       | t     |       |       |
|       |       |       |       |       | ermin |       |       |
|       |       |       |       |       | ology |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CT-41 | CP-0  | 0003  | 1     | Corre | 8.0.0 | 8.1.0 |
| 08-09 |       | 80533 |       |       | ction |       |       |
|       |       |       |       |       | of    |       |       |
|       |       |       |       |       | no    |       |       |
|       |       |       |       |       | tific |       |       |
...
|       |       |       |       |       | ation |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CT-41 | CP-0  | 0004  | 1     | Corre | 8.0.0 | 8.1.0 |
| 08-09 |       | 80521 |       |       | ction |       |       |
|       |       |       |       |       | of    |       |       |
|       |       |       |       |       | su    |       |       |
|       |       |       |       |       | bscri |       |       |
...
|       |       |       |       |       | tions |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CT-41 | CP-0  | 0005  | 1     | Value | 8.0.0 | 8.1.0 |
| 08-09 |       | 80521 |       |       | of    |       |       |
|       |       |       |       |       | \"No  |       |       |
|       |       |       |       |       | reply |       |       |
|       |       |       |       |       | ti    |       |       |
...
|       |       |       |       |       | CDIV  |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CT-41 | CP-0  | 0006  | 2     | Allow | 8.0.0 | 8.1.0 |
| 08-09 |       | 80539 |       |       | SIP   |       |       |
|       |       |       |       |       | based |       |       |
|       |       |       |       |       | user  |       |       |
|       |       |       |       |       | con   |       |       |
...
|       |       |       |       |       | vices |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CT-41 | CP-0  | 0007  | 1     | App   | 8.0.0 | 8.1.0 |
| 08-09 |       | 80533 |       |       | licab |       |       |
|       |       |       |       |       | ility |       |       |
|       |       |       |       |       | stat  |       |       |
|       |       |       |       |       | ement |       |       |
...
|       |       |       |       |       | scope |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CT
|       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CT-62 | CP-1  | 0127  | 2     | Refe  | 1     | 1     |
| 13-12 |       | 30758 |       |       | rence | 2.1.0 | 2.2.0 |
|       |       |       |       |       | up    |       |       |
|       |       |       |       |       | date: |       |       |
|       |       |       |       |       | draft |       |       |
|       |       |       |       |       | -ietf |       |       |
...
|       |       |       |       |       | lback |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CT-62 | CP-1  | 0128  |       | Inco  | 1     | 1     |
| 13-12 |       | 30763 |       |       | rrect | 2.1.0 | 2.2.0 |
|       |       |       |       |       | value |       |       |
|       |       |       |       |       | for   |       |       |
|       |       |       |       |       | \<me  |       |       |
|       |       |       |       |       | dia\> |       |       |
...
|       |       |       |       |       | ample |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CT-62 | CP-1  | 0129  | 1     | Corre | 1     | 1     |
| 13-12 |       | 30770 |       |       | cting | 2.1.0 | 2.2.0 |
|       |       |       |       |       | RFC   |       |       |
|       |       |       |       |       | 6665  |       |       |
|       |       |       |       |       | title |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CT-64 | CP-1  | 0135  | 1     | Re    | 1     | 1     |
| 14-06 |       | 40297 |       |       | moval | 2.2.0 | 2.3.0 |
|       |       |       |       |       | of    |       |       |
|       |       |       |       |       | the   |       |       |
|       |       |       |       |       | CDIVN |       |       |
|       |       |       |       |       | se    |       |       |
|       |       |       |       |       | rvice |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CT-65 | CP-1  | 0137  |       | Upd   | 1     | 1     |
| 14-09 |       | 40652 |       |       | ating | 2.3.0 | 2.4.0 |
|       |       |       |       |       | refer |       |       |
|       |       |       |       |       | ences |       |       |
|       |       |       |       |       | from  |       |       |
|       |       |       |       |       | RFC   |       |       |
...
|       |       |       |       |       | 4.604 |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CT-65 | CP-1  | 0140  | 3     | RF    | 1     | 1     |
| 14-09 |       | 40652 |       |       | C7044 | 2.3.0 | 2.4.0 |
|       |       |       |       |       | in TS |       |       |
|       |       |       |       |       | 2     |       |       |
|       |       |       |       |       | 4.604 |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CT-65 | CP-1  | 0141  | 3     | CFNR  | 1     | 1     |
| 14-09 |       | 40665 |       |       | Call  | 2.3.0 | 2.4.0 |
|       |       |       |       |       | Flow  |       |       |
|       |       |       |       |       | corre |       |       |
|       |       |       |       |       | ction |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CT-65 | CP-1  | 0142  | 1     | Clar  | 1     | 1     |
| 14-09 |       | 40665 |       |       | ifica | 2.3.0 | 2.4.0 |
|       |       |       |       |       | tions |       |       |
|       |       |       |       |       | on    |       |       |
|       |       |       |       |       | the   |       |       |
|       |       |       |       |       | usage |       |       |
...
|       |       |       |       |       | field |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CT-66 | CP-1  | 0136  | 5     | pho   | 1     | 1     |
| 14-12 |       | 40837 |       |       | ne-co | 2.4.0 | 2.5.0 |
|       |       |       |       |       | ntext |       |       |
|       |       |       |       |       | tel   |       |       |
|       |       |       |       |       | URI   |       |       |
|       |       |       |       |       | para  |       |       |
...
|       |       |       |       |       | ument |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CT-66 | CP-1  | 0145  | 1     | Refe  | 1     | 1     |
| 14-12 |       | 40833 |       |       | rence | 2.4.0 | 2.5.0 |
|       |       |       |       |       | up    |       |       |
|       |       |       |       |       | date: |       |       |
|       |       |       |       |       | RFC   |       |       |
|       |       |       |       |       | 7090  |       |       |
...
|       |       |       |       |       | back) |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CT-66 | CP-1  | 0146  | 1     | Corre | 1     | 1     |
| 14-12 |       | 40837 |       |       | ction | 2.4.0 | 2.5.0 |
|       |       |       |       |       | of    |       |       |
|       |       |       |       |       | wrong |       |       |
|       |       |       |       |       | ind   |       |       |
|       |       |       |       |       | exing |       |       |
...
|       |       |       |       |       | field |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CT-66 | CP-1  | 0147  | 3     | CDIV  | 1     | 1     |
| 14-12 |       | 40837 |       |       | Su    | 2.4.0 | 2.5.0 |
|       |       |       |       |       | bscri |       |       |
|       |       |       |       |       | ption |       |       |
|       |       |       |       |       | op    |       |       |
|       |       |       |       |       | tions |       |       |
...
|       |       |       |       |       | ation |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CT-66 | CP-1  | 0148  | 2     | CDIV  | 1     | 1     |
| 14-12 |       | 40837 |       |       | han   | 2.4.0 | 2.5.0 |
|       |       |       |       |       | dling |       |       |
|       |       |       |       |       | of    |       |       |
|       |       |       |       |       | Hi    |       |       |
|       |       |       |       |       | story |       |       |
...
|       |       |       |       |       | UEs   |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CT-66 | CP-1  | 0149  | 1     | Cla   | 1     | 1     |
| 14-12 |       | 40851 |       |       | rific | 2.4.0 | 2.5.0 |
|       |       |       |       |       | ation |       |       |
|       |       |       |       |       | of    |       |       |
|       |       |       |       |       | Ind   |       |       |
|       |       |       |       |       | exing |       |       |
...
|       |       |       |       |       | field |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CT-66 | CP-1  | 0150  | 1     | sim   | 1     | 1     |
| 14-12 |       | 40837 |       |       | servs | 2.4.0 | 2.5.0 |
|       |       |       |       |       | fil   |       |       |
|       |       |       |       |       | ename |       |       |
|       |       |       |       |       | corre |       |       |
|       |       |       |       |       | ction |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CT-66 | CP-1  | 0153  | 1     | Add   | 1     | 1     |
| 14-12 |       | 40851 |       |       | ition | 2.4.0 | 2.5.0 |
|       |       |       |       |       | of    |       |       |
|       |       |       |       |       | \     |       |       |
|       |       |       |       |       | "mp\" |       |       |
|       |       |       |       |       | para  |       |       |
...
|       |       |       |       |       | Flows |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CT-67 | CP-1  | 0151  | 3     | U     | 1     | 1     |
| 15-03 |       | 50067 |       |       | pdate | 2.5.0 | 2.6.0 |
|       |       |       |       |       | REFER |       |       |
|       |       |       |       |       | to    |       |       |
|       |       |       |       |       | re    |       |       |
|       |       |       |       |       | flect |       |       |
...
|       |       |       |       |       | 6665  |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CT-67 | CP-1  | 0154  | 1     | Corre | 1     | 1     |
| 15-03 |       | 50073 |       |       | ction | 2.5.0 | 2.6.0 |
|       |       |       |       |       | of    |       |       |
|       |       |       |       |       | stat  |       |       |
|       |       |       |       |       | ement |       |       |
|       |       |       |       |       | about |       |       |
...
|       |       |       |       |       | field |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CT-67 | CP-1  | 0155  | 1     | Style | 1     | 1     |
| 15-03 |       | 50082 |       |       | corre | 2.6.0 | 3.0.0 |
|       |       |       |       |       | ction |       |       |
|       |       |       |       |       | of    |       |       |
|       |       |       |       |       | hea   |       |       |
|       |       |       |       |       | dings |       |       |
...
|       |       |       |       |       | 4.604 |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CT-67 | CP-1  | 0156  |       | Corre | 1     | 1     |
| 15-03 |       | 50082 |       |       | ction | 2.6.0 | 3.0.0 |
|       |       |       |       |       | on    |       |       |
|       |       |       |       |       | norm  |       |       |
|       |       |       |       |       | ative |       |       |
|       |       |       |       |       | words |       |       |
...
|       |       |       |       |       | NOTE  |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CT-67 | CP-1  | 0157  | 1     | Impr  | 1     | 1     |
| 15-03 |       | 50082 |       |       | oving | 2.6.0 | 3.0.0 |
|       |       |       |       |       | the   |       |       |
|       |       |       |       |       | c     |       |       |
|       |       |       |       |       | onsis |       |       |
|       |       |       |       |       | tency |       |       |
...
|       |       |       |       |       | busy  |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CT-68 | CP-1  | 0158  | 2     | Emer  | 1     | 1     |
| 15-06 |       | 50328 |       |       | gency | 3.0.0 | 3.1.0 |
|       |       |       |       |       | calls |       |       |
|       |       |       |       |       | and   |       |       |
|       |       |       |       |       | CDIV  |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CT-68 | CP-1  | 0161  | 1     | CDIV  | 1     | 1     |
| 15-06 |       | 50328 |       |       | --    | 3.0.0 | 3.1.0 |
|       |       |       |       |       | c     |       |       |
|       |       |       |       |       | ause- |       |       |
|       |       |       |       |       | param |       |       |
|       |       |       |       |       | s     |       |       |
...
|       |       |       |       |       | ction |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CT-68 | CP-1  | 0166  | 3     | CDIV  | 1     | 1     |
| 15-06 |       | 50290 |       |       | --    | 3.0.0 | 3.1.0 |
|       |       |       |       |       | tel   |       |       |
|       |       |       |       |       | and   |       |       |
|       |       |       |       |       | SIP   |       |       |
|       |       |       |       |       | URI   |       |       |
...
|       |       |       |       |       | ction |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CT-69 | CP-1  | 0173  | 1     | SIP   | 1     | 1     |
| 15-09 |       | 50503 |       |       | URI   | 3.1.0 | 3.2.0 |
|       |       |       |       |       | conve |       |       |
|       |       |       |       |       | rsion |       |       |
|       |       |       |       |       | in    |       |       |
|       |       |       |       |       | CDIV  |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CT-69 | CP-1  | 0174  | 2     | Han   | 1     | 1     |
| 15-09 |       | 50530 |       |       | dling | 3.1.0 | 3.2.0 |
|       |       |       |       |       | of    |       |       |
|       |       |       |       |       | P-E   |       |       |
|       |       |       |       |       | arly- |       |       |
|       |       |       |       |       | Media |       |       |
...
|       |       |       |       |       | CFNR  |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CT-70 | CP-1  | 0176  | 2     | CDIV  | 1     | 1     |
| 15-12 |       | 50709 |       |       | s     | 3.2.0 | 3.3.0 |
|       |       |       |       |       | erice |       |       |
|       |       |       |       |       | not   |       |       |
|       |       |       |       |       | regis |       |       |
|       |       |       |       |       | tered |       |       |
...
|       |       |       |       |       | user  |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CT-70 | CP-1  | 0178  | 3     | Re    | 1     | 1     |
| 15-12 |       | 50709 |       |       | moval | 3.2.0 | 3.3.0 |
|       |       |       |       |       | of    |       |       |
|       |       |       |       |       | \     |       |       |
|       |       |       |       |       | "rn\" |       |       |
|       |       |       |       |       | and   |       |       |
...
|       |       |       |       |       | CDIV  |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CT-70 | CP-1  | 0179  | 1     | Se    | 1     | 1     |
| 15-12 |       | 50709 |       |       | rvice | 3.2.0 | 3.3.0 |
|       |       |       |       |       | capab |       |       |
|       |       |       |       |       | ility |       |       |
|       |       |       |       |       | unc   |       |       |
|       |       |       |       |       | ondit |       |       |
...
|       |       |       |       |       | CDIV  |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CT-71 | CP-1  | 0180  | 2     | Sema  | 1     | 1     |
| 16-03 |       | 60084 |       |       | ntics | 3.3.0 | 3.4.0 |
|       |       |       |       |       | of an |       |       |
|       |       |       |       |       | empty |       |       |
|       |       |       |       |       | a     |       |       |
|       |       |       |       |       | ction |       |       |
...
|       |       |       |       |       | ement |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CT-71 | CP-1  | 0182  | 1     | U     | 1     | 1     |
| 16-03 |       | 60068 |       |       | pdate | 3.3.0 | 3.4.0 |
|       |       |       |       |       | draf  |       |       |
|       |       |       |       |       | t-iet |       |       |
|       |       |       |       |       | f-sip |       |       |
|       |       |       |       |       | core- |       |       |
...
|       |       |       |       |       | 7647  |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | CT-71 | CP-1  | 0183  | 1     | Add a | 1     | 1     |
| 16-03 |       | 60084 |       |       | new   | 3.3.0 | 3.4.0 |
|       |       |       |       |       | CFNR  |       |       |
|       |       |       |       |       | trigg |       |       |
|       |       |       |       |       | ering |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
  ...
  **Date**             **Meeting**   **TDoc**    **CR**   **Rev**   **Cat**   **Subject/Comment**                                                         **New version**
  2016-12              CT-74         CP-160752   0184     1         D         Editorial cleanup                                                           14.0.0
  2017-03              CT-75         CP-170137   0185     1         F         CDIV announcement                                                           14.1.0
  2017-12              CT-78         CP-173080   0186               D         Void unused reference                                                       15.0.0
  2018-03              CT-79         CP-180080   0187     2         B         Interaction between CDIV and \"Enhanced calling name\" service              15.1.0
  2020-03              CT-87e        CP-200123   0188               B         Adding interactions with \"Multi-Device\" and \"Multi-Identity\" services   16.0.0
  -------------------- ------------- ----------- -------- --------- --------- --------------------------------------------------------------------------- -----------------
