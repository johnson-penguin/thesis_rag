...
List of system parameters 8.1 General 8.2 Timers of procedures for V2X
...
V2X communication over LTE-Uu enables transfer of V2X messages between a
...
1\) a T5000 timer indicating how often the UE shall change the source
...
e\) when the UE receives a request from upper layers to send or to
...
iii\) the UE received an ATTACH REJECT message or a TRACKING AREA UPDATE
...
m\) else if the V2X service of the V2X message is identified by a V2X
service identifier, the V2X message contains non-IP data, and the
default V2X application server address applicable for the serving PLMN
and the V2X message family of the non-IP data as specified in
...
The UE should use the V2X application server information received over
...
The media type is intended to be used for V2X communication. The content
...
######## Annex B (informative): Change history
  ...
  *2017-09*            *CT-77*          *CP-172110*    *0007*   *2*       *Supporting cross-carrier operation for V2X communication over PC5*                                                                                         *14.2.0*   
  ...
  *2017-12*            *CT-78*          *CP-173056*    *0015*             *IANA registration of application/vnd.3gpp-v2x-local-service-information MIME type*                                                                         *14.3.0*   
  *2017-12*            *CT-78*          *CP-173056*    *0016*   *1*       *Update of IANA registration form for vnd.3gpp.v2x application MIME type*                                                                                   *14.3.0*   
  -------------------- ---------------- -------------- -------- --------- ----------------------------------------------------------------------------------------------------------------------------------------------------------- ---------- --

  -------------------- ------------- ----------- -------- --------- --------- ---------------------------------------------------------------------- -----------------
  **Change history**                                                                                                                                 
  **Date**             **Meeting**   **TDoc**    **CR**   **Rev**   **Cat**   **Subject/Comment**                                                    **New version**
  2018-06              CT-80         CP-181070   0017               B         Support of reliable transmission over PC5                              15.0.0
  2018-09              CT-81         CP-182152   0018     1         F         Correction for reliable transmission over V2X PC5                      15.1.0
  2018-09              CT-81         CP-182152   0019     1         B         Support of V2X over PC5 message transmission using Tx Profiles         15.1.0
  2018-12              CT-82         CP-183078   0021     2         A         Update of specification reference for V2X message family               15.2.0
  2020-06              CT-88e        CP-201355   0026     3         A         Adding the new V2X message family                                      15.3.0
  2020-06              CT-88e        CP-201116   0024     2         B         Introducing V2X communications over NR-PC5 in EPC                      16.0.0
  2020-06              CT-88e        CP-201356   0027     3         A         Adding the new V2X message family                                      16.0.0
  2020-09              CT-89e        CP-202157   0028               F         Minor correction on V2X over NR-PC5 in EPC                             16.1.0
  2020-09              CT-89e        CP-202192   0029     1         F         Addition of support for V2X services over LTE-Uu interface using TCP   16.1.0
  2020-12              CT-90e        CP-203188   0030               F         V2X message in one or more TCP messages in LTE-Uu                      16.2.0
  2020-12              CT-90e        CP-203188   0031               F         Application Identifier                                                 16.2.0
  2023-06              CT-100        CP-231281   0036     \-        A         Removal of editor\'s note related to the IANA registration             16.3.0
  -------------------- ------------- ----------- -------- --------- --------- ---------------------------------------------------------------------- -----------------
