...
for scenario 2 6.3 OperationsInvokedByNM Interface (M) 6.3.1
...
Figure 4.1.1.1 shows the System Context for scenario 1. The LC and NM
...
|                  |                        | isUnique: False        |
|                  | the MFCN (if needed)   |                        |
|                  | have been applied      | defaultValue:          |
