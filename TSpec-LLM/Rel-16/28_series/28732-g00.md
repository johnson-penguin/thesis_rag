...
This IOC represents the Transport Network Interface technology (e.g.
ATM, IP).
...
|                      |                      |                      |
|                      | allowedValues: CBR,  | defaultValue: N/A    |
|                      | RT-VBR, NRT-VBR,     |                      |
...
|                      |                      | isNullable: False    |
+----------------------+----------------------+----------------------+
| maximumBurstSizeEg   | Maximum Burst Size   | type: Integer        |
|                      | (MBS) for VBR        |                      |
|                      | Service Categories   | multiplicity: 1      |
|                      | for Egress traffic.  |                      |
|                      |                      | isOrdered: N/A       |
