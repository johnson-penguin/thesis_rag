...
\[18\] 3GPP TS 22.220: "Service requirements for Home Node B (HNB) and
Home eNode B (HeNB)"
...
The Home NodeB, represented by the \<\<SupportIOC\>\> HNB, has
...
The Local Gateway, represented by the \<\<SupportIOC\>\>
