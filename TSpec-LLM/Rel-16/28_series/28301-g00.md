...
[9](#use-case-1-trigger-lc-registration)
...
**REQ-LC-IRP-SC2-CON-001: The LSA licensee shall be able to use LSA
spectrum resources.**
...
|                       | incumbents from the LR. |               |
+-----------------------+-------------------------+---------------+
| **Begins when**       | The NM detects a change |               |
