...
While the user experience for the IMS Multimedia Telephony service is
...
|                      | based on standard    | application server   |
...
CFNRc shall interact with the following services according to the
following:
