...
For the purpose of this report, the following clauses clarify the
...
The UICC is the physical and logical platform for the USIM. It does at
...
\- A 2G VLR/SGSN only supports 2G AKA and can only be attached to a 2G
...
\- \"The basic mandatory UE requirements are: Support for GSM phase 2
...
In case of a UICC inserted in a 3G ME, nothing but the 3G command set
...
The services n° 27 and n° 38 are both optional. Network operators can
...
**Case 4:** ME, ICC and HLR/AuC are 3G, BSS and VLR/SGSN are 2G. This
...
**Case 7:** All involved system elements are 3G, except for the VLR/SGSN
...
**Case 4:** ME, BSS and VLR/SGSN are 2G, ICC and HLR/AuC are 3G. This
...
**Case 6:** All system elements are 2G, except for the ICC and the
...
**Case 1:** ME, BSS and VLR/SGSN are 3G, the ICC is 2G (i.e. a SIM).
...
However, both applications may share certain elements, either to enable
...
2.  **Separate IMSI & Shared Secret Key:** From a functional point of
...
**- Dynamic mapping:** CHV1 is mapped to the USIM application PIN but
...
A 3G or 2G/3G dual mode ME or a 2G ME of R99 or Rel-4 with USIM support
...
This implies that a 12 etu reception turnaround guardtime is supported
...
This annex illustrates the possible CHV mappings for a
single-verification capable and a multi-verification capable UICC. In
the diagrams D.2 and D.3, the gray box highlights the difference between
the two solutions.
...
######### Annex E: Change history
  ...
  ------------------- -------------- ------------------- -------- --------- ------------------------------------------------------------------------------------------------------ ---------
  **TSG \# / Date**   **TSG Doc.**   **Doc 2nd level**   **CR**   **Rev**   **Subject/Comment**                                                                                    **New**
  TP-11               TP-010045                          \-       \-        Presented for information to TSG-T \#11                                                                1.0.0
  \-                  \-                                 \-       \-        Version after T3 AdHoc \#37 (Joint with SA3), new section 4.4 inserted, section 6.1, case 5 modified   1.1.0
  ...
  TP-16               TP-020119                          006                Extension of Annex C - SIM/USIM file mapping table                                                     5.1.0
                                                         ...
                                                         008                Health warning concerning possibly different file IDs in SIM and USIM                                  
  ...
  TP-27               TP-050024      T3-050168           016      F         Additional USIM Support for 2G Terminals of R99 and Rel-4                                              6.1.0
  CT-30               CP-050501      C6-050833           017      F         Mapping of EF\_LOCI for SIM and USIM application                                                       7.0.0
  CT-31               CP-060025      C6-060168           022      D         Removal of \'all-release applicability\' statement                                                     7.1.0
                                     C6-060169           023      F         Mapping of EF-LOCIGPRS and EF-PSLOCI between SIM                                                       
                                     C6-060170           024      B         Handling of ATR information for SIM and UICC                                                           
  ...
  SA-75                                                                     Upgrade of the specification to Rel-14                                                                 14.0.0
  SA-80                                                                     Upgrade of the specification to Rel-15                                                                 15.0.0
  CT-88e                                                                    Upgrade of the specification to Rel-16                                                                 16.0.0
  ------------------- -------------- ------------------- -------- --------- ------------------------------------------------------------------------------------------------------ ---------
