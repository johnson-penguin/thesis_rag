Compliance template for 3GPP 5G SRIT (Release 15 and beyond)
------------------------------------------------------------
...
|       |       |       |       |       |       |       | LOS.* |
+-------+-------+-------+-------+-------+-------+-------+-------+
|       | eMBB  | Rural | U     | 0.8   | *     | *Yes* | *For  |
|       |       | --    | plink | (120  | 1.0\~ |       | evalu |
|       |       | eMBB  |       | km/h) | 2.79* |       | ation |
|       |       |       |       |       |       |       | con   |
|       |       |       |       |       |       |       | figur |
|       |       |       |       |       |       |       | ation |
|       |       |       |       |       |       |       | A     |
...
| .12)* |       |       |       |       |       |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| **5.2 | Not   | Not   | Not   | At    | *640  | *Yes* | *H    |
| .4.3. | appli | appli | appli | least | MHz*  |       | igher |
| 15**\ | cable | cable | cable | 10    |       |       | f     |
| Band  |       |       |       | 0 MHz |       |       | reque |
| width |       |       |       |       |       |       | ncies |
| and   |       |       |       |       |       |       | e.g.  |
| Sc    |       |       |       |       |       |       | above |
