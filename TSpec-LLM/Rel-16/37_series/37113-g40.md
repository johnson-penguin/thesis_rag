...
8.7 Telecommunication ports 29
...
NOTE: For NR, scope of this specification is limited to *BS type 1-C*.
...
\[23\] IEC 61000-4-3: \"Electromagnetic compatibility (EMC) - Part 4-3:
...
\- The Absolute Radio Frequency Channel Number (UARFCN) for UTRA
carrier,
...
The value of F~UL\_low~ and F~UL\_high~ are defined for each operating
...
<tr class="even">
<td>Emission tests</td>
<td><p>C: TC1a</p>
<p>CNC: NTC1a</p>
<p>C/NC: TC1a and NTC1a</p></td>
<td><p>C: TC1a</p>
<p>CNC: NTC1a</p>
<p>C/NC: TC1a and NTC1a</p></td>
<td>C: TC1b</td>
...
<tr class="odd">
<td>Immunity tests</td>
<td><p>C: TC1a</p>
<p>CNC: NTC1a</p>
<p>C/NC: TC1a, NTC1a</p></td>
<td><p>C: TC1a</p>
<p>CNC: NTC1a</p>
<p>C/NC: TC1a, NTC1a</p></td>
<td>C: TC1b</td>
...
<tr class="even">
<td><p>NOTE 1: Void</p>
<p>NOTE 2: The support of NB-IoT in-band operation is optional and declared by the manufacturer. If not supported, the test configurations denoted by "NI" shall not be used for testing.</p>
...
The BER of the uplink shall be assessed during the test according to one
...
System not compliant with table 8.2.1.4-1 2 does not increase the
probability of passing a EUT that would otherwise have failed a test if
a Test System compliant with table 8.2.1.4-1 had been used.
...
\[34\], annex A, table A.2 and table A.3 may be used.
...
The test method shall be in accordance with CISPR 32 \[34\] and the
...
CISPR 32 \[34\]. The reference earth point of the AMNs shall be
...
The equipment shall meet the limits according to CISPR 32 \[11\] table
A.10, which are defined the average detector receiver and for quasi-peak
detector receiver. If the average limit is met when using a quasi‑peak
detector, the equipment shall be deemed to meet both limits and
measurement with the average detector receiver is not necessary.
...
The requirements of IEC 61000‑3‑2 \[19\] for harmonic current emission
...
61000-3-12 \[20\] applies.

8.6 Voltage fluctuations and flicker (AC mains input port)
----------------------------------------------------------

The requirements of IEC 61000‑3‑3 \[21\] for voltage fluctuations and
...
phase, IEC 61000-3-12 \[20\] applies.
...
CISPR 32 \[34\] table A.12, clause A12.2.
...
Alternatively, for equipment intended to be used in telecommunication
centres only, the limits given in CISPR 32 \[11\] table A.11 clause
A11.2 shall be used.
...
mobile simulator) and the S1/Iub/ Abis interface (e.g. with an
RNC/EPC/BSC simulator) and evaluating the BLER/throughput/BER (see
Figure 9.1-1);
...
S1/Iub/ Abis interface. BLER/throughput/BER evaluation may be carried
out at either interface, where appropriate, and the measurements for the
Uplink and Downlink paths may be carried out as a single path looped at
either the radio interface or S1/Iub/ Abis interface. In case of looping
is used care have to be taken that the BLER/throughput/BER information
...
reverberation chamber test method according to IEC 61000-4-21 \[40\],
...
circuit voltage as given in IEC 61000‑4‑4 \[25\];
...
where appropriate, see IEC 61000‑4‑6 \[26\].
...
IEC 61000‑4‑6 \[26\] corresponding to 3 V rms, at a transfer impedance
of 150 Ω;
...
basic standard IEC 61000-4-6 \[26\];
...
9.7.2.1 (telecommunication ports, outdoor cables), subclause 9.7.2.2
...
1 kV line to ground as given in IEC 61000-4-5 \[28\]. In this case the
total output impedance of the surge generator shall be in accordance
with the basic standard IEC 61000-4-5 \[28\].
...
accordance with the basic standard IEC 61000-4-5 \[28\].
...
The BER at the output of the transmitter may be assessed using either of
the techniques described below.

A.1.1 Assessment of BER using static layer 1 functions
------------------------------------------------------

The transmitter under test shall be operated according to the test case
of TS 51.021 \[10\], subclause 6.1.2.

The bit sequence from the output of the transmitter shall be monitored
by the test system according to the test case of TS 51.021 \[10\],
subclause 7.1.2, and the BER of the class 2 bits for TCH/FS assessed.
The BER shall not exceed the values specified in subclause 6.1 of the
present document.

If the EUT does not support TCH/FS, the manufacturer shall declare the
logical channel for which the performance shall be assessed, and the
...
meets the requirements of TS 51.010-1 \[33\] for the assessment of
RXQUAL. The level of the signal supplied to the equipment should be
within the range for which the assessment of RXQUAL is not impaired. The
RXQUAL shall be monitored during the test. The RXQUAL shall not exceed
the values specified in subclause 6.1 of the present document.

NOTE: This equipment can be a GSM mobile station with suitable provision
for the monitoring of RXQUAL.

A.2 Assessment of BER at the output of a receiver
=================================================

The BER at the output of the receiver may be assessed using either of
the techniques described below.

A.2.1 Assessment of BER using RXQUAL
------------------------------------

The value of the RXQUAL reported by the BTS or BSS shall be monitored
using suitable test equipment.

A.2.2 Assessment of BER using reported BER
------------------------------------------

The BER of the class 2 bits at the output of the receiver shall be
assessed using suitable test equipment.

If the EUT does not support TCH/FS, the manufacturer shall declare the
logical channel for which the performance shall be assessed, and the
corresponding performance criteria.

NOTE: This can be performed by a \"test loopback\" which uses the
transmitter of the BTS to return the data which has been decoded by the
receiver back to the test equipment which generated the bit sequence.
For immunity tests of signal ports, the \"test loopback\" includes an
external connection between signal ports.
...
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | R     | R4-1  |       |       |       | Spe   | 0.0.1 |
| 10-02 | 4\#54 | 00572 |       |       |       | cific |       |
|       |       |       |       |       |       | ation |       |
|       |       |       |       |       |       | ske   |       |
|       |       |       |       |       |       | leton |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | R     | R4-1  |       |       |       | E     | 0.1.0 |
| 10-04 | 4\#55 | 01577 |       |       |       | -mail |       |
|       |       |       |       |       |       | app   |       |
|       |       |       |       |       |       | roved |       |
|       |       |       |       |       |       | Text  |       |
|       |       |       |       |       |       | Prop  |       |
...
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | R     | RP-1  |       |       |       | App   | 9.0.0 |
| 10-06 | P\#48 | 00581 |       |       |       | roval |       |
|       |       |       |       |       |       | by    |       |
|       |       |       |       |       |       | TSG   |       |
|       |       |       |       |       |       | RAN.  |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | RP-49 | RP-1  | 002   | 1     |       | EMC   | 9.1.0 |
| 10-09 |       | 00923 |       |       |       | up    |       |
|       |       |       |       |       |       | dates |       |
|       |       |       |       |       |       | for   |       |
|       |       |       |       |       |       | mult  |       |
...
|       |       |       |       |       |       | ement |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | RP-49 | RP-1  | 001   |       |       | CR    | 1     |
| 10-09 |       | 00927 |       |       |       | LTE   | 0.0.0 |
|       |       |       |       |       |       | \_TDD |       |
|       |       |       |       |       |       | \_260 |       |
|       |       |       |       |       |       | 0\_US |       |
|       |       |       |       |       |       | spe   |       |
...
|       |       |       |       |       |       | range |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | RP-50 | RP-1  | 006   |       |       | MSR   | 1     |
| 10-12 |       | 01346 |       |       |       | test  | 0.1.0 |
|       |       |       |       |       |       | con   |       |
|       |       |       |       |       |       | figur |       |
|       |       |       |       |       |       | ation |       |
|       |       |       |       |       |       | for   |       |
|       |       |       |       |       |       | EMC   |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | RP-50 | RP-1  | 008   |       |       | Corre | 1     |
| 10-12 |       | 01346 |       |       |       | ction | 0.1.0 |
|       |       |       |       |       |       | of CR |       |
|       |       |       |       |       |       | impl  |       |
|       |       |       |       |       |       | ement |       |
|       |       |       |       |       |       | ation |       |
...
|       |       |       |       |       |       | 7.113 |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | RP-50 | RP-1  | 004   | 1     |       | Band  | 1     |
| 10-12 |       | 01356 |       |       |       | 42    | 0.1.0 |
|       |       |       |       |       |       | and   |       |
|       |       |       |       |       |       | 43    |       |
|       |       |       |       |       |       | param |       |
|       |       |       |       |       |       | eters |       |
...
|       |       |       |       |       |       | 7.113 |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | RP-52 | RP-1  | 014   | 1     |       | Add   | 1     |
| 11-06 |       | 10812 |       |       |       | 2GHz  | 0.2.0 |
|       |       |       |       |       |       | S     |       |
|       |       |       |       |       |       | -Band |       |
|       |       |       |       |       |       | (Band |       |
|       |       |       |       |       |       | 23)   |       |
...
|       |       |       |       |       |       | 7.113 |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | RP-53 | RP-1  | 017   |       |       | Add   | 1     |
| 11-09 |       | 11255 |       |       |       | Band  | 0.3.0 |
|       |       |       |       |       |       | 22    |       |
|       |       |       |       |       |       | /XXII |       |
|       |       |       |       |       |       | for   |       |
|       |       |       |       |       |       | LTE   |       |
...
|       |       |       |       |       |       | 7.113 |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | RP-54 | RP-1  | 018   | 1     |       | Re    | 1     |
| 11-12 |       | 11734 |       |       |       | moval | 0.4.0 |
|       |       |       |       |       |       | of    |       |
|       |       |       |       |       |       | refer |       |
|       |       |       |       |       |       | ences |       |
|       |       |       |       |       |       | to    |       |
...
|       |       |       |       |       |       | h)    |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | RP-54 | RP-1  | 019   | 1     |       | EMC   | 1     |
| 11-12 |       | 11735 |       |       |       | re    | 0.4.0 |
|       |       |       |       |       |       | quire |       |
|       |       |       |       |       |       | ments |       |
|       |       |       |       |       |       | for   |       |
|       |       |       |       |       |       | M     |       |
|       |       |       |       |       |       | SR-NC |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | RP-55 | RP-1  | 020   |       |       | Add   | 1     |
| 12-03 |       | 20305 |       |       |       | Exte  | 1.0.0 |
|       |       |       |       |       |       | nding |       |
|       |       |       |       |       |       | 850   |       |
|       |       |       |       |       |       | MHz   |       |
|       |       |       |       |       |       | Upper |       |
...
|       |       |       |       |       |       | 7.113 |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | RP-56 | RP-1  | 023   |       |       | In    | 1     |
| 12-06 |       | 20793 |       |       |       | trodu | 1.1.0 |
|       |       |       |       |       |       | ction |       |
|       |       |       |       |       |       | of    |       |
|       |       |       |       |       |       | AP    |       |
|       |       |       |       |       |       | AC700 |       |
...
|       |       |       |       |       |       | 7.113 |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | RP-56 | RP-1  | 025   |       |       | In    | 1     |
| 12-06 |       | 20791 |       |       |       | trodu | 1.1.0 |
|       |       |       |       |       |       | ction |       |
|       |       |       |       |       |       | of    |       |
|       |       |       |       |       |       | e85   |       |
|       |       |       |       |       |       | 0\_LB |       |
...
|       |       |       |       |       |       | 7.113 |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | RP-60 | RP-1  | 026   |       |       | In    | 1     |
| 13-06 |       | 30792 |       |       |       | trodu | 2.0.0 |
|       |       |       |       |       |       | ction |       |
|       |       |       |       |       |       | of    |       |
|       |       |       |       |       |       | Band  |       |
|       |       |       |       |       |       | 30 in |       |
...
|       |       |       |       |       |       | 7.113 |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | RP-60 | RP-1  | 027   |       |       | In    | 1     |
| 13-06 |       | 30790 |       |       |       | trodu | 2.0.0 |
|       |       |       |       |       |       | ction |       |
|       |       |       |       |       |       | of    |       |
|       |       |       |       |       |       | LTE   |       |
|       |       |       |       |       |       | 450   |       |
...
|       |       |       |       |       |       | 7.113 |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | RP-64 | RP-1  | 033   |       |       | In    | 1     |
| 14-06 |       | 40914 |       |       |       | trodu | 2.1.0 |
|       |       |       |       |       |       | ction |       |
|       |       |       |       |       |       | of    |       |
|       |       |       |       |       |       | band  |       |
|       |       |       |       |       |       | 29 in |       |
...
|       |       |       |       |       |       | 7.113 |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | RP-64 | RP-1  | 029   |       |       | In    | 1     |
| 14-06 |       | 40926 |       |       |       | trodu | 2.1.0 |
|       |       |       |       |       |       | ction |       |
|       |       |       |       |       |       | of    |       |
|       |       |       |       |       |       | Band  |       |
|       |       |       |       |       |       | 32/   |       |
...
|       |       |       |       |       |       | 7.113 |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | RP-65 | RP-1  | 0036  | 1     |       | U     | 1     |
| 14-09 |       | 41562 |       |       |       | pdate | 2.2.0 |
|       |       |       |       |       |       | of    |       |
|       |       |       |       |       |       | d     |       |
|       |       |       |       |       |       | efini |       |
|       |       |       |       |       |       | tions |       |
...
|       |       |       |       |       |       | 7.113 |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | RP-66 | RP-1  | 038   |       |       | EMC   | 1     |
| 14-12 |       | 42146 |       |       |       | te    | 2.3.0 |
|       |       |       |       |       |       | sting |       |
|       |       |       |       |       |       | of    |       |
|       |       |       |       |       |       | multi |       |
|       |       |       |       |       |       | -band |       |
...
|       |       |       |       |       |       | BS    |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | RP-70 | RP-1  | 0039  |       |       | In    | 1     |
| 15-12 |       | 52171 |       |       |       | trodu | 3.0.0 |
|       |       |       |       |       |       | ction |       |
|       |       |       |       |       |       | of    |       |
|       |       |       |       |       |       | Band  |       |
|       |       |       |       |       |       | 65    |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | RP-70 | RP-1  | 0040  |       |       | In    | 1     |
| 15-12 |       | 52172 |       |       |       | trodu | 3.0.0 |
|       |       |       |       |       |       | ction |       |
|       |       |       |       |       |       | of    |       |
|       |       |       |       |       |       | Band  |       |
|       |       |       |       |       |       | 66    |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | RP-70 | RP-1  | 0041  |       |       | In    | 1     |
| 15-12 |       | 52157 |       |       |       | trodu | 3.0.0 |
|       |       |       |       |       |       | ction |       |
|       |       |       |       |       |       | of    |       |
|       |       |       |       |       |       | Band  |       |
|       |       |       |       |       |       | 67    |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | RP-70 | RP-1  | 0042  |       |       | In    | 1     |
| 15-12 |       | 52173 |       |       |       | trodu | 3.0.0 |
|       |       |       |       |       |       | ction |       |
|       |       |       |       |       |       | of    |       |
|       |       |       |       |       |       | 14    |       |
|       |       |       |       |       |       | 47-14 |       |
...
|       |       |       |       |       |       | 7.113 |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | RP-71 | RP-1  | 0043  |       | B     | In    | 1     |
| 16-03 |       | 60483 |       |       |       | trodu | 3.1.0 |
|       |       |       |       |       |       | ction |       |
|       |       |       |       |       |       | of    |       |
|       |       |       |       |       |       | Band  |       |
|       |       |       |       |       |       | 68    |       |
...
|       |       |       |       |       |       | 7.113 |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | RP-71 | RP-1  | 0044  |       | F     | In    | 1     |
| 16-03 |       | 60490 |       |       |       | trodu | 3.1.0 |
|       |       |       |       |       |       | ction |       |
|       |       |       |       |       |       | of    |       |
|       |       |       |       |       |       | Band  |       |
|       |       |       |       |       |       | 46 in |       |
...
|       |       |       |       |       |       | 7.113 |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | RP-72 | RP-1  | 0047  | \-    | F     | Cla   | 1     |
| 16-06 |       | 61142 |       |       |       | rific | 3.2.0 |
|       |       |       |       |       |       | ation |       |
|       |       |       |       |       |       | in    |       |
|       |       |       |       |       |       | EMC   |       |
|       |       |       |       |       |       | env   |       |
...
|       |       |       |       |       |       | ences |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | RP-72 | RP-1  | 0052  | \-    | F     | Nece  | 1     |
| 16-06 |       | 61141 |       |       |       | ssary | 3.2.0 |
|       |       |       |       |       |       | up    |       |
|       |       |       |       |       |       | dates |       |
|       |       |       |       |       |       | in    |       |
|       |       |       |       |       |       | 3     |       |
...
|       |       |       |       |       |       | 69    |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | RP-74 | RP-1  | 0054  | \-    | A     | CR to | 1     |
| 16-12 |       | 62379 |       |       |       | TS    | 4.1.0 |
|       |       |       |       |       |       | 3     |       |
|       |       |       |       |       |       | 7.113 |       |
|       |       |       |       |       |       | --    |       |
|       |       |       |       |       |       | In    |       |
...
|       |       |       |       |       |       | 48    |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | RP-76 | RP-1  | 0068  | \-    | A     | CR on | 1     |
| 17-06 |       | 71285 |       |       |       | eLAA  | 4.2.0 |
|       |       |       |       |       |       | BS    |       |
|       |       |       |       |       |       | for   |       |
|       |       |       |       |       |       | TS    |       |
|       |       |       |       |       |       | 3     |       |
...
|       |       |       |       |       |       | 7.113 |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | RP-77 | RP-1  | 0071  | \-    | B     | CR to | 1     |
| 17-09 |       | 71952 |       |       |       | 37    | 5.0.0 |
|       |       |       |       |       |       | .113: |       |
|       |       |       |       |       |       | In    |       |
|       |       |       |       |       |       | trodu |       |
|       |       |       |       |       |       | ction |       |
...
|       |       |       |       |       |       | 71    |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | RP-77 | RP-1  | 0073  | \-    | B     | CR to | 1     |
| 17-09 |       | 71950 |       |       |       | 37    | 5.0.0 |
|       |       |       |       |       |       | .113: |       |
|       |       |       |       |       |       | In    |       |
|       |       |       |       |       |       | trodu |       |
|       |       |       |       |       |       | ction |       |
...
|       |       |       |       |       |       | B76   |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | RP-77 | RP-1  | 0074  | \-    | B     | In    | 1     |
| 17-09 |       | 71946 |       |       |       | trodu | 5.0.0 |
|       |       |       |       |       |       | ction |       |
|       |       |       |       |       |       | of    |       |
|       |       |       |       |       |       | Band  |       |
|       |       |       |       |       |       | 72    |       |
...
|       |       |       |       |       |       | 7.113 |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | RA    | RP-1  | 0076  | \-    | B     | In    | 1     |
| 17-12 | N\#78 | 72593 |       |       |       | trodu | 5.1.0 |
|       |       |       |       |       |       | ction |       |
|       |       |       |       |       |       | of    |       |
|       |       |       |       |       |       | Band  |       |
|       |       |       |       |       |       | 73    |       |
...
|       |       |       |       |       |       | 7.113 |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | RA    | RP-1  | 0078  | \-    | B     | CR to | 1     |
| 18-03 | N\#79 | 80279 |       |       |       | 37    | 5.2.0 |
|       |       |       |       |       |       | .113: |       |
|       |       |       |       |       |       | In    |       |
|       |       |       |       |       |       | trodu |       |
|       |       |       |       |       |       | ction |       |
...
|       |       |       |       |       |       | 85    |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | RA    | RP-1  | 0079  | 1     | F     | CR to | 1     |
| 18-03 | N\#79 | 80282 |       |       |       | TS    | 5.2.0 |
|       |       |       |       |       |       | 37    |       |
|       |       |       |       |       |       | .113: |       |
|       |       |       |       |       |       | corre |       |
|       |       |       |       |       |       | ction |       |
...
|       |       |       |       |       |       | 52)   |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | RA    | RP-1  | 0082  | 1     | B     | CR to | 1     |
| 18-06 | N\#80 | 81075 |       |       |       | TS    | 5.3.0 |
|       |       |       |       |       |       | 3     |       |
|       |       |       |       |       |       | 7.113 |       |
|       |       |       |       |       |       | (MSR  |       |
|       |       |       |       |       |       | EMC): |       |
...
|       |       |       |       |       |       | dates |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | RA    | RP-1  | 0084  | 1     | F     | CR to | 1     |
| 18-09 | N\#81 | 81896 |       |       |       | TS    | 5.4.0 |
|       |       |       |       |       |       | 37    |       |
|       |       |       |       |       |       | .113: |       |
|       |       |       |       |       |       | corre |       |
|       |       |       |       |       |       | ction |       |
...
|       |       |       |       |       |       | ction |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | RA    | RP-1  | 0088  | 1     | B     | U     | 1     |
| 18-12 | N\#82 | 82362 |       |       |       | pdate | 5.5.0 |
|       |       |       |       |       |       | the   |       |
|       |       |       |       |       |       | title |       |
|       |       |       |       |       |       | to    |       |
|       |       |       |       |       |       | add   |       |
...
|       |       |       |       |       |       | ation |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | RA    | RP-1  | 0094  | 1     | F     | CR to | 1     |
| 19-06 | N\#84 | 91236 |       |       |       | TS    | 5.6.0 |
|       |       |       |       |       |       | 3     |       |
|       |       |       |       |       |       | 7.113 |       |
|       |       |       |       |       |       | subc  |       |
|       |       |       |       |       |       | lause |       |
|       |       |       |       |       |       | 4.5   |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | RA    | RP-1  | 0095  | 1     | F     | CR to | 1     |
| 19-09 | N\#85 | 92019 |       |       |       | TS    | 5.7.0 |
|       |       |       |       |       |       | 3     |       |
|       |       |       |       |       |       | 7.113 |       |
|       |       |       |       |       |       | Corre |       |
|       |       |       |       |       |       | ction |       |
...
|       |       |       |       |       |       | tions |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | RA    | RP-1  | 0105  |       | F     | CR to | 1     |
| 19-12 | N\#86 | 93002 |       |       |       | TS    | 5.8.0 |
|       |       |       |       |       |       | 3     |       |
|       |       |       |       |       |       | 7.113 |       |
|       |       |       |       |       |       | Corre |       |
|       |       |       |       |       |       | ction |       |
...
|       |       |       |       |       |       | se6.2 |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | RA    | RP-2  | 0109  | 1     | F     | Draft | 1     |
| 20-06 | N\#88 | 00984 |       |       |       | CR to | 5.9.0 |
|       |       |       |       |       |       | 3     |       |
|       |       |       |       |       |       | 7.113 |       |
|       |       |       |       |       |       | I     |       |
|       |       |       |       |       |       | ntrod |       |
...
|       |       |       |       |       |       | (MCC) |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | RA    | RP-2  | 0111  | 1     | A     | CR to | **16. |
| 20-12 | N\#90 | 02489 |       |       |       | TS    | 1.0** |
|       |       |       |       |       |       | 3     |       |
|       |       |       |       |       |       | 7.113 |       |
|       |       |       |       |       |       | on    |       |
|       |       |       |       |       |       | Vo    |       |
...
|       |       |       |       |       |       | 16    |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | RA    | RP-2  | 0113  |       | A     | CR to | **16. |
| 21-06 | N\#92 | 11086 |       |       |       | TS    | 2.0** |
|       |       |       |       |       |       | 37    |       |
|       |       |       |       |       |       | .113: |       |
|       |       |       |       |       |       | Rad   |       |
|       |       |       |       |       |       | iated |       |
...
|       |       |       |       |       |       | pment |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | RA    | RP-2  | 0117  |       | F     | CR to | **16. |
| 23-03 | N\#99 | 30502 |       |       |       | TS    | 3.0** |
|       |       |       |       |       |       | 3     |       |
|       |       |       |       |       |       | 7.113 |       |
|       |       |       |       |       |       | MSR   |       |
|       |       |       |       |       |       | base  |       |
...
|       |       |       |       |       |       | R16   |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | RA    | RP-2  | 0120  |       | A     | TS    | **16. |
| 23-03 | N\#99 | 30505 |       |       |       | 37    | 3.0** |
|       |       |       |       |       |       | .113: |       |
|       |       |       |       |       |       | C     |       |
|       |       |       |       |       |       | orrec |       |
|       |       |       |       |       |       | tions |       |
...
|       |       |       |       |       |       | unity |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | RAN   | RP-2  | 0125  |       | A     | CR on | **16. |
| 23-06 | \#100 | 31357 |       |       |       | TS    | 4.0** |
|       |       |       |       |       |       | 3     |       |
|       |       |       |       |       |       | 7.113 |       |
|       |       |       |       |       |       | MSR   |       |
|       |       |       |       |       |       | base  |       |
