...
[18](#get-stapplicationsessionsstsessionid)
...
[33](#a.3-traffic-steering-control-information-update)
...
\[5\] 3GPP TS 29.201: \"Representational State Transfer (REST) reference
...
JSON Content Rules: JSON Content Rules (JCR), as defined in IETF
...
NOTE: In order to allow the PCRF to select and provision an application
...
Upon receipt of the HTTP PUT, the TSSF shall respond to the PCRF
...
POST /stapplication/notification/pcrf.example.com;378388838383;123232
HTTP/1.1
...
The flow-description, a tos-traffic-class, security-parameter-index and
...
The ts-rule-base-name field is of type string, and it indicates the name
...
An error object shall contain the error-type field and the
error-message.
...
This clause defines the JSON schema for reports provided by the TSSF to
...
|       |       |       |       |       |       | St    |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | C     | CP-1  | 0003  | 3     | B     | Up    | 1     |
| 16-03 | T\#71 | 60091 |       |       |       | dates | 3.1.0 |
|       |       |       |       |       |       | to    |       |
|       |       |       |       |       |       | JSON  |       |
|       |       |       |       |       |       | co    |       |
|       |       |       |       |       |       | ntent |       |
...
|       |       |       |       |       |       | PCRF  |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | C     | CP-1  | 0004  | 1     | B     | JSON  | 1     |
| 16-03 | T\#71 | 60091 |       |       |       | co    | 3.1.0 |
|       |       |       |       |       |       | ntent |       |
|       |       |       |       |       |       | rules |       |
|       |       |       |       |       |       | up    |       |
|       |       |       |       |       |       | dates |       |
...
|       |       |       |       |       |       | St    |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | C     | CP-1  | 0008  | 4     | F     | O     | 1     |
| 16-12 | T\#74 | 60619 |       |       |       | verla | 3.2.0 |
|       |       |       |       |       |       | pping |       |
|       |       |       |       |       |       | IP    |       |
|       |       |       |       |       |       | Addr  |       |
|       |       |       |       |       |       | esses |       |
...
|       |       |       |       |       |       | FMSS  |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | C     | CP-1  | 0009  | 3     | F     | Su    | 1     |
| 16-12 | T\#74 | 60619 |       |       |       | pport | 3.2.0 |
|       |       |       |       |       |       | of    |       |
|       |       |       |       |       |       | d     |       |
|       |       |       |       |       |       | eploy |       |
|       |       |       |       |       |       | ments |       |
...
|       |       |       |       |       |       | TSSF  |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | C     | CP-1  | 0010  | 1     | F     | Corre | 1     |
| 16-12 | T\#74 | 60619 |       |       |       | ction | 3.2.0 |
|       |       |       |       |       |       | of    |       |
|       |       |       |       |       |       | IETF  |       |
|       |       |       |       |       |       | n     |       |
|       |       |       |       |       |       | ewton |       |
...
|       |       |       |       |       |       | hemas |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | C     | CP-1  | 0013  | 2     | F     | UE    | 1     |
| 16-12 | T\#74 | 60619 |       |       |       | IPv4  | 3.2.0 |
|       |       |       |       |       |       | ad    |       |
|       |       |       |       |       |       | dress |       |
|       |       |       |       |       |       | pr    |       |
|       |       |       |       |       |       | ovisi |       |
|       |       |       |       |       |       | oning |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | C     | CP-1  | 0012  | 1     | F     | Dia   | 1     |
| 16-12 | T\#74 | 60616 |       |       |       | meter | 4.0.0 |
|       |       |       |       |       |       | base  |       |
|       |       |       |       |       |       | pro   |       |
|       |       |       |       |       |       | tocol |       |
|       |       |       |       |       |       | spe   |       |
...
|       |       |       |       |       |       | pdate |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | C     | CP-1  | 0015  | 1     | D     | R     | 1     |
| 17-06 | T\#76 | 71133 |       |       |       | emove | 4.2.0 |
|       |       |       |       |       |       | the   |       |
|       |       |       |       |       |       | Void  |       |
|       |       |       |       |       |       | refe  |       |
|       |       |       |       |       |       | rence |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | C     | CP-1  | 0017  | 1     | A     | Corre | 1     |
| 17-06 | T\#76 | 71120 |       |       |       | ction | 4.2.0 |
|       |       |       |       |       |       | of    |       |
|       |       |       |       |       |       | IETF  |       |
|       |       |       |       |       |       | n     |       |
|       |       |       |       |       |       | ewton |       |
...
|       |       |       |       |       |       | rsion |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | C     | CP-1  | 0021  | \-    | A     | Corre | 1     |
| 17-09 | T\#77 | 72038 |       |       |       | ction | 4.3.0 |
|       |       |       |       |       |       | of    |       |
|       |       |       |       |       |       | res   |       |
|       |       |       |       |       |       | ource |       |
|       |       |       |       |       |       | path  |       |
...
|       |       |       |       |       |       | lease |       |
+-------+-------+-------+-------+-------+-------+-------+-------+
| 20    | C     | CP-1  | 0024  | \-    | A     | Refe  | 1     |
| 19-06 | T\#84 | 91091 |       |       |       | rence | 5.1.0 |
|       |       |       |       |       |       | up    |       |
|       |       |       |       |       |       | date: |       |
|       |       |       |       |       |       | d     |       |
|       |       |       |       |       |       | raft- |       |
