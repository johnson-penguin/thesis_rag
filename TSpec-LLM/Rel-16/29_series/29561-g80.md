...
[18](#dn-interworking-model-of-smf-for-dhcp)
...
[52](#use-of-the-supported-features-avp-on-the-n6-reference-point)
...
[65](#message-flows-for-network-slice-specific-authentication-1)
...
13.2.3 IMS specific procedures in the SMF 13.2.3.1 Provisioning of
...
\- if requested by the UE at PDU session establishment, the SMF may
...
In the following subclauses, the AS is used as an example for the
...
NOTE: The SMF+PGW-C can initiate RADIUS re-authorization procedure
...
2\. The AMF sends Nsmf\_PDUSession\_CreateSMContext Request including
...
VSA defined in subclause 16.4.7 of 3GPP TS 29.061 \[5\]
  ...
  16                                                     3GPP-GGSN-Ipv6-Address             Re-used. It includes (home) SMF control plane IPv6 address providing the Nsmf\_PDUSession service.
...
Interim-Update messages. Present for a FN-BRG accessing the 5GC via
...
MULPI \[53\]. It shall comply with the syntax specified in clause 2.2 of
IETF RFC 7542 \[54\] for the username part of a NAI.
...
+----------+----------+----------+----------+----------+----------+
| Sub-attr | Sub-a    | Des      | Presence | As       | Appli    |
| \#       | ttribute | cription | Req      | sociated | cability |
|          | Name     |          | uirement | a        |          |
|          |          |          |          | ttribute |          |
|          |          |          |          |          |          |
|          |          |          |          | (        |          |
...
|          |          |          |          | ub-attr) |          |
+----------+----------+----------+----------+----------+----------+
| 110      | 3        | It       | Optional | Acces    |          |
|          | GPP-Noti | includes |          | s-Accept |          |
|          | fication | all      |          |          |          |
|          |          | notif    |          |          |          |
|          |          | ications |          |          |          |
|          |          | that the |          |          |          |
...
|          |          | SMF.     |          |          |          |
+----------+----------+----------+----------+----------+----------+
| 111      | 3GP      | It is    | Optional | Access-  |          |
|          | P-UE-MAC | sent     |          | Request, |          |
|          | -Address | from the |          |          |          |
|          |          | DN-AAA   |          | Access-R |          |
|          |          | to       |          | esponse, |          |
|          |          | a        |          |          |          |
...
|          |          | DN-AAA.  |          |          |          |
+----------+----------+----------+----------+----------+----------+
| 112      | 3GPP     | It is    | Optional | Access   |          |
|          | -Authori | sent     |          | -Accept, |          |
|          | zation-R | from the |          |          |          |
|          | eference | DN-AAA   |          | Change-  |          |
|          |          | to refer |          | of-Autho |          |
|          |          | to the   |          | rization |          |
|          |          | local    |          |          |          |
|          |          | autho    |          |          |          |
...
|          |          | the SMF. |          |          |          |
+----------+----------+----------+----------+----------+----------+
| 113      | 3GPP-    | It is    | Optional | Access   |          |
|          | Policy-R | sent     |          | -Accept, |          |
|          | eference | from the |          |          |          |
|          |          | DN-AAA   |          | Change-  |          |
|          |          | and used |          | of-Autho |          |
|          |          | by the   |          | rization |          |
...
|          |          | release. |          |          |          |
+----------+----------+----------+----------+----------+----------+
| 114      | 3        | It is    | Optional | Access   |          |
|          | GPP-Sess | sent     |          | -Accept, |          |
|          | ion-AMBR | from the |          |          |          |
|          |          | DN-AAA   |          | Change-  |          |
|          |          | to       |          | of-Autho |          |
|          |          | a        |          | rization |          |
...
|          |          | uplink.  |          |          |          |
+----------+----------+----------+----------+----------+----------+
| 115      | 3GPP-NAI | The      | Optional | Access-  |          |
|          |          | Network  |          | Request, |          |
|          |          | Access   |          |          |          |
|          |          | Id       |          | Ac       |          |
|          |          | entifier |          | counting |          |
...
|          |          |          |          | m-Update |          |
+----------+----------+----------+----------+----------+----------+
| 116      | 3GPP     | It is    | Optional | Access   | eSes     |
|          | -Session | sent     |          | -Accept, | sionAMBR |
|          | -AMBR-v2 | from the |          |          |          |
|          |          | DN-AAA   |          | Change-  |          |
|          |          | to       |          | of-Autho |          |
|          |          | a        |          | rization |          |
...
|          |          | DL.      |          |          |          |
+----------+----------+----------+----------+----------+----------+
| 117      | 3GPP-Su  | It       | Optional | Access-  |          |
|          | pported- | i        |          | Request, |          |
|          | Features | ndicates |          |          |          |
|          |          | the      |          | Access   |          |
|          |          | s        |          | -Accept, |          |
...
|          |          |          |          | START    |          |
+----------+----------+----------+----------+----------+----------+
| 118      | 3        | It       | Optional | Access-  |          |
|          | GPP-IP-A | i        |          | Request, |          |
|          | ddress-P | ndicates |          |          |          |
|          | ool-Info | the IP   |          | Access   |          |
|          |          | address  |          | -Accept, |          |
|          |          | pool     |          |          |          |
|          |          | ide      |          | Ac       |          |
|          |          | ntifier. |          | counting |          |
...
|          |          |          |          | m-Update |          |
+----------+----------+----------+----------+----------+----------+
| 119      | 3GPP     | It is    | Optional | Access   |          |
|          | -VLAN-Id | sent     |          | -Accept, |          |
|          |          | from the |          |          |          |
|          |          | DN-AAA   |          | Change-  |          |
|          |          | to       |          | of-Autho |          |
...
|          |          | session. |          |          |          |
+----------+----------+----------+----------+----------+----------+
| 120      | 3GPP     | I        | Optional | Access-  |          |
|          | -TNAP-Id | ndicates |          | Request, |          |
|          | entifier | the UE   |          |          |          |
|          |          | location |          | Ac       |          |
|          |          | in a     |          | counting |          |
|          |          | Trusted  |          | -Request |          |
...
|          |          |          |          | m-Update |          |
+----------+----------+----------+----------+----------+----------+
| 121      | 3GPP-HF  | I        | Optional | Access   |          |
|          | C-NodeId | ndicates |          | -Request |          |
|          |          | the HFC  |          | (NOTE),  |          |
|          |          | Node     |          |          |          |
|          |          | Id       |          | Ac       |          |
|          |          | entifier |          | counting |          |
...
|          |          | network  |          |          |          |
+----------+----------+----------+----------+----------+----------+
| 122      | 3GPP-GLI | I        | Optional | Access   |          |
|          |          | ndicates |          | -Request |          |
|          |          | the      |          | (NOTE),  |          |
|          |          | Global   |          |          |          |
|          |          | Line     |          | Ac       |          |
...
|          |          |          |          | m-Update |          |
+----------+----------+----------+----------+----------+----------+
| 123      | 3GPP-L   | I        | Optional | Access   |          |
|          | ine-Type | ndicates |          | -Request |          |
|          |          | the type |          | (NOTE),  |          |
|          |          | of the   |          |          |          |
|          |          | wireline |          | Ac       |          |
|          |          | (DLS or  |          | counting |          |
...
|          |          |          |          | m-Update |          |
+----------+----------+----------+----------+----------+----------+
| 124      | 3GPP-NID | Indicate | Optional | Access-  |          |
|          |          | the      |          | Request, |          |
|          |          | network  |          | Ac       |          |
|          |          | ide      |          | counting |          |
|          |          | ntifier. |          | -Request |          |
...
|          |          | an SNPN. |          |          |          |
+----------+----------+----------+----------+----------+----------+
| 129      | 3GPP-GCI | I        | Optional | Access   |          |
|          |          | ndicates |          | -Request |          |
|          |          | the line |          | (NOTE),  |          |
|          |          | co       |          |          |          |
|          |          | nnecting |          | Ac       |          |
...
|             |             | above       |             |             |
+-------------+-------------+-------------+-------------+-------------+
| 6           | S           | Indicates   | 17          | Optional    |
|             | ervice-Type | the type of | (Authorize  |             |
|             |             | service for | Only)       |             |
|             |             | this user.  |             |             |
+-------------+-------------+-------------+-------------+-------------+
...
+-------------+-------------+-------------+-------------+-------------+
| 10          | 3GPP-NSAPI  | identifies  | UTF-8       | Optional    |
|             |             | QFI with    | encoded     |             |
...
|             |             | session.    |             |             |
+-------------+-------------+-------------+-------------+-------------+
| 30          | Called      | Identifier  | DNN (UTF-8  | Optional    |
...
|             |             |             | (NOTE 6)    |             |
+-------------+-------------+-------------+-------------+-------------+
| 79          | EAP-Message | This        | String      | Conditional |
|             |             | attribute   |             |             |
|             |             | e           |             | NOTE 3      |
|             |             | ncapsulates |             |             |
|             |             | EAP message |             |             |
...
|             |             | details.    |             |             |
+-------------+-------------+-------------+-------------+-------------+
| 80          | Message-Au  | This        | String      | Conditional |
|             | thenticator | attribute   |             |             |
|             |             | includes    |             | NOTE 3      |
|             |             | the message |             |             |
|             |             | aut         |             |             |
|             |             | henticator, |             |             |
...
|             | IPv6-Prefix | IPv6 prefix |             | NOTE 4      |
|             |             | to the      |             |             |
|             |             | user.       |             |             |
+-------------+-------------+-------------+-------------+-------------+
| 26/10415    | 3GPP        | Sub         | See         | Optional    |
|             | Vend        | -attributes | clause 11.3 |             |
|             | or-Specific | according   |             |             |
|             |             | c           |             |             |
|             |             | lause 11.3, |             |             |
|             |             | the         |             |             |
|             |             | encoding of |             |             |
...
NOTE: The SMF+PGW-C can initiate Diameter re-authorization procedure
without re-authentication with the DN-AAA server based on local policy.
The DN-AAA server decides the actions to take (e.g. to request another
re-authorization without the association with EAP based
re-authentication or release the session) is out of 3GPP scope.
...
message to a DN-AAA server. Upon receipt of the DER message, the DN-AAA
server shall respond with an DEA message. Multi-round authentication
using the DEA and DER messages may be used. The DN-AAA server finally
authenticates and authorizes the user by replying with the DEA message.
...
DEA message. Multi-round authentication using the DEA and DER messages
may be used. The DN-AAA server finally authenticates and authorizes the
user by replying with the DEA message.
...
in the initial request, the Auth-Request-Type AVP to \"AUTHORIZE\_ONLY\"
...
the Session-Timeout attribute in the Access-Accept, the SMF may use the
...
the user. This message also indicates to the DN-AAA server that the user
session has started.
...
response message in Namf\_Communication\_N1N2MessageTransfer service
...
further transferred to UE via Namf\_Communication\_N1N2MessageTransfer
...
NAS SM Transport message and Nsmf\_PDUSession\_UpdateSMContext service,
...
In the case of home routed, the H-SMF may wait for the
Accounting-Response (START) before sending the Nsmf\_PDUSession\_Update
service in step 13.
...
DN-AAA server upon occurrence of a chargeable event, e.g. RAT change or
QoS change. Interim updates are also used when the IPv4 address and/or
IPv6 prefix is allocated/released/re-allocated.
...
sending the response for the triggering signalling message (i.e.
Namf\_Communication\_N1N2MessageTransfer). The SMF may delete the QoS
flow if the Accounting Answer is not received from the DN-AAA server.
...
Nsmf\_PDUSession\_UpdateSMContext) from the AMF before sending the ASA
to the DN-AAA server.
...
\"AUTHORIZE\_ONLY\" to the SMF. On receipt of the RAR from the DN-AAA
...
Re-Auth-Request-Type value \"AUTHORIZE\_AUTHENTICATE\" to the SMF. The
...
figure 12.2.1-1, from step 4 to step 11, and step 13. The
Auth-Request-Type in the DER is set to \"AUTHORIZE\_AUTHENTICATE\".
...
<tr class="odd">
<td>3GPP-Authorization-Reference</td>
<td>112</td>
<td>11.3.1</td>
<td>OctetString</td>
<td>V</td>
...
<tr class="even">
<td>3GPP-IP-Address-Pool-Info</td>
<td>118</td>
<td>11.3.1</td>
<td>OctetString</td>
<td>V</td>
...
<tr class="odd">
<td><p>NOTE 1: The AVP header bit denoted as 'M', indicates whether support of the AVP is required. The AVP header bit denoted as 'V', indicates whether the optional Vendor-ID field is present in the AVP header. For further details, see IETF RFC 6733 [24].</p>
<p>NOTE 2: The value types are defined in IETF RFC 6733 [24].</p>
<p>NOTE 3: The use of Radius VSA as a Diameter vendor AVP is described in Diameter NASREQ (IETF RFC 7155 [23]) and the P flag may be set.</p>
<p>NOTE 4: It is not used in this release.</p></td>
<td></td>
<td></td>
<td></td>
<td></td>
...
in 5G and the VSAs defined in subclause 16.4.7 of 3GPP TS 29.061 \[5\].
...
+----------------------+--------------+-----+----------------------+
| 0                    | eSessionAMBR | M   | This feature         |
|                      |              |     | indicates the        |
|                      |              |     | support of enhanced  |
|                      |              |     | Session AMBR         |
|                      |              |     | function. If         |
|                      |              |     | supported, the       |
|                      |              |     | DN-AAA authorizes DL |
|                      |              |     | and/or UL Session    |
|                      |              |     | AMBR separately.     |
+----------------------+--------------+-----+----------------------+
| Feature bit: The     |              |     |                      |
...
DIAMETER\_QOS\_FLOW\_DELETION\_INDICATION (2421)
...
this subclause. Other Diameter AVPs as defined in IETF RFC 4072 \[25\]
and IETF RFC 7155 \[23\], even if their AVP flag rules are marked with
\"M\", are not required for being compliant with the current
specification.

Diameter messages as defined in subclause 16.4 of 3GPP TS 29.061 \[5\]
are re-used in 5G with the following differences:
...
3GPP-Line-Type AVP may be included in the AAR and ACR command.
...
**3GPP TS 29.061 \[5\]** are described in the following subclauses.
...
initial access request (e.g. Nsmf\_PDUSession\_CreateSMContext) message
...
If the PDU Session is used for IMS (identified by DNN), the SMF shall
not modify the fields Type of Service (IPv4) and Traffic Class (IPv6).
...
Service (IPv4) and Traffic Class (IPv6) (see subclause L.3.2.4 of
3GPP TS 24.229 \[13\]).
...
3GPP TS 23.380 \[38\], subclause 5.8.3); or
...
Session as specified in 3GPP TS 23.316 \[43\] subclause 7.7.1. When
support of multicast routing protocol is provided at the N6 interface,
...
5G, multiple authentication methods using Extensible Authentication
Protocol (EAP) may be used such as EAP-TLS (see IETF RFC 5216 \[11\]),
EAP-TTLS (see IETF RFC 5281 \[37\]). The NSSAAFor AAA-P shall implement
...
receives Nnssaaf\_NSSAA\_Authenticate request from AMF, the RADIUS
client function shall send the authentication information with network
slice information to a NSS-AAA server directly or via an AAA-P.
...
When the NSSAAF receives Nnssaaf\_NSSAA\_Authenticate request from AMF,
it shall send a RADIUS Access-Request message with EAP extension to an
...
4\. The AMF sends Nnssaaf\_NSSAA\_Authenticate Request to the NSSAAF
...
Nnssaaf\_NSSAA\_Authenticate service and NAS Network Slice-Specific
Authentication Command message. UE responds to the received
authentication/authorization data and such information is transferred in
NAS Network Slice-Specific Authentication Complete message and
Nnssaaf\_NSSAA\_Authenticate service, then finally sent to the NSS-AAA
by the NSSAAF, via the AAA-P if the AAA-P is used, in the Access-Request
message.
...
17\. The NSSAAF sends a Nnssaaf\_NSSAA\_Authenticate Response with the
...
the NSS-AAA server, the NSSAAF shall release the resources, interact
with its succeeding Network Function AMF which is got from the UDM by
Nudm\_UECM\_GET service operation with GPSI and reply with a
...
Nudm\_UECM\_GET or Nnssaaf\_NSSAA\_Notify response) from the succeeding
...
follows sd attribute specified in subclause 5.4.4.2 of
...
|          |          |          |          | ub-attr) |          |
+----------+----------+----------+----------+----------+----------+
| 200      | 3GPP     | It       | Con      | Access   |          |
|          | -S-NSSAI | includes | ditional | -Request |          |
|          |          | the      | (NOTE)   |          |          |
|          |          | S-NSSAI. |          |          |          |
+----------+----------+----------+----------+----------+----------+
| NOTE:    |          |          |          |          |          |
...
receives Nnssaaf\_NSSAA\_Authenticate request from AMF, the Diameter
client function shall send the authentication information with network
...
NSSAAF receives Nnssaaf\_NSSAA\_Authenticate request from AMF, it shall
...
further transferred to UE via AMF by Nnssaaf\_NSSAA\_Authenticate
service and NAS MM Transport message. UE responds to the received
authentication/authorization data and such information is transferred in
NAS Network Slice-Specific Authentication Complete message and
Nnssaaf\_NSSAA\_Authenticate service, then finally sent to the NSS-AAA
by the NSSAAF, via the AAA-P if the AAA-P is used, in the DER message.
...
NSS-AAA server, the NSSAAF shall release the corresponding resources,
interact with its succeeding Network Function AMF which is got from the
UDM by Nudm\_UECM\_GET service operation with GPSI and reply with a
Diameter ASA message. It is not necessary for the NSSAAF to wait for the
response (i.e. Nudm\_UECM\_GET or Nnssaaf\_NSSAA\_Notify response) from
its succeeding Network Function before sending the ASA message to the
NSS-AAA server or AAA-P.
...
server, the NSSAAF shall interact with its succeeding Network Function
AMF which is got from the UDM by Nudm\_UECM\_GET service operation with
GPSI and reply with a Diameter RAA message. It is not necessary for the
NSSAAF to wait for the response (i.e. Nudm\_UECM\_GET or
Nnssaaf\_NSSAA\_Notify response) from its succeeding Network Function
before sending the RAA message to the NSS-AAA server or AAA-P.

After replying Nnssaaf\_NSSAA\_Notify response, the AMF shall start
...
<td><p>NOTE 1: The AVP header bit denoted as 'M', indicates whether support of the AVP is required. The AVP header bit denoted as 'V', indicates whether the optional Vendor-ID field is present in the AVP header. For further details, see IETF RFC 6733 [24].</p>
<p>NOTE 2: The value types are defined in IETF RFC 6733 [24].</p>
<p>NOTE 3: The use of Radius VSA as a Diameter vendor AVP is described in Diameter NASREQ (IETF RFC 7155 [23]) and the P flag may be set.</p></td>
<td></td>
<td></td>
<td></td>
<td></td>
...
|                                     |         |     |             |
+-------------------------------------+---------+-----+-------------+
| Feature bit: The order number of    |         |     |             |
| the bit within the Feature-List AVP |         |     |             |
| where the least significant bit is  |         |     |             |
| assigned number \"0\".              |         |     |             |
|                                     |         |     |             |
| Feature: A short name that can be   |         |     |             |
| used to refer to the bit and to the |         |     |             |
| feature, e.g. \"5GC\".              |         |     |             |
|                                     |         |     |             |
| M/O: Defines if the implementation  |         |     |             |
| of the feature is mandatory (\"M\") |         |     |             |
| or optional (\"O\") in this 3GPP    |         |     |             |
| Release.                            |         |     |             |
|                                     |         |     |             |
...
Diameter messages as defined in subclause 12.6 are re-used for network
...
######## Annex B (informative): Change history
  ...
  **Date**             **TSG \#**   **TSG Doc.**   **CR**   **Rev**   **Cat**   **Subject/Comment**                                                                                                                                           **New**
  ...
  2021-03              CT\#91e      CP-210202      0095     \-        F         Reporting GCI to RADIUS DN-AAA server                                                                                                                         16.7.0
  2021-03              CT\#91e      CP-210202      0096     \-        F         Reporting GCI to Diameter DN-AAA server                                                                                                                       16.7.0
  2021-06              CT\#92e      CP-211237      0099     1         F         Clarify 5GS interworking with EPS for EAP based secondary AUTH in RADIUS message flow                                                                         16.8.0
  2021-06              CT\#92e      CP-211237      0101     1         F         Clarify EPS interworking for EAP based secondary AUTH in Diameter message flow                                                                                16.8.0
  2021-06              CT\#92e      CP-211209      0104     1         A         Correction to Framed IP                                                                                                                                       16.8.0
  -------------------- ------------ -------------- -------- --------- --------- ------------------------------------------------------------------------------------------------------------------------------------------------------------- ---------
