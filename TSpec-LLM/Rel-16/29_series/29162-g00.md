![](media/image1.jpeg){width="7.0875in" height="1.5722222222222222in"}
...
[15](#control-plane-interworking-1)
...
[45](#trgw-resource-congestion-in-add-response-request-is-queued)
...
security for RTP based media 10.2.10.2 End-to-end security for TCP based
...
\[52\] 3GPP TS 26.441: \"Codec for Enhanced Voice Services (EVS);
General Overview\".
...
**MSC Server enhanced for SRVCC**: An MSC Server that supports the
...
**Mx reference point:** The protocol applied at the Mx reference point
...
\- media transcoding if the media that was used prior to the access
...
When the IMS-ALG has received the requested information, the IMS-ALG
...
\- The IBCF can perform screening of SIP request and SIP responses based
...
\- include the minimum packet rate assumed when re-calculating the
...
Table 4: Derivation of IPv4 Header from IPv6 Header (fragmentation)
  ...
  **IPv4 field**                    **Value**
  ...
  Type of Service and Precedence:   The default behaviour is that the value of the IPv4 field Type of service field is the value of the IPv6 Traffic class field (all 8 bits are copied). An im­plementation of a TrGW should also provide the ability to ignore the value of the IPv6 Traffic Class and always set the IPv4 Type of Service field to zero.
...
\- fragment the IPv4 packets so that their length, excluding the IPv4
...
If the IBCF and available TrGW support transcoding, the IBCF may add
...
An IBCF may support the end-to-end IMS media plane security for TCP
...
Upon reception of the 2xx response to the initial INVITE request, the
...
\- if the IBCF includes the \"ecn-capable-rtp\" attribute within the
...
If the TrGW acts as ECN endpoint and detects an ECN-related error case,
...
\- Under conditions specified in 3GPP TS 29.079 \[39\], the IBCF
...
NOTE: The specific Ix related call sequence which details the handling
...
a\) Upon receipt of an SDP offer containing the image attribute(s) from
...
\- \"send\" keyword and corresponding image sizes which the TrGW
...
Figure 10.2.23.3.2.1 shows the message sequence chart example for
...
\- request the TrGW to reserve resources for all of these configurations
...
via SDP offer/answer exchange through an extension defined in
3GPP TS 26.114 \[36\] of the RTCP feedback capability attribute
\"a=rtcp-fb\" as defined in IETF RFC 4585 \[61\].

If the IBCF and the TrGW support the \"DBI\" signalling, they shall
apply the requirements and procedures specified in 3GPP TS 23.334 \[43\]
subclause 5.26 and subclause 6.2.25.
...
This procedure is used to configure or reconfigure an termination at the
TrGW.
...
|             |           |             |             | nsparently. |
+-------------+-----------+-------------+-------------+-------------+
| Reserve and | TrGW      | Context     | M           | This        |
...
NOTE: No requirement for statistics in the Release TrGW Termination Ack
has been justified by a use case.
...
Table 10.4.1.5.1: IP Bearer Released
  ...
  IP Bearer Released       TrGW        Context                    M                              This information element indicates the context for the bearer termination.
  ...
  IP Bearer Released Ack   IBCF        Context                    M                              This information element indicates all context are where the command was executed.
...
Table 10.4.1.6.1: Media Inactivity Notification
  ...
  ----------------------------------- ----------- -------------------------- ------------------------------ -------------------------------------------------------------------------------------------------------------------
  Procedure                           Initiated   Information element name   Information element required   Information element description
  Media Inactivity Notification       TrGW        Context                    M                              This information element indicates the existing context for the bearer termination.
                                                  ...
                                                  Media Inactivity           M                              This information element notifies the IBCF of Media inactivity detection on the bearer termination.
  Media Inactivity Notification Ack   IBCF        Context                    M                              This information element indicates the context where the command was executed.
...
Table 10.4.1.7.1: Termination heartbeat indication
  ...
  -------------------------------------- ----------- -------------------------- ------------------------------ ------------------------------------------------------------------------------------------------------------
  Procedure                              Initiated   Information element name   Information element required   Information element description
  Termination heartbeat indication       TrGW        Context                    M                              This information element indicates the context for the bearer termination.
  ...
  Termination heartbeat indication Ack   IBCF        Context                    M                              This information element indicates the context where the command was executed.
...
Table 10.4.1.8.1: Change Through-Connection
  ...
  ------------------------------- ----------- ----------------------------------------------- ------------------------------ --------------------------------------------------------------------------------------------------------------------------------------------------
  Procedure                       Initiated   Information element name                        Information element required   Information element description
  Change Through-Connection       IBCF        Context/Context Request                         M                              This information element indicates the existing context or requests a new context for the bearer termination.
  ...
  Change Through-Connection Ack   TrGW        Context                                         M                              This information element indicates the context where the command was executed.
                                              Bearer Termination                              M                              This information element indicates the bearer termination where the command was executed.
  ------------------------------- ----------- ----------------------------------------------- ------------------------------ --------------------------------------------------------------------------------------------------------------------------------------------------
...
This procedure is used to report ECN related failures (see clause
10.2.13.3a).

Table 10.4.1.9.1: Procedures toward the IM Subsystem: ECN Failure
Indication

  -------------------------- ----------- -------------------------- ------------------------------ --------------------------------------------------------------------------------------------------
  Procedure                  Initiated   Information element name   Information element required   Information element description
  ECN Error Indication       TrGW        Context                    M                              This information element indicates the context for the bearer termination.
  ...
  ECN Error Indication Ack   IBCF        Context                    M                              This information element indicates the context where the command was executed.
                                         Bearer Termination         M                              This information element indicates the bearer termination where the command was executed.
  -------------------------- ----------- -------------------------- ------------------------------ --------------------------------------------------------------------------------------------------
...
terminations within a context for access transfer procedures (see
subclause 10.2.15).

Table 10.4.1.10.1: Procedures toward the IM Subsystem: Change Flow
Direction

  --------------------------- ------------ ---------------------------------------------------- ------------------------------ ----------------------------------------------------------------------------------------------------------------------------------------------
  Procedure                   Initiated    Information element name                             Information element required   Information element description
  Change Flow Direction       IBCF(ATCF)   Context/Context Request                              M                              This information element indicates the existing context or a new context where the flow direction is changed.
  ...
  Change Flow Direction Ack   TrGW(ATGW)   Context                                              M                              This information element indicates the context where the command was executed.
  --------------------------- ------------ ---------------------------------------------------- ------------------------------ ----------------------------------------------------------------------------------------------------------------------------------------------
...
Table 10.4.1.11.1: Procedures toward the IM Subsystem: ICE Connectivity
Check Result Notification

  ------------------------------------------------ ----------- ------------------------------------------ ------------------------------ --------------------------------------------------------------------------------------------------------------------
  Procedure                                        Initiated   Information element name                   Information element required   Information element description
  ICE Connectivity Check Result Notification       TrGW        Context                                    M                              This information element indicates the context for the bearer termination.
  ...
  ICE Connectivity Check Result Notification Ack   IBCF        Context                                    M                              This information element indicates the context where the command was executed.
                                                               Bearer Termination                         M                              This information element indicates the bearer termination where the command was executed.
  ------------------------------------------------ ----------- ------------------------------------------ ------------------------------ --------------------------------------------------------------------------------------------------------------------
...
Table 10.4.1.12.1: Procedures toward the IM Subsystem: ICE New Peer
Reflexive Candidate Notification

  --------------------------------------------------- ----------- --------------------------------------------- ------------------------------ -----------------------------------------------------------------------------------------------------------------------
  Procedure                                           Initiated   Information element name                      Information element required   Information element description
  ICE New Peer Reflexive Candidate Notification       TrGW        Context                                       M                              This information element indicates the context for the bearer termination.
  ...
  ICE New Peer Reflexive Candidate Notification Ack   IBCF        Context                                       M                              This information element indicates the context where the command was executed.
                                                                  Bearer Termination                            M                              This information element indicates the bearer termination where the command was executed.
  --------------------------------------------------- ----------- --------------------------------------------- ------------------------------ -----------------------------------------------------------------------------------------------------------------------

### 10.4.2 Non Call related Procedures

The procedures in table 10.4.2.1 shall be applied between the IBCF and
TrGW.

Table 10.4.2.1: Non-call related procedures

+----------------------+----------------------+----------------------+
| Stage 3 Procedure    | Corresponding        | Remarks              |
| (for information)    | Stage 2 Procedure    |                      |
...
|                      |                      | command              |
+----------------------+----------------------+----------------------+
| Audit Value          | Audit Value          | The \"Audit Value\"  |
|                      |                      | procedure may be     |
|                      |                      | used to determine    |
|                      |                      | the support of       |
|                      |                      | SDPCapNeg in         |
...
| indication           | indication           |                      |
+----------------------+----------------------+----------------------+
| Realm Availability   |                      | See 3GPP             |
| Change Activation    |                      | TS 29.235 \[29\]     |
|                      |                      | subclause A.7.2      |
+----------------------+----------------------+----------------------+
| Realm Availability   |                      | See 3GPP             |
| Change Indication    |                      | TS 29.235 \[29\]     |
|                      |                      | subclause A.7.2      |
+----------------------+----------------------+----------------------+
...
######## Annex B (informative): Change history
  ...
  **Date**             **TSG \#**   **TSG Doc.**   **CR**   **Rev**   **Cat**   **Subject/Comment**                                                                                   **Old**   **New**   
  06-2015              CT-68        CP-150351      0139     \-                  Bearer Termination in Acknowledgements                                                                12.6.0    12.7.0    
  09-2015              CT-69        CP-150483      0141     2         B         Support for Video Enhancements by Region-of-Interest Information Signalling                           12.7.0    13.0.0    
  12-2015              CT-70        CP-150667      0142     11        B         Support of SDP capability negotiation                                                                 13.0.0    13.1.0    
  12-2015              CT-70        CP-150665      0144     4         B         Support for Video Enhancements by Region-of-Interest Information Signalling                           13.0.0    13.1.0    
  **Change history**                                                                                                                                                                                      
  **Date**             **TSG \#**   **TSG Doc.**   **CR**   **Rev**   **Cat**   **Subject/Comment**                                                                                   **New**             
  03-2016              CT\#71       CP-160105      0149     \-        F         Bandwidth adjustment for EVS codec                                                                    13.2.0              
  03-2016              CT\#71       CP-160102      0150     2         B         Support of enhanced bandwidth negotiation mechanism for MTSI sessions                                 13.2.0              
  03-2016              CT\#71       CP-160105      0151     \-        F         Removal of references to TS 26.235                                                                    13.2.0              
  03-2016              CT\#71       CP-160097      0152     4         B         WebRTC media plane optimization procedure                                                             13.2.0              
  06-2016              CT\#72       CP-160269      0153     \-        F         Clarifications related to the enhanced bandwidth negotiation mechanism                                13.3.0              
  09-2016              CT\#73       CP-160451      0154     3         B         Clarification of the gate control procedure between SIP and H.248 for early media over Ix interface   14.0.0              
  12-2016              CT\#74       CP-160625      0155     1         B         Support of RTP-level pause and resume functionality                                                   14.1.0              
  03-2017              CT\#75       CP-170082      0156     \-        F         Correcting references for \"RTP-level pause and resume\" signalling                                   14.2.0              
  03-2017              CT\#75       CP-170082      0157     1         B         RTCP Codec Control Commands and Indications                                                           14.2.0              
  09-2018              CT\#81                                                   Automatic upgrade to Rel-15                                                                           15.0.0              
  06-2019              CT\#84       CP-191107      0159     3         B         Update IBCF and TrGW interworking requirements for DBI support                                        16.0.0              
  -------------------- ------------ -------------- -------- --------- --------- ----------------------------------------------------------------------------------------------------- --------- --------- --
