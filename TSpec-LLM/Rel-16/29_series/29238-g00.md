3GPP TS 29.238 V16.0.0 (2019-06)
...
5.14.3.7 IP Domain Connection (ipdc) 36
...
5.17.3.2 TrGW Out Of Service 72
...
The IBCF domain name is provisioned in the TrGW or retrieved from the
...
+-------------+-------------+-------------+-------------+-------------+
|             | Mandato     | Used in     | Supported   | Provisioned |
|             | ry/Optional | command     | Values      | Value       |
+-------------+-------------+-------------+-------------+-------------+
...
| 10b/0x0001) |             |             |             |             |
+-------------+-------------+-------------+-------------+-------------+
| Congestion  | O           | ADD, MODIFY | \"SDCC\"    | \"RDC       |
| Response    |             |             | (0x0001)    | C\"(0x0002) |
| Method      |             |             | (NOTE 2)    |             |
| (e          |             |             |             |             |
| cnrous/crm, |             |             | \"RDC       |             |
| 0x0         |             |             | C\"(0x0002) |             |
...
|             |             |             | (NOTE1)     |             |
+-------------+-------------+-------------+-------------+-------------+
| Initiation  | M           | ADD, MODIFY | \"rtp\"     | \"leap\"    |
| Method      |             |             | (NOTE 2)    |             |
| (ecnrous/   |             |             |             |             |
| initmethod, |             |             | \"leap\",   |             |
| 0x0         |             |             |             |             |
...
|             |             |             | "inactive\" |             |
+-------------+-------------+-------------+-------------+-------------+
| ECN Mode    | O           | ADD, MODIFY | \"setonly\" | \"setonly\" |
| (ec         |             |             | (0x0001)    | (0x0001) in |
| nrous/mode, |             |             | (NOTE 2)    | the Remote  |
| 0x0         |             |             |             | Descriptor  |
| 10b/0x0004) |             |             | \           | and         |
|             |             |             | "readonly\" | \           |
|             |             |             | (0x0002)    | "readonly\" |
...
#### 5.14.3.18 MG located Bearer Level ALG (mgbalg)

Table 5.14.3.18.1: MG located Bearer Level ALG package
...
5.14.3.19 Enhanced Revised Offer/Answer SDP Support (eroas)

Table 5.14.3.19.1: Enhanced Revised Offer/Answer SDP Support package
...
|                        |                 | to be reserved at this |
|                        |                 | stage (NOTE 1). If the |
|                        |                 | MG does not support    |
|                        |                 | the requested media    |
|                        |                 | value it shall reject  |
...
+----------------------------------+----------------------------------+
| NOTE 1: For IMS-Ix the above     |                                  |
| transports are applicable but    |                                  |
| for CS-Ix only RTP/AVP, TCP and  |                                  |
| udptl are applicable.            |                                  |
|                                  |                                  |
| NOTE 2: Parameter \"udp\" is     |                                  |
| introduced by IETF RFC 4566      |                                  |
| \[8\].                           |                                  |
|                                  |                                  |
| NOTE 3: Upper case TCP is        |                                  |
| defined by IETF RFC 4145 \[11\]  |                                  |
| and registered by IANA. .        |                                  |
|                                  |                                  |
| NOTE 4: Included for support of  |                                  |
| e2e security, in order to permit |                                  |
| rtcph/rsb property to be         |                                  |
| applied. TrGW does not support   |                                  |
| associated SRTP/SRTCP stream     |                                  |
| handling per se. If either       |                                  |
| RTP/SAVP is signalled at any     |                                  |
| termination in a context,or if   |                                  |
| RTP/SAVPF is signalled at any    |                                  |
| termination in a context, the    |                                  |
| TrGW shall not terminate SRTP /  |                                  |
| SRTCP streams and therefore      |                                  |
| shall not reserve any associated |                                  |
| resources, but shall pass media  |                                  |
| transparently, and shall also    |                                  |
| pass related RTCP streams (as    |                                  |
| indicated with the rtcph/rsb     |                                  |
| property) transparently (for     |                                  |
| end-to-end media security).      |                                  |
|                                  |                                  |
| NOTE 5: Codepoint used for e.g.  |                                  |
...
|                        |                 | SDP m-line in the      |
|                        |                 | local and remote       |
|                        |                 | descriptor if the TrGW |
|                        |                 | supports ICE, see also |
|                        |                 | 3GPP TS 24.229 \[45\]. |
|                        |                 | In the local           |
|                        |                 | descriptor, the IBCF   |
|                        |                 | shall provide          |
...
|                        |                 | and remote descriptor  |
|                        |                 | to indicate that the   |
|                        |                 | TrGW shall be prepared |
|                        |                 | to receive and is      |
|                        |                 | allowed to send,       |
|                        |                 | respectively, the RTCP |
|                        |                 | CCM feedback messages  |
|                        |                 | FIR, and/or TMMBR and  |
|                        |                 | TMMBN.                 |
|                        |                 |                        |
|                        |                 | 13\) DBI signalling:   |
|                        |                 |                        |
...
defined in ITU-T Recommendation X.690 \[28\]. Specifically in accordance
with ITU-T Recommendation X.690 \[28\] section 7.3, alternative
encodings based on the definite and indefinite form of length are
permitted by the basic encoding rules as a sender\'s option. Receivers
shall support both alternatives.

Unsupported values of parameters or properties may be reported by the
TrGW and shall be supported by the IBCF as such by using H.248.1 error
code \#449 \"Unsupported or Unknown Parameter or Property Value\". The
unsupported or unknown value is included in the error text in the error
descriptor.
...
|                      | ObservedEvents       | E                    |
|                      | Descriptor           | vents/ObservedEvents |
...
|                      |                      | \"a=fmtp\"-line(s).  |
+----------------------+----------------------+----------------------+
| Connectivity Mode    | Local Control        | ITU-T Recommendation |
|                      |                      | H.248.1 \[3\] Mode   |
|                      |                      | property.            |
|                      |                      |                      |
|                      |                      | Binary Encoding:     |
...
|                      |                      | H.248.52 \[12\].     |
+----------------------+----------------------+----------------------+
| ECN Congestion       | Local descriptor or  | Defined according to |
| Response             | Remote Descriptor    | \"Congestion         |
|                      |                      | Response Method\"    |
|                      |                      | property in ITU-T    |
|                      |                      | Recommendation       |
|                      |                      | H.248.82 \[40\].     |
|                      |                      | (NOTE)               |
+----------------------+----------------------+----------------------+
| ECN ECT Marking      | Local descriptor or  | Defined according to |
|                      | Remote Descriptor    | \"ECT Marking\"      |
|                      |                      | property in ITU-T    |
|                      |                      | Recommendation       |
|                      |                      | H.248.82 \[40\].     |
|                      |                      |                      |
...
|                      |                      | H.248.82 \[40\].     |
+----------------------+----------------------+----------------------+
| ECN Mode             | Local Descriptor or  | Defined according to |
|                      | Remote Descriptor    | the \"ECN Mode\"     |
|                      |                      | property in ITU-T    |
|                      |                      | Recommendation       |
|                      |                      | H.248.82 \[40\].     |
|                      |                      |                      |
|                      |                      | (NOTE)               |
+----------------------+----------------------+----------------------+
| ECN RTCP Feedback    | Local Descriptor or  | \"rtcp-fb\" SDP      |
|                      | Remote Descriptor    | attribute with the   |
|                      |                      | \"nack\" feedback    |
|                      |                      | parameter as         |
|                      |                      | derfined in IETF RFC |
|                      |                      | 4585 \[30\] and the  |
|                      |                      | \"ecn\" parameter    |
|                      |                      | value according to   |
|                      |                      | IETF RFC 6679 \[35\] |
+----------------------+----------------------+----------------------+
| ECN XR Summary       | Local Descriptor or  | \"ecn-sum\" value as |
| Report               | Remote Descriptor    | defined in IETF RFC  |
|                      |                      | 6679 \[35\] within a |
|                      |                      | \"rtcp-xr\" SDP      |
|                      |                      | attribute in         |
|                      |                      | accordance with IETF |
|                      |                      | RFC 3611 \[36\]      |
+----------------------+----------------------+----------------------+
| Emergency Call       | NA                   | ITU-T Recommendation |
| Indication           |                      | H.248.1 \[3\] 6.1.1  |
|                      |                      | Emergency Call       |
|                      |                      | Indicator Binary     |
|                      |                      | Encoding: Encoding   |
|                      |                      | as per ITU-T         |
...
|                      |                      | full ICE.            |
+----------------------+----------------------+----------------------+
| Inactivity Timeout   | Events,              | Defined according to |
|                      |                      | *Inactivity Timeout* |
|                      | Observed Events      | event in ITU-T       |
|                      |                      | Recommendation       |
|                      |                      | H.248.14 \[19\].     |
...
|                      |                      | 29.232 \[21\]        |
+----------------------+----------------------+----------------------+
| IP Realm Identifier  | Local Control        | According to *IP     |
|                      |                      | Realm Identifier*    |
|                      |                      | property in ITU-T    |
|                      |                      | Recommendation       |
|                      |                      | H.248.41 \[14\].     |
...
This section describes the various call related procedures performed by
the TrGW, which are listed in table 15.17.2.1.1

Table 5.17.2.1.1: TrGW Call Related Procedures

+---------------------------+-----------+---------------------------+
| Transaction defined in    | Supported | Comment                   |
| 3GPP TS 29.235 \[17\] or  |           |                           |
| 3GPP TS 29.162 \[18\]     |           |                           |
+---------------------------+-----------+---------------------------+
| Reserve TrGW Connection   | Mandatory | See 5.17.2.2              |
| Point                     |           |                           |
+---------------------------+-----------+---------------------------+
| Configure TrGW Connection | Mandatory | See 5.17.2.3              |
| Point                     |           |                           |
+---------------------------+-----------+---------------------------+
| Reserve and Configure     | Mandatory | See 5.17.2.4              |
| TrGW Connection Point     |           |                           |
+---------------------------+-----------+---------------------------+
| Release TrGW Termination  | Mandatory | See 5.17.2.5              |
+---------------------------+-----------+---------------------------+
...
+---------------------------+-----------+---------------------------+
| ECN Failure Indication    | Optional  | See 5.17.2.10             |
+---------------------------+-----------+---------------------------+
| Change Flow Direction     | Optional  | See 5.17.2.11             |
+---------------------------+-----------+---------------------------+
...
|                      | Context ID = c1      |                      |
|                      |                      | If media is          |
|                      | Termination ID = \$  | \"video\":           |
|                      |                      |                      |
|                      | If Stream Number     | If CVO required:     |
|                      | specified:-          |                      |
|                      |                      | Extended Header for  |
|                      | Stream Number        | CVO                  |
|                      |                      |                      |
|                      | If Resources for     | (NOTE 4, NOTE 5)     |
|                      | multiple Codecs      |                      |
|                      | required:            | If media is          |
|                      |                      | \"video\":           |
|                      | Reserve\_Value       |                      |
|                      |                      | If imageattr         |
|                      | If IP Interface      | negotiation:         |
|                      | Type:                |                      |
|                      |                      | Generic Image        |
|                      | IP interface = \"IP  | Attribute            |
|                      | interface type\"     |                      |
|                      |                      | (NOTE 6)             |
|                      | If indication on     |                      |
|                      | Bearer Released      | If Predefined ROI    |
|                      | requested:           | required:            |
|                      |                      |                      |
|                      | N                    | RTCP feedback for    |
|                      | otificationRequested | Predefined ROI       |
|                      | (Event ID = x, \"BNC |                      |
|                      | Release \")          | Extended Header for  |
|                      |                      | Sent ROI             |
|                      | If diffserv          |                      |
...
|                      | Diffserv Code Point  |                      |
|                      |                      | RTCP feedback for    |
|                      | If tagging behaviour | Arbitrary ROI        |
|                      |                      |                      |
|                      | Diffserv Tagging     | Extended Header for  |
|                      | Behaviour            | Sent ROI             |
|                      |                      |                      |
|                      | If Remote Source     | If ICE is applied:   |
|                      | Address Filtering    |                      |
|                      | required:-           | ICE host candidate   |
|                      |                      | request              |
|                      | Remote Source        |                      |
|                      | Address Filtering    | ICE password request |
|                      |                      |                      |
|                      | If Remote Source     | ICE Ufrag request    |
|                      | Address range        |                      |
|                      | required:-           | If SDPCapNeg is      |
|                      |                      | signalled to the     |
|                      | Remote Source        | gateway:             |
|                      | Address Mask         |                      |
|                      |                      | SDPCapNeg            |
|                      | If Remote Source     | configuration        |
|                      | Port Filtering       |                      |
|                      |                      | }                    |
|                      | required:-           |                      |
|                      |                      |                      |
...
Editor\'s Note: IP Interface Type needs to be further clarified in stage
2 -- possible exclusion for IMS Ix.
...
|                      | required:            | RtcpbwRR             |
| IP Address           |                      |                      |
|                      | Reserve\_Value       | If RTP-level pause   |
| IP Version           |                      | and resume:          |
|                      | If diffserv          |                      |
| }                    | required:-           | CCM pause-resume     |
|                      |                      |                      |
|                      | Diffserv Code Point  | If RTCP Codec        |
|                      |                      | Control Commands and |
|                      | If tagging behaviour | Indications:         |
|                      |                      |                      |
|                      | Diffserv Tagging     | CCM BASE             |
|                      | Behaviour            |                      |
|                      |                      | If RTCP Delay Budget |
|                      | If Remote Source     | Information:         |
|                      | Address Filtering    |                      |
|                      | required:-           | DBI                  |
|                      |                      |                      |
|                      | Remote Source        | If media is          |
|                      | Address Filtering    | \"video\":           |
|                      |                      |                      |
|                      | If Remote Source     | If CVO required:     |
|                      | Address range        |                      |
|                      | required:-           | Extended Header for  |
|                      |                      | CVO                  |
|                      | Remote Source        |                      |
|                      | Address Mask         | (NOTE 6, NOTE 7)     |
|                      |                      |                      |
|                      | If Remote Source     | If media is          |
|                      | Port Filtering       | \"video\":           |
|                      |                      |                      |
|                      | required:-           | If imageattr         |
|                      |                      | negotiation:         |
|                      | Remote Source Port   |                      |
|                      | Filtering            | Generic Image        |
|                      |                      | Attribute            |
|                      | If individual port:- |                      |
|                      |                      | (NOTE 8)             |
|                      | Remote Source Port   |                      |
|                      |                      | If Predefined ROI    |
|                      | If range of ports:   | required:            |
|                      |                      |                      |
|                      | Remote Source Port   | RTCP feedback for    |
|                      | Range                | Predefined ROI       |
|                      |                      |                      |
|                      | N                    | Extended Header for  |
|                      | otificationRequested | Sent ROI             |
|                      | (Event ID = x,       |                      |
|                      |                      | If Arbitrary ROI     |
|                      | \"termination        | required:            |
|                      | heartbeat\")         |                      |
|                      |                      | RTCP feedback for    |
|                      | If multiple IP       | Arbitrary ROI        |
|                      | realms: IP realm     |                      |
|                      | Identifier =         | Extended Header for  |
|                      | required IP realm    | Sent ROI             |
|                      | (NOTE 1)             |                      |
|                      |                      | If SDPCapNeg is      |
...
|                      | Rate                 | Rtpbw                |
|                      |                      |                      |
|                      | Maximum Burst Size   | If rate adaptation   |
|                      |                      | **for media\         |
|                      | If peak data rate    | endpoints**:         |
|                      | policing             |                      |
|                      |                      | Additional           |
|                      | Policing Required    | Bandwidth\           |
|                      |                      | Properties (NOTE 10) |
|                      | Peak Data Rate       |                      |
|                      |                      | If RTCP bandwidth    |
|                      | If Delay Variation   |                      |
|                      | required             | RtcpbwRS             |
|                      |                      |                      |
|                      | Delay Variation      | RtcpbwRR             |
|                      | Tolerance            |                      |
|                      |                      | If RTP-level pause   |
|                      | If RTCP handling     | and resume:          |
|                      | required:            |                      |
|                      |                      | CCM pause-resume     |
|                      | RTCP allocation      |                      |
|                      |                      | If RTCP Codec        |
|                      | If ECN transparent   | Control Commands and |
|                      | support required:    | Indications:         |
|                      | ECN Enable =         |                      |
|                      | \"True\"             | CCM BASE             |
|                      |                      |                      |
|                      | Initiation Method =  | If RTCP Delay Budget |
...
|                      |                      | If CVO required:     |
|                      | Initiation Method =  |                      |
|                      | \"ECN Initiation     | Extended Header for  |
|                      |                      | CVO                  |
|                      | Method\" NOTE 3      |                      |
|                      |                      | (NOTE 6, NOTE 7)     |
|                      | Congestion Response  |                      |
...
|                      |                      | \"video\":           |
|                      | Congestion           |                      |
|                      | Response\"           | If imageattr         |
|                      |                      | negotiation:         |
|                      | NOTE 4               |                      |
|                      |                      | Generic Image        |
|                      | ECN Mode = \"ECN     | Attribute            |
|                      | mode\"               |                      |
|                      |                      | (NOTE 8)             |
|                      | NOTE 4               |                      |
|                      |                      | If Predefined ROI    |
|                      | ECT Marking = \"ECN  | required:            |
|                      | ECT                  |                      |
|                      |                      | RTCP feedback for    |
|                      | marking\" NOTE 4     | Predefined ROI       |
|                      |                      |                      |
|                      | RTCP Feedback =      | Extended Header for  |
|                      | \"ECN RTCP           | Sent ROI             |
|                      |                      |                      |
|                      | Feedback\" NOTE 4    | If Arbitrary ROI     |
|                      |                      | required:            |
|                      | XR Summary Report =  |                      |
|                      | \"ECN XR             | RTCP feedback for    |
|                      |                      | Arbitrary ROI        |
|                      | Summary Report\"     |                      |
|                      | NOTE 4               | Extended Header for  |
|                      |                      | Sent ROI             |
|                      | If notification of   |                      |
|                      | ECN Failure          | If media is          |
|                      |                      | \"message\":         |
|                      | Report:              |                      |
|                      |                      | If B-ALG for MSRP    |
|                      | N                    | required:            |
...
|                      | (Event ID            | MSRP Path            |
|                      |                      |                      |
|                      | = x,\" ECN           | If RTCP APP messages |
|                      | Failure\")           | allowed              |
|                      |                      |                      |
|                      | If full ICE is       | Allowed RTCP APP     |
|                      | applied:             | message              |
|                      |                      |                      |
|                      | Send Connectivity    | types                |
|                      | Check\               |                      |
|                      | (\"Control\")        | If ICE is applied:   |
|                      |                      |                      |
|                      | If notification of   | ICE received         |
|                      | ICE Connectivity     | candidate            |
|                      | Check Result Report: |                      |
|                      |                      | ICE received         |
|                      | N                    | password             |
|                      | otificationRequested |                      |
|                      | (Event ID= xx,       | ICE received Ufrag   |
|                      |                      |                      |
|                      | \"Connectivity Check | (NOTE 9)             |
|                      | Result\")            |                      |
|                      |                      | If SDPCapNeg is      |
|                      | If notification of   | signalled to the     |
|                      | New Peer Reflexive   | gateway:             |
|                      | Candidate:           |                      |
|                      |                      | SDPCapNeg            |
|                      | N                    | configuration        |
|                      | otificationRequested |                      |
...
| may be added by the  |                      |                      |
| Configure\_TrG       |                      |                      |
| W\_Connection\_Point |                      |                      |
| procedure. The       |                      |                      |
| additional streams   |                      |                      |
| shall then carry the |                      |                      |
| same IP Realm        |                      |                      |
| Identifier as the    |                      |                      |
| first stream.        |                      |                      |
|                      |                      |                      |
...
|                      |                      | If RTP-level pause   |
| }                    | Context ID = c1      | and resume:          |
|                      |                      |                      |
|                      | Termination ID = \$  | CCM pause-resume     |
|                      |                      |                      |
|                      | If Stream Number     | If RTCP Codec        |
|                      | Specified:           | Control Commands and |
|                      |                      | Indications:         |
|                      | Stream Number        |                      |
|                      |                      | CCM BASE             |
|                      | If Resources for     |                      |
|                      | multiple Codecs      | If RTCP Delay Budget |
|                      | shall be reserved:   | Information:         |
|                      |                      |                      |
|                      | Reserve\_Value       | DBI                  |
|                      |                      |                      |
|                      | If IP Interface      | If media is          |
|                      | Type:                | \"video\":           |
|                      |                      |                      |
|                      | IP interface = \"IP  | If CVO required:     |
|                      | interface type\"     |                      |
|                      |                      | Extended Header for  |
|                      | If indication on     | CVO                  |
|                      | Bearer Released      |                      |
|                      | requested:           | (NOTE 4, NOTE 5)     |
|                      |                      |                      |
|                      | N                    | If media is          |
|                      | otificationRequested | \"video\":           |
|                      | (Event ID = x, \"BNC |                      |
|                      | Release \")          | If imageattr         |
|                      |                      | negotiation:         |
|                      | If diffserv          |                      |
|                      | required:-           | Generic Image        |
|                      |                      | Attribute            |
|                      | Diffserv Code Point  |                      |
|                      |                      | (NOTE 6)             |
|                      | If tagging behaviour |                      |
|                      |                      | If Predefined ROI    |
|                      | Diffserv Tagging     | required:            |
|                      | Behaviour            |                      |
|                      |                      | RTCP feedback for    |
|                      | If Remote Source     | Predefined ROI       |
|                      | Address Filtering    |                      |
|                      | required:-           | Extended Header for  |
|                      |                      | Sent ROI             |
|                      | Remote Source        |                      |
...
|                      |                      | required:            |
|                      | If Remote Source     |                      |
|                      | Address range        | RTCP feedback for    |
|                      | required:-           | Arbitrary ROI        |
|                      |                      |                      |
|                      | Remote Source        | Extended Header for  |
|                      | Address Mask         | Sent ROI             |
|                      |                      |                      |
|                      | If Remote Source     | If ICE is applied:   |
|                      | Port Filtering       |                      |
|                      |                      | ICE host candidate   |
...
|                      | If individual port:- |                      |
|                      |                      | If SDPCapNeg is      |
|                      | Remote Source Port   | signalled to the     |
|                      |                      | gateway:             |
|                      | If range of ports:   |                      |
|                      |                      | SDPCapNeg            |
|                      | Remote Source Port   | configuration        |
|                      | Range                |                      |
|                      |                      | }                    |
|                      | N                    |                      |
|                      | otificationRequested | Remote Descriptor {  |
|                      | (Event ID = x,       |                      |
|                      |                      | If media is          |
|                      | \"termination        | \"audio\" or         |
|                      | heartbeat\")         | \"video\":           |
|                      |                      |                      |
|                      | If multiple IP       | Codec List           |
|                      | realms: IP realm     |                      |
|                      | Identifier =         | RTP Payloads         |
|                      | required IP realm    |                      |
|                      | identifier           | Rtpbw                |
|                      |                      |                      |
|                      | If Media Inactivity  | If rate adaptation   |
|                      | Detection Required:  | **for media\         |
|                      |                      | endpoints**:         |
|                      | N                    |                      |
|                      | otificationRequested | Additional Bandwidth |
|                      | (Event ID = x,       | Properties\          |
|                      | \"Media Inactivity   | (NOTE 8)             |
|                      | Detection (Media     |                      |
|                      | Inactivity Detection | If RTCP bandwidth    |
|                      | Time, Media          |                      |
|                      | Inactivity Detection | RtcpbwRS             |
|                      | Direction) \") (NOTE |                      |
|                      | 1)                   | RtcpbwRR             |
|                      |                      |                      |
|                      | If Sustainable Data  | If RTP-level pause   |
|                      | Rate Policing        | and resume:          |
|                      | Required:-           |                      |
|                      |                      | CCM pause-resume     |
|                      | Policing Required    |                      |
|                      |                      | If RTCP Codec        |
|                      | Sustainable Data     | Control Commands and |
|                      | Rate                 | Indications:         |
|                      |                      |                      |
|                      | Maximum Burst Size   | CCM BASE             |
|                      |                      |                      |
|                      | If peak data rate    | If RTCP Delay Budget |
|                      | policing             | Information:         |
|                      |                      |                      |
|                      | Policing Required    | DBI                  |
|                      |                      |                      |
|                      | Peak Data Rate       | If media is          |
|                      |                      | \"video\":           |
|                      | If Delay Variation   |                      |
|                      | required             | If CVO required:     |
|                      |                      |                      |
|                      | Delay Variation      | Extended Header for  |
|                      | Tolerance            | CVO                  |
|                      |                      |                      |
|                      | If RTCP handling     | (NOTE 4, NOTE 5)     |
|                      | required:            |                      |
|                      |                      | If media is          |
|                      | RTCP allocation      | \"video\":           |
|                      |                      |                      |
|                      | If ECN transparent   | If imageattr         |
|                      | support required:    | negotiation:         |
|                      | ECN Enable =         |                      |
|                      | \"True\"             | Generic Image        |
|                      |                      | Attribute            |
|                      | Initiation Method =  |                      |
|                      | \"inactive\"         | (NOTE 6)             |
|                      |                      |                      |
|                      | If ECN Endpoint      | If Predefined ROI    |
|                      | support required     | required:            |
|                      |                      |                      |
|                      | ECN Enable =         | RTCP feedback for    |
|                      | \"True\"             | Predefined ROI       |
|                      |                      |                      |
|                      | Initiation Method =  | Extended Header for  |
|                      | \"ECN Initiation     | Sent ROI             |
|                      |                      |                      |
|                      | Method\" NOTE 2      | If Arbitrary ROI     |
|                      |                      | required:            |
|                      | Congestion Response  |                      |
|                      | = \"ECN              | RTCP feedback for    |
|                      |                      | Arbitrary ROI        |
|                      | Congestion           |                      |
|                      | Response\"           | Extended Header for  |
|                      |                      | Sent ROI             |
|                      | NOTE 3               |                      |
|                      |                      | If media is          |
|                      | ECN Mode = \"ECN     | \"message\":         |
|                      | mode\"               |                      |
|                      |                      | If B-ALG for MSRP    |
|                      | NOTE 3               | required:            |
|                      |                      |                      |
|                      | ECT Marking = \"ECN  | MSRP Path            |
|                      | ECT                  |                      |
|                      |                      | If RTCP APP messages |
|                      | marking\" NOTE 3     | allowed              |
|                      |                      |                      |
|                      | RTCP Feedback =      | Allowed RTCP APP     |
|                      | \"ECN RTCP           | message              |
|                      |                      |                      |
|                      | Feedback\" NOTE 3    | types                |
|                      |                      |                      |
|                      | XR Summary Report =  | If ICE is applied:   |
|                      | \"ECN XR             |                      |
|                      |                      | ICE received         |
...
|                      |                      | (NOTE 7)             |
|                      | N                    |                      |
|                      | otificationRequested | If SDPCapNeg is      |
|                      | (Event ID            | signalled to the     |
|                      |                      | gateway:             |
|                      | = x,\" ECN           |                      |
|                      | Failure\")           | SDPCapNeg            |
|                      |                      | configuration        |
...
following procedure is initiated: the TrGW sends a NOT.req command with
...
When processing of the command is complete, the IBCF initiates the
following procedure.
...
The IBCF is in charge of correcting any detected mismatch, by
subtracting hanging terminations or clearing hanging contexts.

#### 5.17.2.7 IP Bearer Released

When the procedure \"IP Bearer Released\" is required the following
procedure is initiated: the TrGW sends a NOT.req command with the
...
When the processing of command is complete, the IBCF initiates the
following procedure.
...
The IBCF sends an ADD or a MODIFY request command as in Table
5.17.2.9.1.
...
The TrGW sends an ADD or a MODIFY request command as in Table
5.17.2.11.1.
...
The TrGW sends a NOTIFY request command as defined in Table 5.17.2.12.1.
...
The IBCF responds as defined in Table 5.17.2.12.2
...
The TrGW sends a NOTIFY request command as defined in Table 5.17.2.13.1.
...
The IBCF responds as defined in Table 5.17.2.13.2
...
+-----------------------+-------------------+-----------------------+
| Transaction defined   | Support           | Comment               |
| in                    |                   |                       |
|                       |                   |                       |
| 3GPP TS 29.235 \[17\] |                   |                       |
| or 3GPP TS 29.162     |                   |                       |
| \[18\]                |                   |                       |
+-----------------------+-------------------+-----------------------+
| TrGW Out of service   | Mandatory         | 5.17.3.2              |
+-----------------------+-------------------+-----------------------+
| TrGW Communication Up | Mandatory         | 5.17.3.3              |
+-----------------------+-------------------+-----------------------+
| TrGW Restoration      | Mandatory         | 5.17.3.4              |
+-----------------------+-------------------+-----------------------+
| TrGW Register         | Mandatory         | 5.17.3.5              |
+-----------------------+-------------------+-----------------------+
| TrGW Re-register      | Optional (NOTE 3  | 5.17.3.6              |
+-----------------------+-------------------+-----------------------+
| IBCF Ordered          | Optional (NOTE 3  | 5.17.3.7              |
| Re-register           |                   |                       |
+-----------------------+-------------------+-----------------------+
| IBCF Restoration      | Optional          | 5.17.3.8              |
+-----------------------+-------------------+-----------------------+
| IBCF Out of Service   | Optional          | 5.17.3.9              |
+-----------------------+-------------------+-----------------------+
...
|                       |                   | 5.17.3.11             |
+-----------------------+-------------------+-----------------------+
| TrGW Capability       | Optional          | 5.17.3.12             |
| Change                |                   |                       |
+-----------------------+-------------------+-----------------------+
| TrGW Resource         | Optional          | 5.17.3.13             |
| Congestion Handling   |                   |                       |
| -- Activate           |                   |                       |
+-----------------------+-------------------+-----------------------+
| TrGW Resource         | Optional          | 5.17.3.14             |
| Congestion Handling   |                   |                       |
| -- Indication         |                   |                       |
+-----------------------+-------------------+-----------------------+
| Inactivity timeout    | Optional (NOTE 4) | 5.17.3.15             |
| activation            |                   |                       |
+-----------------------+-------------------+-----------------------+
| Inactivity timeout    | Optional (NOTE 4) | 5.17.3.16             |
| indication            |                   |                       |
+-----------------------+-------------------+-----------------------+
...
The TrGW sends a SERVICE CHANGE request command as in Table 5.17.3.3.1
to the IBCF address to which the control link association was previously
established.
...
The IBCF may respond as in table 5.17.3.3.2. If a response is received,
the control link association is re-established and the inactivity timer
would be restarted.
...
Table 5.17.3.5.2: TrGW Register Ack
...
| ServiceChangeMGCId    |                       |                    |
| parameter may be      |                       |                    |
| returned in the TrGW  |                       |                    |
| Re-register response. |                       |                    |
| If present in the     |                       |                    |
| response, the TrGW    |                       |                    |
| shall not consider    |                       |                    |
...
Table 5.17.3.7.2: IBCF Ordered Re-Register Ack
...
Table 5.17.3.11.1: ANYcommand.resp (command reject) TrGW/IBCF to
IBCF/TrGW
...
Table 5.17.3.12.2 Capability Update Ack
...
Only point-to-point sessions are in scope of this H.248 Profile (see
clause 5.4). Interconnection of individual H.248 Streams is based on the
basic principle described in clause 7.1.6/ ITU-T Recommendation H.248.1
\[3\]. The H.248 Multiplex Descriptor is therefore not necessary (see
clause 5.6.2). The H.248 Topology Descriptor definition includes
individual H.248 Streams, but is also not necessary (see clause 5.7.8).

NOTE: all sessions have unicast media flows. Potential multicast
applications are transparent for MG point of view.

A.2 Relationships between gates and H.248 Streams
=================================================

The realization of a gate is illustrated in figure A.2.1. There is a
unidirectional media flow in that example, and there is a single H.248
Stream per Termination. A **H.248 Stream** covers per definition a
single **bidirectional** media flow (clause 7.1.6/ITU-T Recommendation
H.248.1 \[3\]). Media flows are interconnected by using the same
**StreamID** (here: StreamID equals to S1 for T1 and T2).

![](media/image6.wmf)

Figure A.2.1: H.248 Context - Illustration of Gate, Stream and
Terminations

The uni- or bidirectional application of an H.248 Streams is controlled
via usage of Local Descriptor (LD) and Remote Descriptor (RD).
Figure A.2.2 shows a bidirectional session. There is again a single
H.248 Stream per Termination. Gates are direction-dependent, there are
consequently two gates in this example.

![](media/image7.wmf)

Figure A.2.2: H.248 Context Bidirectional Session using single H.248
Streams
...
########  Annex C (informative): Change history
  ...
  **Date**             **TSG \#**   **TSG Doc.**   **CR**   **Rev**   **Subject/Comment**                                                                   **Old**   **New**
  2009-12              CT\#46       CP-090821                         3GPP TS Presented for approval in CT\#46                                              2.0.0     9.0.0
  2010-03              CT\#47       CP-100043      0006     1         Another Reference Tidy-Up                                                             9.0.0     9.1.0
                                                   0007     1         ServiceChange Correction                                                                        
                                                   0008     1         Termination Type Alignment                                                                      
                                                   0009     1         Error Code Additions                                                                            
                                                   0010               Returned SDP Properties                                                                         
                                                   0011     1         Package Usage                                                                                   
                                                   0012     2         Call Related Procedures                                                                         
                                                   0013     1         Non-Call Related Procedures                                                                     
                                                   0014     1         Clean-up Proposals                                                                              
                                                   0015               Resolution of Editor\'s Notes                                                                   
  2010-06              CT\#48       CP-100289      0016     1         Transport protocol to be indicated to gateway for end-to-end media security           9.1.0     9.2.0
                                    CP-100283      0017     1         Handling of Stream mode                                                                         
                                    CP-100283      0018     1         Package Updates                                                                                 
                                    CP-100283      0019     1         Descriptor Updates                                                                              
  2010-09              CT\#49       CP-100460      0020               Procedures for Emergency indicator                                                    9.2.0     9.3.0
                                    CP-100460      0021               Priority indicator                                                                              
  2011-03              CT\#51       CP-110274      0022     10        ECN Support in Ix Interface                                                           9.3.0     10.0.0
                                    CP-110058      0023     1         Handling of rtcp-fb SDP attribute and SDP attribute for RTCP APP feedback messages              
  2011-06              CT\#52       CP-110368      0024               ECN Failure improvements                                                              10.0.0    10.1.0
                                    CP-110368      0026     1         Interworking with Non-3GPP ECN networks                                                         
                                    CP-110368      0027     1         Alignment of 3GPP profiles with SG16 ECN package definition                                     
  2011-09              CT\#53       CP-110564      0028     1         Incorportation of latest ITU-T ECN package and proposed ammendment                    10.1.0    10.2.0
  2011-12              CT\#54       CP-110798      0029     1         Adding of stage 3 for ATCF/ATGW function                                              10.2.0    10.3.0
                                    CP-110796      0030               Update of reference to H.248.52                                                                 
                                    CP-110789      0031     1         ECN Improvements                                                                                
                                    CP-110789      0032               Missing \"rtcp-xr\" SDP attribute in Table about Optional SDP Information Elements              
  2012-06              CT\#56       CP-120226      0033     1         Reference update: draft-ietf-avtcore-ecn-for-rtp                                      10.3.0    10.4.0
  2012-09              CT\#57       CP-120478      0034     3         Support of Multimedia Priority Service (MPS) over Ix Interface -- Stage 3             10.4.0    11.0.0
  2012-12              CT\#58       CP-120723      0040     1         Ix interface updates of ECN Support Package                                           11.0.0    11.1.0
                                    CP-120734      0041     3         Support of Multimedia Priority Service (MPS) in Modify over Ix Interface -- Stage 3             
  2013-06              CT\#60       CP-130294      0043     2         Replacement of ECN for RTP-over-UDP Support package                                   11.1.0    11.2.0
  2013-09              CT\#61       CP-130452      0048     3         Introduction of support for Coordination of Video Orientation (CVO)                   11.2.0    12.0.0
                                    CP-130471      0049     3         Introduction of support for Generic Image Attribute/signalling of image size                    
  2014-03              CT\#63       CP-140025      0050     1         Clarification on CVO handling                                                         12.0.0    12.1.0
                                    CP-140037      0051     1         Clarification on SIS handling                                                                   
  2014-06              CT\#64       CP-140248      0052     3         ICE support in Ix interface                                                           12.1.0    12.2.0
  2014-09              CT\#65       CP-140520      0053     1         Corrections to Transport Protocol table                                               12.2.0    12.3.0
                                    CP-140520      0054     1         TrGW Capability Change                                                                          
  2014-12              CT\#66       CP-140786      0055     1         Application-aware MSRP interworking                                                   12.3.0    12.4.0
                                    CP-140788      0056     1         Adding support for EVS codec                                                                    
                                    CP-140973      0057     \-        Alternative connection (ALTC) addresses management                                              
  2015-03              CT\#67       CP-150023      0058     1         MG located Bearer Level ALG package                                                   12.4.0    12.5.0
  2015-12              CT\#70       CP-150783      0061     3         Support for Video Enhancements by Region-of-Interest Information Signalling           12.5.0    13.0.0
  2016-03              CT\#71       CP-160032      0062     1         TrGW configuration for end-to-end WebRTC calls (stage 3)                              13.0.0    13.1.0
                                    CP-160034      0063     1         Support of enhanced bandwidth negotiation mechanism for MTSI sessions                           
                                    CP-160021      0064     1         Ix stage 3 to support SDP Capability Negotiation                                                
  2016-06              CT\#72       CP-160229      0065     \-        Clarifications related to the rate adaptation for media endpoints                     13.1.0    13.2.0
  2016-12              CT\#74       CP-160684      0066     1         Support of RTP-level pause and resume functionality                                   13.2.0    14.0.0
  2017-03              CT\#75       CP-170051      0067     1         RTCP Codec Control Commands and Indications                                           14.0.0    14.1.0
  2018-10              CT\#81       \-             \-       \-        Update to Rel-15 version (MCC)                                                        14.1.0    15.0.0
  2019-06              CT\#84       CP-191053      0068     2         Ix interface enhancements to support DBI                                              15.0.0    16.0.0
  -------------------- ------------ -------------- -------- --------- ------------------------------------------------------------------------------------- --------- ---------
