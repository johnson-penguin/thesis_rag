3GPP TS 38.305 V16.9.0 (2023-06)
...
described in clause 8.10.3.2.3. The gNB then activates the UE SRS
transmission and sends a NRPPa Positioning Activation Response message.
The target device begins the UL-SRS transmission according to the time
domain behavior of UL-SRS resource configuration.
