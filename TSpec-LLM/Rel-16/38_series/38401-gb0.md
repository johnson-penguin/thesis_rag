...
[12](#ng-ran-architecture)

[12](#overview)

[12](#overall-architecture-of-ng-ran)

[13](#overall-architecture-for-separation-of-gnb-cu-cp-and-gnb-cu-up)

[14](#overall-architecture-of-iab)

[15](#protocol-stacks-of-iab)

[16](#ng-ran-identifiers)

[16](#principle-of-handling-application-protocol-identities)
...
[18](#transport-addresses)

[18](#ue-associations-in-ng-ran-node)

[19](#ng-ran-functions-description)

[19](#general-1)

[19](#ng-ran-sharing)

[19](#remote-interference-management)

[20](#cross-link-interference-management)

[20](#support-for-non-public-networks)

[20](#rach-optimisation-function)

[20](#positioning)

[20](#overall-procedures-in-gnb-cugnb-du-architecture)

[20](#ue-initial-access)

[22](#intra-gnb-cu-mobility)

[22](#intra-nr-mobility)

[22](#inter-gnb-du-mobility)

[23](#intra-gnb-du-handover)

[24](#inter-gnb-du-conditional-handover-or-conditional-pscell-change)

[25](#en-dc-mobility)

[25](#inter-gnb-du-mobility-using-mcg-srb)

[27](#inter-gnb-du-mobility-using-scg-srb-srb3)

[27](#inter-gnb-du-conditional-pscell-change-using-mcg-srb-without-mn-negotiation)

[29](#intra-cu-topology-adaptation-procedure)

[29](#intra-cu-topology-adaptation-procedure-in-sa)

[32](#intra-cu-topology-adaptation-procedure-in-nsa-using-mcg-srb)

[33](#intra-cu-topology-adaptation-procedure-in-nsa-using-scg-srb-srb3)

[33](#intra-cu-topological-redundancy-procedure)

[36](#intra-cu-backhaul-rlf-recovery-for-iab-nodes-in-sa-mode)

[36](#mechanism-of-centralized-retransmission-of-lost-pdus)

[36](#centralized-retransmission-in-intra-gnb-cu-cases)

[38](#multi-connectivity-operation)

[38](#secondary-node-addition)

[38](#en-dc)

[38](#secondary-node-release-mnsn-initiated)

[38](#en-dc-1)

[40](#scg-suspendresume-in-rrc_inactive)

[41](#f1-startup-and-cells-activation)

[42](#rrc-state-transition)

[42](#rrc-connected-to-rrc-inactive)

[42](#rrc-inactive-to-other-states)

[44](#rrc-connection-reestablishment)

[46](#multiple-tnlas-for-f1-c)

[47](#overall-procedures-involving-e1-and-f1)

[47](#ue-initial-access-1)

[48](#bearer-context-setup-over-f1-u)

[49](#bearer-context-release-over-f1-u)

[49](#gnb-cu-cp-initiated-bearer-context-release)

[50](#gnb-cu-up-initiated-bearer-context-release)

[51](#inter-gnb-handover-involving-gnb-cu-up-change)

[53](#change-of-gnb-cu-up)

[55](#rrc-state-transition-1)

[55](#rrc-connected-to-rrc-inactive-1)

[56](#rrc-inactive-to-other-states-1)

[57](#trace-activationdeactivation-over-f1-and-e1)

[58](#bh-rlc-channel-establishment-procedure)

[59](#traffic-mapping)

[59](#traffic-mapping-from-ip-layer-to-layer-2)

[60](#bh-rlc-channel-mapping-on-bap-layer)

[60](#iab-node-release)

[60](#iab-node-orderly-release)

[60](#iab-node-disorderly-release)

[60](#iab-node-oam)

[61](#handling-of-iab-mts-in-inactive-state)

[61](#ip-address-allocation-for-iab-nodes)

[61](#multiple-tnlas-for-e1)

[63](#support-of-network-sharing-with-multiple-cell-id-broadcast)

[63](#general-2)

[63](#initial-registration-separate-plmn-signalling)

[64](#rrc-connection-reestablishment-separate-plmn-signalling)

[65](#support-of-shared-signalling-transport)

[65](#iab-node-integration-procedure)

[65](#standalone-iab-integration)

[66](#nsa-iab-integration-procedure)

[67](#overall-procedures-for-mdt)

[67](#signalling-based-mdt-activation)

[68](#management-based-mdt-activation)

[68](#general-3)

[68](#management-based-mdt-activation-in-gnb-cu-cp)

[69](#management-based-mdt-activation-in-gnb-du)

[70](#management-based-mdt-activation-in-gnb-cu-up)

[71](#user-consent-propagation-in-en-dc)

[71](#self-optimisation)

[71](#overall-procedures-for-mro)

[72](#signalling-of-rlf-information-from-gnb-cu-to-gnb-du)

[72](#synchronization)

[72](#gnb-synchronization)

[73](#ng-ran-interfaces)
...
[74](#antenna-interface---general-principles)

[74](#overall-procedures-in-ng-ran-architecure)

[74](#multiple-tnlas-for-xn-c)

[76](#annex-a-informative-deployment-scenarios-of-gnben-gnb)

[77](#annex-b-ng-ran-architecture-for-radio-access-network-sharing-with-multiple-cell-id-broadcast-informative)

[78](#annex-c-informative-change-history)Foreword 1 Scope 2 References 3
...
gNB-CU-CP and gNB-CU-UP 6.1.3 Overall Architecture of IAB 6.1.4 Protocol
stacks of IAB 6.2 NG-RAN identifiers 6.2.1 Principle of handling
Application Protocol Identities 6.2.2 gNB-DU ID 6.2.3 ng-eNB-DU ID 6.2.4
gNB-CU-UP ID 6.3 Transport addresses 6.4 UE associations in NG-RAN Node
7 NG-RAN functions description 7.0 General 7.1 NG-RAN sharing 7.2 Remote
Interference Management 7.3 Cross-Link Interference Management 7.4
Support for Non-Public Networks 7.5 RACH Optimisation Function 7.6
Positioning 8 Overall procedures in gNB-CU/gNB-DU Architecture 8.1 UE
Initial Access 8.2 Intra-gNB-CU Mobility 8.2.1 Intra-NR Mobility 8.2.1.1
Inter-gNB-DU Mobility 8.2.1.2 Intra-gNB-DU handover 8.2.1.3 Inter-gNB-DU
Conditional Handover or Conditional PSCell Change 8.2.2 EN-DC Mobility
8.2.2.1 Inter-gNB-DU Mobility using MCG SRB 8.2.2.2 Inter-gNB-DU
Mobility using SCG SRB (SRB3) 8.2.2.3 Inter-gNB-DU Conditional PSCell
Change using MCG SRB without MN negotiation 8.2.3 Intra-CU topology
adaptation procedure 8.2.3.1 Intra-CU topology adaptation procedure in
SA 8.2.3.2 Intra-CU topology adaptation procedure in NSA using MCG SRB
8.2.3.3 Intra-CU topology adaptation procedure in NSA using SCG SRB
(SRB3) 8.2.4 Intra-CU topological redundancy procedure 8.2.5 Intra-CU
Backhaul RLF recovery for IAB-nodes in SA mode 8.3 Mechanism of
centralized retransmission of lost PDUs 8.3.1 Centralized Retransmission
in Intra gNB-CU Cases 8.4 Multi-Connectivity operation 8.4.1 Secondary
Node Addition 8.4.1.1 EN-DC 8.4.2 Secondary Node Release (MN/SN
initiated) 8.4.2.1 EN-DC 8.4.3 SCG suspend/resume in RRC\_INACTIVE 8.5
F1 Startup and cells activation 8.6 RRC state transition 8.6.1 RRC
connected to RRC inactive 8.6.2 RRC inactive to other states 8.7 RRC
connection reestablishment 8.8 Multiple TNLAs for F1-C 8.9 Overall
procedures involving E1 and F1 8.9.1 UE Initial Access 8.9.2 Bearer
context setup over F1-U 8.9.3 Bearer context release over F1-U 8.9.3.1
gNB-CU-CP initiated bearer context release 8.9.3.2 gNB-CU-UP initiated
bearer context release 8.9.4 Inter-gNB handover involving gNB-CU-UP
change 8.9.5 Change of gNB-CU-UP 8.9.6 RRC State transition 8.9.6.1 RRC
Connected to RRC Inactive 8.9.6.2 RRC Inactive to other states 8.9.7
Trace activation/deactivation over F1 and E1 8.9.8 BH RLC channel
establishment procedure 8.9.9 Traffic Mapping **8.9.9.1** Traffic
**Mapping from IP-layer to Layer-2** **8.9.9.2** **BH RLC Channel
Mapping on BAP Layer** 8.9.10 IAB-node release 8.9.10.1 IAB-node orderly
release 8.9.10.2 IAB-node disorderly release 8.9.11 IAB-node OAM 8.9.12
Handling of IAB-MTs in INACTIVE State 8.9.13 IP Address Allocation for
IAB-nodes 8.10 Multiple TNLAs for E1 8.11 Support of Network Sharing
with multiple cell-ID broadcast 8.11.1 General 8.11.2 Initial
Registration -- separate PLMN signalling 8.11.3 RRC Connection
Reestablishment -- separate PLMN signalling 8.11.4 Support of shared
signalling transport 8.12 IAB-node Integration Procedure 8.12.1
Standalone IAB integration 8.12.2 NSA IAB Integration procedure 8.13
Overall procedures for MDT 8.13.1 Signalling based MDT activation 8.13.2
Management based MDT activation 8.13.2.1 General 8.13.2.2 Management
based MDT Activation in gNB-CU-CP 8.13.2.3 Management based MDT
Activation in gNB-DU 8.13.2.4 Management based MDT Activation in
gNB-CU-UP 8.13.2.5 User consent propagation in EN-DC 8.14
Self-optimisation 8.14.1 Overall procedures for MRO 8.14.1.1 Signalling
of RLF information from gNB-CU to gNB-DU 9 Synchronization 9.1 gNB
Synchronization 10 NG-RAN interfaces 10.1 NG interface 10.2 Xn interface
10.3 F1 interface 10.4 E1 interface 10.5 Antenna interface - general
principles 11 Overall procedures in NG-RAN Architecure 11.1 Multiple
TNLAs for Xn-C Annex A (informative): Deployment scenarios of gNB/en-gNB
Annex B: NG-RAN Architecture for Radio Access Network Sharing with
multiple cell ID broadcast (informative) Annex C (informative): Change
History
...
NOTE: As specified in TS 38.300 \[2\], NG-RAN could also consists of a
...
![](media/image8.wmf){width="3.9583333333333335in"
...
NOTE: In case of DAPS Handover, the UE CONTEXT MODIFICATION REQUEST
...
NOTE: The step 13 may happen before step 12, as soon as the gNB-CU knows
which cell the UE has successfully accessed.

NOTE: The gNB-CU may initiate UE Context Release procedure toward the
...
> 15 -16. The steps 15-16 are as defined in steps 11-12 in clause
> 8.2.1.1.
...
> cell.
>
> 7\. The gNB-CU sends an SGNB MODIFICATION REQUIRED message to the
> MeNB, which includes a generated *RRCReconfiguration* message.
>
> 8\. The MeNB and the UE perform RRC Connection
> Reconfiguration/Complete procedure.
...
> 10\. An execution condition to trigger initiation of conditional
> PSCell change is fulfilled.
>
> 11\. Random Access procedure is performed at the candidate gNB-DU,
> which becomes the target gNB-DU if successful. The target gNB-DU sends
> a Downlink Data Delivery Status frame to inform the gNB-CU. The target
> gNB-DU also sends an ACCESS SUCCESS message to inform the gNB-CU of
> which cell the UE has successfully accessed.
...
> source gNB-DU and indicates to stop the data transmission for the UE.
> The source gNB-DU sends a Downlink Data Delivery Status frame to
> inform the gNB-CU about the unsuccessfully transmitted downlink data
> to the UE. Downlink packets, which may include PDCP PDUs not
> successfully transmitted in the source gNB-DU, are sent from the
> gNB-CU to the target gNB-DU. Downlink packets are sent to the UE.
> Also, uplink packets are sent from the UE, which are forwarded to the
> gNB-CU through the target gNB-DU.

NOTE: The step 14 may happen before step 13, as soon as the gNB-CU knows
which cell the UE has successfully accessed.
...
> MODIFICATION RESPONSE message.
>
> 16-17. The steps 16-17 are as defined in steps 11-12 in clause
> 8.2.1.1.
...
NOTE**:** **In case that the source path and target path have common
nodes, the BH RLC channels and BAP-sublayer** routing **entries of those
nodes may not need to be released in Step 15.**
...
NOTE**:** **In upstream direction, in-flight packets between the source
...
NOTE: The IAB-donor-CU can determine the unsuccessfully transmitted
...
NOTE: step 5 and step 6 exist for inactive to active transitions,
...
NOTE: Here it is assumed that the UE accessed the original gNB-DU where
the UE context is available for that UE, and either steps 9-10 or steps
9'-10' may be executed or both could be skipped.

NOTE: If the UE accessed from a gNB-DU other than the original one, the
gNB-CU should trigger the UE Context Setup procedure toward this new
gNB-DU.
...
![](media/image30.wmf){width="3.1743055555555557in"
...
message indicates to ignore the included security context and not to
initiate sending downlink packets until the UE successfully accesses. Up
to implementation, the gNB-CU-CP may request to establish bearer context
as if a regular HO was requested.
...
NOTE: In case of DAPS Handover or Conditional Handover, the F1 UE
...
NOTE: In case of DAPS Handover, the EARLY STATUS TRANSFER message is
sent for DRBs configured with DAPS instead of the SN STATUS TRANSFER
message.

NOTE: In case of Conditional Handover, the EARLY STATUS TRANSFER message
is sent only if early data forwarding is applied.
...
condition(s) are fulfilled. Once successfully accessed, the target
...
NOTE: In case of Conditional Handover, inactivity monitoring is
...
![](media/image39.wmf){width="6.699305555555555in"
...
NOTE: Implementation must ensure that IPv6 Flow Label collisions are
...
NOTE: The transport connection between the IAB-node and its OAM may also
be provided using the Backhaul IP layer by implementation.
...
provided by the Backhaul IP layer, the OAM traffic may be aggregated
...
for each purpose. This occurs before the IAB node uses the IP
address(es) for UL and/or DL traffic.
...
![](media/image41.wmf){width="3.5034722222222223in"
...
> (e.g. IAB-node 2 in Figure 8.12.1-1) connects to the network in the
> same way as a UE, by performing RRC connection setup procedure with
...
> session. The IAB-node can select the parent node for access based on
> an over-the-air indication from potential parent node IAB-DU
> (transmitted in SIB1). To indicate its IAB capability, the IAB-MT
> includes the IAB-node indication in *RRCSetupComplete* message, to
> assist the IAB-donor to select an AMF supporting IAB.
>
...
> (non-default) BH RLC channels. This phase also includes configuring
> the BAP Address of the IAB-node 2 and default BAP Routing ID for the
> upstream direction.
>
...
> also be established.
>
> Phase 2-2: Routing update. In this phase, the BAP sublayer is updated
> to support routing between the new IAB-node 2 and the IAB-donor-DU.
> For the downstream direction, the IAB-donor-CU initiates F1AP
> procedure to configure the IAB-donor-DU with the mapping from IP
> header field(s) to the BAP Routing ID related to IAB-node 2. The
> routing tables are updated on all ancestor IAB-nodes (e.g. IAB-node 1
> in Figure 8.12.1-1) and on the IAB-donor-DU, with routing entries for
> the new BAP Routing ID(s). This phase may also include the IP address
> allocation procedure for IAB-node 2. IAB-node 2 may request one or
> more IP addresses from the IAB-donor-CU via RRC. The IAB-donor-CU may
> send the IP address(es) to the IAB-node 2 via RRC. The IAB-donor-CU
> may obtain the IP address(es) from the IAB-donor-DU via F1-AP or by
> other means (e.g. OAM, DHCP). IP address allocation procedure may
> occur at any time after RRC connection has been established.
>
...
>
> NOTE: The IAB-DU can discover the IAB-donor-CU's IP address in the
...
> and optionally, OAM connectivity establishment by using the IAB-MT's
> PDN connection. The IAB-node can select the IAB-supporting eNB based
> on an over-the-air indication from eNB (transmitted in SIB1). To
> indicate its IAB capability, the IAB-MT includes the IAB-node
> indication in *RRCConnectionSetupComplete* message, to assist the eNB
> to select an MME supporting IAB. The eNB then configures the IAB-MT
> part with an NR measurement configuration in order to perform
> discovery, measurement and measurement reporting of candidate gNBs. To
> enable the eNB choose an en-gNB which supports IAB function, the IAB
> capability of neighbour gNBs can be pre-configured in the eNB (e.g. by
> OAM).
>
> NOTE: Other ways to enable the eNB know the IAB capability of
> neighbour gNBs are not precluded.
>
> Phase 1-2. SgNB addition. In this phase, the IAB-MT part connects to
...
>
> Phase 2-1: BH RLC channel establishment. This phase is the same as
> Phase 2-1 in the standalone IAB integration procedure (refer to the
> Phase 2-1 in clause 8.12.1). This step may occur in Phase 1-2.
>
...
> IAB-DU part setup. IAB-donor-CU may also change the configuration
> after IAB-DU part setup. In case the configuration is not performed
> before IAB-DU part setup, the IAB node uses the NR leg as the default
> one. When both LTE leg and NR leg are configured, it is up to the
> implementation to select the leg for F1-C traffic transfer.**
...
> the gNB-CU-CP sends TRACE START message to the gNB-CU-UP, including
...
> For each selected UE, the gNB-DU may send CELL TRAFFIC TRACE message
> to the gNB-CU-CP in the F1 UE associated signalling, including Trace
> ID for MDT.
...
> For each selected UE, the gNB-CU-UP may send CELL TRAFFIC TRACE
...
![](media/image52.wmf){width="4.278472222222222in"
