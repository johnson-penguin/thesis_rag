...
\- an average RF power measurement shall be performed for frequency
...
In case of a repeater only supporting one channel, one RF input signal
...
The EVM shall be measured at the equivalent output of the repeater
