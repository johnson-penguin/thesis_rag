...
**closed‑loop pitch analysis:** adaptive codebook search, i.e., a
...
**mode: w**hen used alone, refers to the source codec mode, i.e., to one
...
![](media/image22.wmf){width="0.44375in" height="0.2638888888888889in"}
...
![](media/image38.wmf){width="0.375in" height="0.25in"} Length of the
...
![](media/image66.wmf){width="0.3333333333333333in"
...
![](media/image80.wmf){width="0.375in" height="0.2361111111111111in"}
...
![](media/image110.wmf){width="0.2638888888888889in"
...
![](media/image124.wmf){width="0.19375in"
...
![](media/image140.wmf){width="0.4027777777777778in"
...
![](media/image156.wmf){width="0.4305555555555556in"
...
![](media/image185.wmf){width="4.958333333333333in"
...
![](media/image217.wmf){width="2.125in" height="0.44375in"} (14)
...
![](media/image230.wmf){width="1.375in" height="0.2638888888888889in"},
...
![](media/image242.wmf){width="3.1527777777777777in"
...
height="0.2916666666666667in"},
![](media/image274.wmf){width="0.2777777777777778in"
height="0.2916666666666667in"},
...
![](media/image287.wmf){width="1.0965277777777778in"
...
![](media/image296.wmf){width="0.4305555555555556in"
...
Either of these two minimum distance conditions must be fulfilled to
...
The convolution ![](media/image352.wmf){width="0.4305555555555556in"
height="0.2361111111111111in"} is computed for the first delay
![](media/image384.wmf){width="0.3055555555555556in"
height="0.2222222222222222in"} in the searched range, and for the other
delays in the search range ![](media/image354.wmf){width="1.375in"
height="0.2222222222222222in"}, it is updated using the recursive
relation of equation (38).
...
correlation in equation (37) and searching for its maximum. Once the
fractional pitch lag is determined, the adaptive codebook vector
![](media/image385.wmf){width="0.3194444444444444in"
height="0.2222222222222222in"} is computed by interpolating the past
excitation signal ![](media/image386.wmf){width="0.3333333333333333in"
height="0.2222222222222222in"} at the given integer delay and phase
(fraction). The interpolation is performed using two FIR filters
(Hamming windowed sinc functions); one for interpolating the term in
equation (37) with the sinc truncated at ± 11 and the other for
...
In the first subframe, a fractional pitch delay is used with
resolutions: 1/3 in the range ![](media/image379.wmf){width="1.0in"
height="0.2916666666666667in"} and integers only in the range \[85,
143\]. For the second, third, and fourth subframes, integer pitch
resolution is used in the range
![](media/image382.wmf){width="0.9583333333333334in"
height="0.2916666666666667in"}, where
![](media/image94.wmf){width="0.16666666666666666in"
height="0.2222222222222222in"} is nearest integer to the fractional
pitch lag of the previous subframe, bounded by 20\...143. Additionally,
a fractional resolution of 1/3 is used in the range
![](media/image383.wmf){width="1.3465277777777778in"
height="0.2916666666666667in"}.

Closed‑loop pitch analysis is performed around the open‑loop pitch
estimates on a subframe basis. In the first subframe the range *T~op~* ±
5, bounded by 20\...143, is searched. For the other subframes,
closed‑loop pitch analysis is performed around the integer pitch
selected in the previous subframe, as described above. The pitch delay
is encoded with 8 bits in the first subframe and the relative delay of
the other subframes is encoded with 4 bits.
...
The convolution ![](media/image352.wmf){width="0.4305555555555556in"
height="0.2361111111111111in"} is computed for the first delay
![](media/image387.wmf){width="0.3055555555555556in"
height="0.2222222222222222in"} in the searched range, and for the other
delays in the search range ![](media/image354.wmf){width="1.375in"
height="0.2222222222222222in"}, it is updated using the recursive
relation of equation (38).
...
correlation in equation (37) and searching for its maximum. Once the
fractional pitch lag is determined, the adaptive codebook vector
![](media/image388.wmf){width="0.3194444444444444in"
height="0.2222222222222222in"} is computed by interpolating the past
excitation signal ![](media/image389.wmf){width="0.3333333333333333in"
height="0.2222222222222222in"} at the given integer delay and phase
(fraction). The interpolation is performed using two FIR filters
(Hamming windowed sinc functions); one for interpolating the term in
equation (37) with the sinc truncated at ± 11 and the other for
...
The average adaptive codebook gain is calculated if the *LSP\_flag* is
set and the unquantized adaptive codebook gain exceeds the gain
threshold ![](media/image390.wmf){width="0.7916666666666666in"
height="0.2222222222222222in"}.
...
![](media/image391.wmf){width="3.6666666666666665in"
height="0.3333333333333333in"}, where *n* is the current subframe. If
the average adaptive codebook gain exceeds the
![](media/image392.wmf){width="0.3611111111111111in"
height="0.2222222222222222in"}, the unquantized gain is limited to the
threshold value and the *GpC\_flag* is set to indicate the limitation.

![](media/image393.wmf){width="1.2777777777777777in" height="1.25in"}

The *GpC\_flag* is used in the gain quantization in clause 5.8.
...
pulses can have the amplitudes +1 or ‑1. The 40 positions in a subframe
are divided into 5 tracks, where each track contains two pulses, as
shown in table 3.

Table 3: Potential positions of individual pulses in the algebraic
codebook, 12.2 kbit/s.
...
The pulses are grouped into 3, 3, and 2 pulses and their positions are
encoded with 10, 10, and 7 bits, respectively (total of 27 bits). The
sign of the first pulse in each track is encoded with 1 bit (total of
4 bits).
...
The pulse positions are encoded with 3, 3, 3, and 4 bits (total of
13 bits), and the sign of the each pulse is encoded with 1 bit (total of
4 bits). This gives a total of 17 bits for the algebraic code.

**6.70 kbit/s mode**

In this codebook, the innovation vector contains 3 non‑zero pulses. All
pulses can have the amplitudes +1 or ‑1. The 40 positions in a subframe
are divided into 3 tracks, where each track contains one pulse, as shown
in table 6.

Table 6: Potential positions of individual pulses in the algebraic
codebook, 6.70 kbit/s.
...
The pulse positions are encoded with 3, 4, and 4 bits (total of
11 bits), and the sign of the each pulse is encoded with 1 bit (total of
3 bits). This gives a total of 14 bits for the algebraic code.
...
The pulse positions are encoded with 4 and 5 bits (total of 9 bits), and
the sign of the each pulse is encoded with 1 bit (total of 2 bits). This
gives a total of 11 bits for the algebraic code.

**5.15, 4.75 kbit/s modes**

In this codebook, the innovation vector contains 2 non‑zero pulses. All
pulses can have the amplitudes +1 or ‑1. The 40 positions in a subframe
are divided into 5 tracks. Two subsets of 2 tracks each are used for
each subframe with one pulse in each track. Different subsets of tracks
are used for each subframe. The pulse positions used in each subframe
are shown in table 8.

Table 8: Potential positions of individual pulses in the algebraic
codebook, 5.15, 4.75 kbit/s.
...
One bit is needed to encoded the subset used. The two pulse positions
are encoded with 3 bits each (total of 6 bits), and the sign of the each
pulse is encoded with 1 bit (total of 2 bits). This gives a total of
9 bits for the algebraic code.
...
![](media/image394.wmf){width="2.486111111111111in"
height="0.2638888888888889in"} (42)

where ![](media/image395.wmf){width="1.1666666666666667in"
height="0.2361111111111111in"} is the filtered adaptive codebook vector
and ![](media/image396.wmf){width="0.2361111111111111in"
height="0.2638888888888889in"} is the quantified adaptive codebook gain.
If ![](media/image397.wmf){width="0.20833333333333334in"
height="0.2222222222222222in"} is the algebraic codevector at index
![](media/image398.wmf){width="0.1388888888888889in"
height="0.18055555555555555in"}, then the algebraic codebook is searched
by maximizing the term:

![](media/image399.wmf){width="1.5in" height="0.6111111111111112in"},
(43)

where ![](media/image122.wmf){width="0.6666666666666666in"
height="0.2777777777777778in"} is the correlation between the target
signal ![](media/image400.wmf){width="0.4027777777777778in"
height="0.25in"} and the impulse response
![](media/image123.wmf){width="0.3333333333333333in" height="0.25in"},
![](media/image124.wmf){width="0.19375in"
height="0.18055555555555555in"} is a the lower triangular Toepliz
convolution matrix with diagonal
![](media/image125.wmf){width="0.3333333333333333in" height="0.25in"}
and lower diagonals ![](media/image126.wmf){width="0.9305555555555556in"
height="0.25in"}, and
![](media/image127.wmf){width="0.7083333333333334in"
height="0.2777777777777778in"} is the matrix of correlations of
![](media/image128.wmf){width="0.3333333333333333in" height="0.25in"}.
The vector ![](media/image401.wmf){width="0.1388888888888889in"
height="0.18055555555555555in"} (backward filtered target) and the
matrix ![](media/image402.wmf){width="0.18055555555555555in"
height="0.18055555555555555in"} are computed prior to the codebook
search. The elements of the vector
![](media/image401.wmf){width="0.1388888888888889in"
height="0.18055555555555555in"} are computed by

![](media/image403.wmf){width="2.513888888888889in"
height="0.5277777777777778in"}, (44)

and the elements of the symmetric matrix
![](media/image402.wmf){width="0.18055555555555555in"
height="0.18055555555555555in"} are computed by:

![](media/image404.wmf){width="2.4583333333333335in"
height="0.5555555555555556in"}. (45)

The algebraic structure of the codebooks allows for very fast search
procedures since the innovation vector
![](media/image405.wmf){width="0.20833333333333334in"
...
![](media/image406.wmf){width="1.1388888888888888in"
height="0.5555555555555556in"}, (46)

where ![](media/image407.wmf){width="0.20833333333333334in"
height="0.2222222222222222in"} is the position of the
![](media/image408.wmf){width="0.12013888888888889in"
height="0.16666666666666666in"}th pulse,
![](media/image409.wmf){width="0.20833333333333334in"
height="0.2361111111111111in"} is its amplitude, and
![](media/image410.wmf){width="0.2638888888888889in"
height="0.2638888888888889in"} is the number of pulses
(![](media/image411.wmf){width="0.625in" height="0.25in"})*.* The energy
in the denominator of equation (43) is given by:

![](media/image412.wmf){width="3.2777777777777777in"
height="0.5833333333333334in"} (47)

To simplify the search procedure, the pulse amplitudes are preset by the
mere quantization of an appropriate signal
![](media/image413.wmf){width="0.3194444444444444in"
height="0.2222222222222222in"}. This is simply done by setting the
amplitude of a pulse at a certain position equal to the sign of
![](media/image413.wmf){width="0.3194444444444444in"
height="0.2222222222222222in"} at that position. The simplification
proceeds as follows (prior to the codebook search). First, the sign
signal ![](media/image414.wmf){width="1.2083333333333333in"
height="0.25in"} and the signal
![](media/image415.wmf){width="1.19375in" height="0.2777777777777778in"}
are computed. Second, the matrix
![](media/image402.wmf){width="0.18055555555555555in"
height="0.18055555555555555in"} is modified by including the sign
information; that is,
![](media/image416.wmf){width="1.6388888888888888in"
height="0.2777777777777778in"}. The correlation in equation (46) is now
given by:

![](media/image417.wmf){width="1.0416666666666667in"
height="0.5694444444444444in"} (48)

and the energy in equation (47) is given by:

![](media/image418.wmf){width="2.7083333333333335in"
...
![](media/image413.wmf){width="0.3194444444444444in"
height="0.2222222222222222in"}, used for presetting the amplitudes, is a
sum of the normalized
![](media/image419.wmf){width="0.34652777777777777in"
height="0.2222222222222222in"} vector and normalized long‑term
prediction residual ![](media/image138.wmf){width="0.69375in"
height="0.2361111111111111in"}:

![](media/image420.wmf){width="4.513888888888889in"
height="0.5965277777777778in"} (50)

is used. Having preset the pulse amplitudes, as explained above, the
...
absolute values of ![](media/image413.wmf){width="0.3194444444444444in"
height="0.2222222222222222in"} are searched. From these the global
maximum value for all the pulse positions is selected. The first pulse
i~0~ is always set into the position corresponding to the global maximum
value.

Next, four iterations are carried out. During each iteration the
position of pulse i~1~ is set to the local maximum of one track. The
rest of the pulses are searched in pairs by sequentially searching each
of the pulse pairs {i~2~,i~3~}, {i~4~,i~5~}, {i~6~,i~7~} and {i~8~,i~9~}
in nested loops. Every pulse has 8 possible positions, i.e., there are
four 8x8‑loops, resulting in 256 different combinations of pulse
positions for each iteration.

In each iteration all the 9 pulse starting positions are cyclically
shifted, so that the pulse pairs are changed and the pulse i~1~ is
placed in a local maximum of a different track. The rest of the pulses
are searched also for the other positions in the tracks. At least one
pulse is located in a position corresponding to the global maximum and
one pulse is located in a position corresponding to one of the 4 local
maxima.

A special feature incorporated in the codebook is that the selected
codevector is filtered through an adaptive pre‑filter
![](media/image12.wmf){width="0.4166666666666667in"
height="0.2222222222222222in"} which enhances special spectral
components in order to improve the synthesized speech quality. Here the
filter ![](media/image421.wmf){width="1.3333333333333333in"
height="0.25in"} is used, where
![](media/image13.wmf){width="0.1527777777777778in"
height="0.18055555555555555in"} is the nearest integer pitch lag to the
closed‑loop fractional pitch lag of the subframe, and
![](media/image422.wmf){width="0.1388888888888889in"
height="0.2222222222222222in"} is the quantized pitch gain of the
current subframe bounded by \[0.0,1.0\]. Note that prior to the codebook
search, the impulse response
![](media/image423.wmf){width="0.3333333333333333in"
height="0.2222222222222222in"} must include the pre‑filter
![](media/image424.wmf){width="0.4166666666666667in"
height="0.2222222222222222in"}. That is, for values of $T$less than 40,
the impulse $h(n)$is modified according to

$h\left( n \right) = \begin{matrix}
\left\{ h\left( n \right)\text{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ }n = 0,\text{.}\text{.}\text{.},T - 1 \middle| \right.\  \\
\end{matrix}$ (50a)

The fixed codebook gain is then found by:

![](media/image425.wmf){width="0.6388888888888888in"
height="0.5416666666666666in"} (51)

where ![](media/image426.wmf){width="0.20833333333333334in"
height="0.2222222222222222in"} is the target vector for fixed codebook
search and ![](media/image427.wmf){width="0.125in"
height="0.1388888888888889in"} is the fixed codebook vector convolved
with ![](media/image423.wmf){width="0.3333333333333333in"
height="0.2222222222222222in"},

![](media/image428.wmf){width="2.4305555555555554in"
height="0.5277777777777778in"} (52)

**10.2 kbit/s mode**

In this case the signal
![](media/image429.wmf){width="0.3194444444444444in"
height="0.2222222222222222in"}, used for presetting the amplitudes, is
given by eq. (50). Having preset the pulse amplitudes, as explained
above, the optimal pulse positions are determined using an efficient
non‑exhaustive analysis‑by‑synthesis search technique. In this
technique, the term in equation (43) is tested for a small percentage of
...
![](media/image422.wmf){width="0.1388888888888889in"
height="0.2222222222222222in"} is the quantized pitch gain of the
previous subframe bounded by \[0.0,0.8\]. Note that prior to the
codebook search, the impulse response
![](media/image430.wmf){width="0.3333333333333333in"
height="0.2222222222222222in"} must include the pre‑filter
![](media/image424.wmf){width="0.4166666666666667in"
height="0.2222222222222222in"}. That is, for values of $T$less than 40,
the impulse $h(n)$is modified according to equation (50a).
...
In this case the
signal![](media/image429.wmf){width="0.3194444444444444in"
height="0.2222222222222222in"}, used for presetting the amplitudes, is
equal to the signal
![](media/image431.wmf){width="0.34652777777777777in"
height="0.2222222222222222in"}. Having preset the pulse amplitudes, as
explained above, the optimal pulse positions are determined using an
efficient non‑exhaustive analysis‑by‑synthesis search technique. In this
technique, the term in equation (43) is tested for a small percentage of
position combinations.
...
height="0.2222222222222222in"}. Having preset the pulse amplitudes, as
explained above, the optimal pulse positions are determined using an
exhaustive analysis‑by‑synthesis search technique.
...
height="0.2222222222222222in"}. Having preset the pulse amplitudes, as
explained above, the optimal pulse positions are determined using an
exhaustive analysis‑by‑synthesis search technique. Note that both
subsets are searched.
...
![](media/image422.wmf){width="0.1388888888888889in"
height="0.2222222222222222in"} is the quantized pitch gain of the
previous subframe for the 5.15 kbit/s mode and the previous odd subframe
for the 4.75 kbit/s mode bounded by \[0.0,0.8\]. Note that prior to the
codebook search, the impulse response
![](media/image430.wmf){width="0.3333333333333333in"
height="0.2222222222222222in"} must include the pre‑filter
![](media/image424.wmf){width="0.4166666666666667in"
...
If the *GpC\_flag* is set, the limited adaptive codebook gain is used in
the gain quantization in clause 5.8.2. The quantization codebook search
range is limited to only include adaptive codebook gain values less than
![](media/image432.wmf){width="0.3611111111111111in"
height="0.2222222222222222in"}. This is performed in the quantization
...
with fixed coefficients. The 4^th^ order MA prediction is performed on
the innovation energy as follows. Let
![](media/image433.wmf){width="0.375in" height="0.2222222222222222in"}
be the mean‑removed innovation energy (in dB) at subframe
![](media/image434.wmf){width="0.1388888888888889in"
height="0.1388888888888889in"}, and given by:

$E(n) = \text{10}\text{log}\left( \frac{1}{N}g_{c}^{2}\sum_{i = 0}^{N - 1}{c^{2}(i)} \right) - \overline{E}$,
(53)

where ![](media/image435.wmf){width="0.4861111111111111in"
height="0.2222222222222222in"} is the subframe size, $c\left( i \right)$
is the fixed codebook excitation, and
![](media/image436.wmf){width="0.18055555555555555in"
height="0.20833333333333334in"} (in dB) is the mean of the innovation
energy. The predicted energy is given by:

![](media/image437.wmf){width="1.3888888888888888in"
height="0.5277777777777778in"}, (54)

where ![](media/image438.wmf){width="2.19375in"
height="0.2638888888888889in"} are the MA prediction coefficients, and
![](media/image439.wmf){width="0.3611111111111111in"
height="0.2361111111111111in"} is the quantified prediction error at
subframe ![](media/image440.wmf){width="0.1388888888888889in"
height="0.18055555555555555in"}. The predicted energy is used to compute
a predicted fixed‑codebook gain
![](media/image441.wmf){width="0.20833333333333334in"
height="0.2222222222222222in"} as in equation (53) (by substituting
![](media/image433.wmf){width="0.375in" height="0.2222222222222222in"}
by ![](media/image442.wmf){width="0.375in"
height="0.2361111111111111in"} and
![](media/image443.wmf){width="0.20833333333333334in"
height="0.2222222222222222in"} by
![](media/image441.wmf){width="0.20833333333333334in"
height="0.2222222222222222in"}). This is done as follows. First, the
mean innovation energy is found by:

![](media/image444.wmf){width="1.7638888888888888in"
height="0.6111111111111112in"} (55)

and then the predicted gain
![](media/image441.wmf){width="0.20833333333333334in"
height="0.2222222222222222in"} is found by:

![](media/image445.wmf){width="1.5277777777777777in"
height="0.3194444444444444in"}. (56)
...
![](media/image446.wmf){width="0.9027777777777778in" height="0.25in"}.
(57)

Note that the prediction error is given by:

![](media/image447.wmf){width="2.263888888888889in"
height="0.2916666666666667in"} (58)

**12.2 kbit/s mode**

The correction factor
![](media/image448.wmf){width="0.2638888888888889in" height="0.25in"} is
computed using a mean energy value,
![](media/image449.wmf){width="0.5277777777777778in"
height="0.20833333333333334in"} dB. The correction factor
![](media/image448.wmf){width="0.2638888888888889in" height="0.25in"} is
quantified using a 5‑bit codebook. The quantization table search is
performed by minimizing the error:

![](media/image450.wmf){width="1.3888888888888888in" height="0.375in"}.
(59)

Once the optimum value
![](media/image451.wmf){width="0.2638888888888889in"
height="0.2638888888888889in"} is chosen, the quantified fixed codebook
gain is given by ![](media/image452.wmf){width="0.7916666666666666in"
height="0.2638888888888889in"}.
...
![](media/image448.wmf){width="0.2638888888888889in" height="0.25in"} is
computed using a mean energy value,
![](media/image453.wmf){width="0.5277777777777778in"
height="0.20833333333333334in"} dB. The adaptive codebook gain
![](media/image454.wmf){width="0.2361111111111111in" height="0.25in"}and
the correction factor
![](media/image448.wmf){width="0.2638888888888889in" height="0.25in"}
are jointly vector quantized using a 7-bit codebook. The gain codebook
search is performed by minimizing equation (63).
...
![](media/image448.wmf){width="0.2638888888888889in" height="0.25in"} is
computed using a mean energy value,
![](media/image455.wmf){width="0.5277777777777778in"
height="0.20833333333333334in"} dB. The same scalar codebooks as for the
12.2 kbit/s mode is used for quantization of the adaptive codebook gain
![](media/image454.wmf){width="0.2361111111111111in" height="0.25in"}
and the correction factor
![](media/image448.wmf){width="0.2638888888888889in" height="0.25in"}.
The search of the codebooks starts with finding 3 candidates for the
adaptive codebook gain. These candidates are the best codebook value in
scalar quantization and the two adjacent codebook values. These 3
candidates are searched together with the correction factor codebook
minimizing the term of equation (63).

An adaptor based on the coding gain in the adaptive codebook decides if
the coding gain is low. If this is the case, the correction factor
codebook is searched once more minimizing a modified criterion in order
to find a new quantized fixed codebook gain. The modified criterion is
given by:

![](media/image456.wmf){width="4.096527777777778in" height="0.375in"}
(60)

where ![](media/image457.wmf){width="0.3333333333333333in"
height="0.2222222222222222in"} and
![](media/image458.wmf){width="0.34652777777777777in"
height="0.2222222222222222in"} are the energy (the squared norm) of the
LP residual and the total excitation, respectively. The criterion is
searched with the already quantized adaptive codebook gain and the
correction factor ![](media/image451.wmf){width="0.2638888888888889in"
height="0.2638888888888889in"} that minimizes (60) is selected. The
balance factor ![](media/image459.wmf){width="0.16666666666666666in"
height="0.1527777777777778in"} decides the amount of energy matching in
the modified criterion. This factor is adaptively decided based on the
coding gain in the adaptive codebook as computed by:

![](media/image460.wmf){width="1.8888888888888888in"
height="0.6388888888888888in"}. (61)
...
detected if the fixed codebook gain in the current subframe is more than
twice the value of the fixed codebook gain in the previous subframe. A
hangover of 8 subframes is used in the onset detection so that the
modified criterion is not used for the next 7 subframes either if an
onset is detected. The balance factor
![](media/image459.wmf){width="0.16666666666666666in"
height="0.1527777777777778in"} is computed from the median filtered
adaptive coding gain. The current and the *ag*-values for the previous 4
subframes are median filtered to get
![](media/image461.wmf){width="0.3194444444444444in"
height="0.2222222222222222in"}. The
![](media/image459.wmf){width="0.16666666666666666in"
height="0.1527777777777778in"}-factor is computed by:

![](media/image462.wmf){width="2.5277777777777777in"
height="0.7916666666666666in"}. (62)

**7.40 kbit/s mode**

The correction factor
![](media/image463.wmf){width="0.2638888888888889in"
height="0.2076388888888889in"} is computed using a mean energy value,
![](media/image464.wmf){width="0.5277777777777778in"
height="0.20833333333333334in"} dB. The adaptive codebook gain
![](media/image454.wmf){width="0.2361111111111111in" height="0.25in"}and
the correction factor
![](media/image465.wmf){width="0.2638888888888889in"
height="0.2076388888888889in"} are jointly vector quantized using a
7-bit codebook. The gain codebook search is performed by minimizing the
square of the weighted error between original and reconstructed speech
which is given by

![](media/image466.wmf){width="5.069444444444445in"
height="0.34652777777777777in"} (63)

where ![](media/image467.wmf){width="0.1388888888888889in"
height="0.1388888888888889in"} is the target vector,
![](media/image468.wmf){width="0.1388888888888889in"
height="0.18055555555555555in"} is the filtered adaptive codebook
vector, and ![](media/image469.wmf){width="0.125in"
...
![](media/image448.wmf){width="0.2638888888888889in" height="0.25in"} is
computed using a mean energy value,
![](media/image470.wmf){width="0.7083333333333334in"
height="0.20833333333333334in"} dB. The adaptive codebook gain
![](media/image454.wmf){width="0.2361111111111111in" height="0.25in"}and
the correction factor
![](media/image448.wmf){width="0.2638888888888889in" height="0.25in"}
...
![](media/image448.wmf){width="0.2638888888888889in" height="0.25in"} is
computed using a mean energy value,
![](media/image471.wmf){width="0.5277777777777778in"
height="0.20833333333333334in"} dB. The adaptive codebook gain
![](media/image454.wmf){width="0.2361111111111111in" height="0.25in"}and
the correction factor
![](media/image448.wmf){width="0.2638888888888889in" height="0.25in"}
are jointly vector quantized using a 6-bit codebook. The gain codebook
search is performed by minimizing equation (63).
...
![](media/image471.wmf){width="0.5277777777777778in"
height="0.20833333333333334in"} dB. The adaptive codebook gains and the
correction factors are jointly vector quantized every 10 ms. This is
done by minimizing a weighted sum of the error criterion (63) for each
of the two subframes. The default values on the weighing factors are 1.
If the energy of the second subframe is more than two times the energy
of the first subframe, the weight of the first subframe is set to 2. If
the energy of the first subframe is more than four times the energy of
the second subframe, the weight of the second subframe is set to 2.

### 5.8.3 Update past quantized adaptive codebook gain buffer (all modes)

After the gain quantization, the buffer with past adaptive codebook
gains is updated, regardless of the value of the *GpC\_flag.* That is,
![](media/image472.wmf){width="2.4166666666666665in" height="0.25in"}.
...
![](media/image473.wmf){width="0.3333333333333333in"
height="0.2222222222222222in"}, in the present subframe is found by:

![](media/image474.wmf){width="2.513888888888889in"
height="0.2638888888888889in"}, (64)

where ![](media/image475.wmf){width="0.2361111111111111in"
height="0.25in"} and
![](media/image476.wmf){width="0.20833333333333334in"
height="0.2222222222222222in"} are the quantified adaptive and fixed
codebook gains, respectively,
![](media/image477.wmf){width="0.3194444444444444in"
height="0.2222222222222222in"} the adaptive codebook vector
(interpolated past excitation), and
![](media/image478.wmf){width="0.3194444444444444in"
height="0.2222222222222222in"} is the fixed codebook vector (algebraic
code including pitch sharpening). The states of the filters can be
updated by filtering the signal
![](media/image479.wmf){width="1.0555555555555556in"
height="0.2222222222222222in"} (difference between residual and
excitation) through the filters
![](media/image480.wmf){width="0.4861111111111111in"
height="0.2638888888888889in"} and
![](media/image481.wmf){width="1.19375in" height="0.2916666666666667in"}
for the 40‑sample subframe and saving the states of the filters. This
would require 3 filterings. A simpler approach which requires only one
filtering is as follows. The local synthesized speech,
![](media/image482.wmf){width="0.3194444444444444in"
height="0.2222222222222222in"}, is computed by filtering the excitation
signal through ![](media/image480.wmf){width="0.4861111111111111in"
height="0.2638888888888889in"}. The output of the filter due to the
input ![](media/image483.wmf){width="1.0555555555555556in"
height="0.2222222222222222in"} is equivalent to
![](media/image484.wmf){width="1.19375in"
height="0.2222222222222222in"}. So the states of the synthesis filter
![](media/image480.wmf){width="0.4861111111111111in"
height="0.2638888888888889in"} are given by
![](media/image485.wmf){width="1.25in" height="0.2361111111111111in"}.
Updating the states of the filter
![](media/image484.wmf){width="1.19375in" height="0.2222222222222222in"}
can be done by filtering the error signal
![](media/image486.wmf){width="0.3194444444444444in"
height="0.2222222222222222in"} through this filter to find the
perceptually weighted error
![](media/image487.wmf){width="0.4305555555555556in"
height="0.2361111111111111in"}. However, the signal
![](media/image487.wmf){width="0.4305555555555556in"
height="0.2361111111111111in"} can be equivalently found by:

![](media/image488.wmf){width="2.125in" height="0.2638888888888889in"},
(65)

Since the signals ![](media/image489.wmf){width="0.3333333333333333in"
height="0.2222222222222222in"},
![](media/image490.wmf){width="0.3333333333333333in"
height="0.2361111111111111in"}, and
![](media/image491.wmf){width="0.3194444444444444in"
height="0.2222222222222222in"} are available, the states of the
weighting filter are updated by computing
![](media/image487.wmf){width="0.4305555555555556in"
height="0.2361111111111111in"} as in equation (65) for
![](media/image492.wmf){width="0.875in" height="0.20833333333333334in"}.
This saves two filterings.

**4.75 kbit/s mode**

The memory update in the first and third subframes use the unquantized
gains in equation (64). After the second and fourth subframes
respectively, when the gains are quantized, the state is recalculated
using the quantized gains.
...
quantization are used to reconstruct the quantified LSP vectors. The
...
coefficient domain ![](media/image493.wmf){width="0.20833333333333334in"
...
![](media/image494.wmf){width="0.3194444444444444in"
height="0.2222222222222222in"} is found by interpolating the past
excitation ![](media/image495.wmf){width="0.3333333333333333in"
height="0.2222222222222222in"} (at the pitch delay) using the FIR filter
described in clause 5.6.

2\) **Decoding of the innovative codebook vector:** The received
algebraic codebook index is used to extract the positions and amplitudes
(signs) of the excitation pulses and to find the algebraic codevector
![](media/image496.wmf){width="0.3194444444444444in"
height="0.2222222222222222in"}. If the integer part of the pitch lag,
*T*, is less than the subframe size 40, the pitch sharpening procedure
is applied which translates into modifying
![](media/image496.wmf){width="0.3194444444444444in"
height="0.2222222222222222in"} by
![](media/image497.wmf){width="1.5555555555555556in"
height="0.2361111111111111in"}, where
![](media/image498.wmf){width="0.1388888888888889in"
height="0.2222222222222222in"} is the decoded pitch gain,
![](media/image499.wmf){width="0.2361111111111111in" height="0.25in"},
bounded by \[0.0,1.0\] or \[0.0,0.8\], depending on mode.

3\) **Decoding of the adaptive and fixed codebook gains:** In case of
scalar quantization of the gains (12.2 kbit/s and 7.95 kbit/s modes) the
received indices are used to readily find the quantified adaptive
codebook gain, ![](media/image499.wmf){width="0.2361111111111111in"
height="0.25in"}, and the quantified fixed codebook gain correction
factor, ![](media/image500.wmf){width="0.2638888888888889in"
height="0.2638888888888889in"}, from the corresponding quantization
tables. In case of vector quantization of the gains (all other modes),
the received index gives both the quantified adaptive codebook gain,
![](media/image499.wmf){width="0.2361111111111111in" height="0.25in"},
and the quantified fixed codebook gain correction factor,
${\hat{g}}_{\text{gc}}$. The estimated fixed codebook gain $g_{c}^{'}$
is found as described in clause 5.7. First, the predicted energy is
found by:

![](media/image501.wmf){width="1.3888888888888888in"
height="0.5277777777777778in"} (66)

and then the mean innovation energy is found by:

![](media/image502.wmf){width="1.7222222222222223in"
height="0.6111111111111112in"}. (67)

The predicted gain ![](media/image503.wmf){width="0.20833333333333334in"
height="0.2222222222222222in"} is found by:

![](media/image504.wmf){width="1.5277777777777777in"
height="0.3194444444444444in"}. (68)

The quantified fixed codebook gain is given by:

![](media/image505.wmf){width="0.7916666666666666in" height="0.25in"}.
(69)

4\) **Smoothing of the fixed codebook gain (10.2, 6.70, 5.90, 5.15, 4.75
kbit/s modes):** An adaptive smoothing of the fixed codebook gain is
performed to avoid unnatural fluctuations in the energy contour. The
smoothing is based on a measure of the stationarity of the short-term
spectrum in the **q** domain. The smoothing strength is computed from
this measure. An averaged **q**-value is computed for each frame *n* by:

![](media/image506.wmf){width="2.2916666666666665in"
height="0.2361111111111111in"}. (70)

For each subframe *m*, a difference measure between the averaged vector
and the quantized and interpolated vector is computed by:

![](media/image507.wmf){width="2.1805555555555554in"
height="0.5965277777777778in"}, (71)

where *j* runs over the 10 LSPs. Furthermore, a smoothing
factor,![](media/image508.wmf){width="0.2361111111111111in"
height="0.2222222222222222in"}, is computed by:

![](media/image509.wmf){width="2.611111111111111in"
height="0.3194444444444444in"}, (72)

where the constants are set to
![](media/image510.wmf){width="0.6111111111111112in"
height="0.2222222222222222in"} and
![](media/image511.wmf){width="0.7083333333333334in"
height="0.2222222222222222in"}. A hangover period of 40 subframes is
used where the ![](media/image512.wmf){width="0.2361111111111111in"
height="0.2222222222222222in"}-value is set 1.0 if the
![](media/image513.wmf){width="0.375in" height="0.2222222222222222in"}
has been above 0.65 for 10 consecutive frames. A value of 1.0
corresponds to no smoothing. An averaged fixed codebook gain value is
computed for each subframe by:

![](media/image514.wmf){width="0.125in"
height="0.2222222222222222in"}![](media/image515.wmf){width="1.5in"
height="0.5277777777777778in"}. (73)

The fixed codebook gain used for synthesis is now replaced by a smoothed
value given by:

![](media/image516.wmf){width="1.8194444444444444in"
height="0.2916666666666667in"}. (74)

5\) **Anti-sparseness processing (7.95, 6.70, 5.90, 5.15, 4.75 kbit/s
modes):** An adaptive anti-sparseness post-processing procedure is
applied to the fixed codebook vector
![](media/image517.wmf){width="0.3194444444444444in"
height="0.2222222222222222in"}in order to reduce perceptual artefacts
...
number ![](media/image518.wmf){width="0.9583333333333334in"
height="0.20833333333333334in"} is set to select one of them. A value of
2 corresponds to no modification, a value of 1 corresponds to medium
...
> ![](media/image519.wmf){width="1.3888888888888888in"
> height="1.4861111111111112in"}

Detect onset by comparing the fixed codebook gain to the previous fixed
codebook gain. If the current value is more than twice the previous
value an onset is detected.

If not onset and ![](media/image520.wmf){width="0.7361111111111112in"
height="0.20833333333333334in"}, the median filtered value of the
current and the previous 4 adaptive codebook gains are computed. If this
value is less than 0.6,
![](media/image520.wmf){width="0.7361111111111112in"
height="0.20833333333333334in"}.

If not onset, the ![](media/image521.wmf){width="0.4861111111111111in"
height="0.20833333333333334in"}-value is restricted to increase by one
step from the previous subframe.

If an onset is declared, the
![](media/image521.wmf){width="0.4861111111111111in"
height="0.20833333333333334in"}-value is increased by one if it is less
than 2.

6\) **Computing the reconstructed speech:** The excitation at the input
of the synthesis filter is given by:

![](media/image522.wmf){width="1.5694444444444444in"
height="0.2638888888888889in"}. (75)
...
![](media/image523.wmf){width="3.8465277777777778in"
height="0.8055555555555556in"} (76)

Adaptive gain control (AGC) is used to compensate for the gain
difference between the non‑emphasized excitation
![](media/image524.wmf){width="0.3333333333333333in"
height="0.2361111111111111in"} and emphasized excitation
![](media/image108.wmf){width="0.3333333333333333in"
height="0.2361111111111111in"} The gain scaling factor *η* for the
emphasized excitation is computed by:

![](media/image525.wmf){width="2.1527777777777777in"
height="0.9722222222222222in"} (77)

The gain‑scaled emphasized excitation signal
${\hat{u}}^{'}\left( n \right)$ is given by:

![](media/image526.wmf){width="0.94375in"
height="0.2361111111111111in"}. (78)

The reconstructed speech for the subframe of size 40 is given by:

![](media/image527.wmf){width="2.763888888888889in"
height="0.5277777777777778in"}. (79)

where ${\hat{a}}_{i}$ are the interpolated LP filter coefficients.

7\) **Additional instability protection**: An additional instability
protection is implemented in the speech decoder which is monitoring
overflows in the synthesis filter. If an overflow has occurred in the
synthesis part, the whole adaptive codebook memory,
$v(n),n\text{=-}(\text{143} + \text{11}),\text{.}\text{.}\text{.},\text{39}$
is scaled down by a factor of 4, and the synthesis filtering is repeated
using this down-scaled memory. I.e. in this case step 6) is repeated,
except that the post-processing in (76) - (78) of the excitation signal
is by-passed.

The synthesized speech
![](media/image528.wmf){width="0.3194444444444444in"
height="0.2361111111111111in"} is then passed through an adaptive
...
The adaptive postfilter is the cascade of two filters: a formant
...
![](media/image529.wmf){width="1.2361111111111112in"
height="0.5555555555555556in"} (80)

where ![](media/image530.wmf){width="0.3611111111111111in"
height="0.2638888888888889in"} is the received quantified (and
interpolated) LP inverse filter (LP analysis is not performed at the
decoder), and the factors
![](media/image16.wmf){width="0.2222222222222222in"
height="0.2361111111111111in"} and
![](media/image531.wmf){width="0.2222222222222222in"
height="0.2361111111111111in"} control the amount of the formant
post‑filtering.

Finally, the filter ![](media/image532.wmf){width="0.4305555555555556in"
height="0.2361111111111111in"} compensates for the tilt in the formant
postfilter ![](media/image533.wmf){width="0.4861111111111111in"
height="0.2638888888888889in"} and is given by:

![](media/image534.wmf){width="1.1388888888888888in"
height="0.2777777777777778in"} (81)

where ![](media/image535.wmf){width="0.625in"
height="0.2222222222222222in"} is a tilt factor, with
![](media/image536.wmf){width="0.19375in" height="0.2222222222222222in"}
being the first reflection coefficient calculated on the truncated
(![](media/image537.wmf){width="0.5833333333333334in"
height="0.2222222222222222in"}) impulse response,
![](media/image538.wmf){width="0.4305555555555556in"
height="0.2638888888888889in"}, of the filter
![](media/image539.wmf){width="1.2222222222222223in"
height="0.2777777777777778in"}.
![](media/image536.wmf){width="0.19375in" height="0.2222222222222222in"}
is given by:

![](media/image540.wmf){width="2.7083333333333335in"
height="0.5694444444444444in"}. (82)

The post‑filtering process is performed as follows. First, the
synthesized speech ![](media/image528.wmf){width="0.3194444444444444in"
height="0.2361111111111111in"} is inverse filtered through
![](media/image541.wmf){width="0.5965277777777778in"
height="0.2916666666666667in"} to produce the residual signal
![](media/image542.wmf){width="0.3194444444444444in"
height="0.2222222222222222in"}. The signal
![](media/image542.wmf){width="0.3194444444444444in"
height="0.2222222222222222in"} is filtered by the synthesis filter
![](media/image543.wmf){width="0.7361111111111112in"
height="0.2777777777777778in"}. Finally, the signal at the output of the
synthesis filter ![](media/image543.wmf){width="0.7361111111111112in"
height="0.2777777777777778in"} is passed to the tilt compensation filter
![](media/image544.wmf){width="0.44375in" height="0.2361111111111111in"}
resulting in the post‑filtered speech signal
![](media/image545.wmf){width="0.4305555555555556in"
height="0.2638888888888889in"}.

Adaptive gain control (AGC) is used to compensate for the gain
difference between the synthesized speech signal
![](media/image528.wmf){width="0.3194444444444444in"
height="0.2361111111111111in"} and the post‑filtered signal
![](media/image545.wmf){width="0.4305555555555556in"
height="0.2638888888888889in"}. The gain scaling factor
![](media/image546.wmf){width="0.2638888888888889in"
height="0.2361111111111111in"} for the present subframe is computed by:

![](media/image547.wmf){width="1.2083333333333333in"
height="1.0833333333333333in"}. (83)

The gain‑scaled post‑filtered signal
![](media/image548.wmf){width="0.375in" height="0.2222222222222222in"}
is given by:

![](media/image549.wmf){width="1.3465277777777778in"
height="0.2638888888888889in"} (84)

where $\beta_{\text{sc}}(n)$ is updated in sample‑by‑sample basis and
given by:

![](media/image550.wmf){width="2.2222222222222223in"
height="0.2361111111111111in"} (85)
...
![](media/image551.wmf){width="0.5965277777777778in"
height="0.2361111111111111in"},
![](media/image552.wmf){width="0.69375in" height="0.2361111111111111in"}
and

![](media/image553.wmf){width="1.5277777777777777in"
height="0.5138888888888888in"}. (86)

**7.95, 7.40, 6.70, 5.90, 5.15, 4.75 kbit/s modes**

The adaptive post‑filtering factors are given by:
![](media/image554.wmf){width="0.6527777777777778in"
height="0.2222222222222222in"},
![](media/image555.wmf){width="0.5965277777777778in"
height="0.2222222222222222in"} and
![](media/image556.wmf){width="0.5555555555555556in"
height="0.2222222222222222in"}.

### 6.2.2 High-pass filtering and up-scaling (all modes)

The high-pass filter serves as a precaution against undesired low
frequency components. A filter cut-off frequency of 60 Hz is used, and
the filter is given by

![](media/image557.wmf){width="4.0in" height="0.4583333333333333in"}.
(87)
...
The detailed allocation of the bits in the adaptive multi-rate speech
encoder is shown for each mode in table 9a-9h. These tables show the
order of the bits produced by the speech encoder. Note that the most
significant bit (MSB) of each codec parameter is always sent first.

Table 9a: Source encoder output parameters in order of occurrence and
bit allocation within the speech frame of 244 bits/20 ms, 12.2 kbit/s
mode.
...
Table 9b: Source encoder output parameters in order of occurrence and
bit allocation within the speech frame of 204 bits/20 ms, 10.2 kbit/s
mode.

  ---------------- ---------------------------------------------
  Bits (MSB‑LSB)   Description
  s1 -- s8         index of 1^st^ LSF subvector
  s9 ‑ s17         index of 2^nd^ LSF subvector
  s18 -- s26       index of 3^rd^ LSF subvector
  subframe 1       
  s27 -- s34       adaptive codebook index
  s35              sign information for 1^st^ and 5^th^ pulses
  s36              sign information for 2^nd^ and 6^th^ pulses
  s37              sign information for 3^rd^ and 7^th^ pulses
  s38              sign information for 4^th^ and 8^th^ pulses
  s39-s48          position for 1^st^, 2^nd^, and 5^th^ pulses
  s49-s58          position for 3^rd^, 6^th^, and 7^th^ pulses
  s59-s65          position for 4^th^ and 8^th^ pulses
...
Table 9c: Source encoder output parameters in order of occurrence and
bit allocation within the speech frame of 159 bits/20 ms, 7.95 kbit/s
mode.

  ---------------- ------------------------------------
  Bits (MSB‑LSB)   Description
  s1 -- s9         index of 1^st^ LSF subvector
  s10 ‑ s18        index of 2^nd^ LSF subvector
  s19 -- s27       index of 3^rd^ LSF subvector
  subframe 1       
  s28 -- s35       adaptive codebook index
  s36 -- s39       position of 4^th^ pulse
  s40 -- s42       position of 3^rd^ pulse
  s43 -- s45       position of 2^nd^ pulse
  s46 -- s48       position of 1^st^ pulse
  s49              sign information for 4^th^ pulse
  s50              sign information for 3^rd^ pulse
  s51              sign information for 2^nd^ pulse
  s52              sign information for 1^st^ pulse
...
Table 9d: Source encoder output parameters in order of occurrence and
bit allocation within the speech frame of 148 bits/20 ms, 7.40 kbit/s
mode.
  ...
  subframe 1       
  s27 -- s34       adaptive codebook index
  s35 -- s38       position of 4^th^ pulse
  s39 -- s41       position of 3^rd^ pulse
  s42 - s44        position of 2^nd^ pulse
  s45 -- s47       position of 1^st^ pulse
  s48              sign information for 4^th^ pulse
  s49              sign information for 3^rd^ pulse
  s50              sign information for 2ndd pulse
  s51              sign information for 1^st^ pulse
...
Table 9e: Source encoder output parameters in order of occurrence and
bit allocation within the speech frame of 134 bits/20 ms, 6.70 kbit/s
mode.
  ...
  subframe 1       
  s27 -- s34       adaptive codebook index
  s35 -- s38       position of 3^rd^ pulse
  s39 -- s42       position of 2^nd^ pulse
  s43 -- s45       position of 1^st^ pulse
  s46              sign information for 3^rd^ pulse
  s47              sign information for 2^nd^ pulse
  s48              sign information for 1^st^ pulse
...
Table 9f: Source encoder output parameters in order of occurrence and
bit allocation within the speech frame of 118 bits/20 ms, 5.90 kbit/s
mode.
  ...
  subframe 1       
  s27 -- s34       adaptive codebook index
  s35 -- s39       position of 2^nd^ pulse
  s40 -- s43       position of 1^st^ pulse
  s44              sign information for 2^nd^ pulse
  s45              sign information for 1^st^ pulse
...
Table 9g: Source encoder output parameters in order of occurrence and
bit allocation within the speech frame of 103 bits/20 ms, 5.15 kbit/s
mode.
  ...
  s32              position subset
  s33 -- s35       position of 2^nd^ pulse
  s36 -- s38       position of 1^st^ pulse
  s39              sign information for 2^nd^ pulse
  s40              sign information for 1^st^ pulse
...
Table 9h: Source encoder output parameters in order of occurrence and
bit allocation within the speech frame of 95 bits/20 ms, 4.75 kbit/s
mode.
...
purposes of the adaptive multi-rate speech codec.
...
the first homing frame is therefore dependent on the used codec mode and
the codec state when receiving that frame and hence usually not known.
The response of the encoder to any further homing frame is by definition
the corresponding decoder homing frame for the used codec mode. The
response of the decoder to any further homing frame is by definition the
encoder homing frame. This procedure allows homing of both, the encoder
...
**Decoder homing frame:** There exist eight different decoder homing
frames, which correspond to the eight AMR codec modes. Using one of
...
4\) F.K. Soong and B.H. Juang, \"Line spectrum pair (LSP) and speech
data compression\", in *Proc. ICASSP\'84*, pp. 1.10.1‑1.10.4.
...
sparse-excitation artefacts in CELP\", in *Proc. ICASSP'98*, pp.
I-145‑I-148.
...
######## Annex A (informative): Change history
  ...
  **Tdoc**             **SPEC**     **CR**         **REV**   **VERS**   **SUBJECT**                                                                             **CAT**   **NEW\_VERS**
  SP-99570             26.090       A001                     3.0.1      Bit allocation of the adaptive multi-rate codec                                         F         3.1.0
  **Change history**                                                                                                                                                      
  **Date**             **TSG \#**   **TSG Doc.**   **CR**    **Rev**    **Subject/Comment**                                                                     **Old**   **New**
  ...
  06-2009              44           SP-090249      0002      1          Corrections to Quantization of codebook gains in sub-clause 5.8.2                       8.0.0     8.1.0
  06-2009              44           SP-090249      0003      1          Correction to recursive equation for the past filtered excitation in sub-clause 5.6.1   8.0.0     8.1.0
  12-2009              46                                               Version for Release 9                                                                   8.1.0     9.0.0
  03-2011              51                                               Version for Release 10                                                                  9.0.0     10.0.0
  09-2011              53           SP-110548      0007      1          Correction of equation for pitch sharpening                                             10.0.0    10.1.0
