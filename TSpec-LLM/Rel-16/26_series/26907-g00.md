...
Encrypted Media Extensions (EME) \[20\] aim at leveraging pre-installed
...
\- XHTML Image module: defines the \"img\" element to enable embedding
...
Another approach is to describe the DOM updates in a separate document
