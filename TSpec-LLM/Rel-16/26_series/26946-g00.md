...
[22](#service-discoveryannouncement)
...
Forward Error Correction performance A.1 Theoretical performance A.2
...
\[15\] IETF RFC 2357 (June 1998): \"IETF Criteria for Evaluating
...
Figure 2 gives an overview of functions for MBMS user services based on
...
The \"MBMS User Service Receiver\" combines the reception via the MBMS
...
Users of the download-based MBMS User Service are not required to
...
After the data transmission phase the MBMS User Service Receiver may
...
The MBMS Identity field can be used by the BM-SC and terminal to
...
Output of the MBMS User Service Receiver is in case of the MBMS
...
The following recommendations are given to MBMS encoders and packetizers
...
| 28.8 kbit/s              |                    |                    |
+--------------------------+--------------------+--------------------+
| Medium Bitrate (MCS-6)   | 5 s: 51.1kbit/s    | 5 s: 50.4 kbit/s   |
|                          |                    |                    |
| (0.5 % BLER)             | 20 s: 54.6 kbit/s  | 20 s: 54.2 kbit/s  |
|                          |                    |                    |
| 59.2 kbit/s              |                    |                    |
+--------------------------+--------------------+--------------------+
| High Bitrate (MCS-9)     | 5 s: 99.5 kbit/s   | 5 s: 98.2 kbit/s   |
|                          |                    |                    |
| (1 % BLER)               | 20 s: 104.5 kbit/s | 20 s: 104.2 kbit/s |
|                          |                    |                    |
| 118.4 kbit/s             |                    |                    |
+--------------------------+--------------------+--------------------+
| High Bitrate and High    | 5 s: 66.5 kbit/s   | 5 s: 66.4 kbit/s   |
| Error Rate (MCS-6)       |                    |                    |
|                          | 20 s: 72.5kbit/s   | 20 s: 72.3 kbit/s  |
| 10 % BLER, 146 byte      |                    |                    |
| packet payloads          |                    |                    |
|                          |                    |                    |
| 118.4 kbit/s             |                    |                    |
...
######### Annex B: Change history
  ...
  **Date**             **TSG \#**   **TSG Doc.**   **CR**   **Rev**   **Subject/Comment**                                                     **Old**   **New**
  ...
  2014-09              65                                             Version for Release 12                                                  11.2.0    12.0.0
  2014-12              66           SP-140732      0006     1         Guidelines on MBMS Client to DASH Client Communication                  12.0.0    12.1.0
  2014-12              66           SP-140732      0007     1         Proxy-based Interaction between MBMS Client and DASH Client             12.0.0    12.1.0
  2015-03              67           SP-150091      0008     1         AvailabilityTimeOffset cardinality                                      12.1.0    12.2.0
  2015-03              67           SP-150091      0009     1         MBMS Guidelines Release 12 update                                       12.1.0    12.2.0
  2015-09              69           SP-150449      0014     3         Partial File Handling                                                   12.2.0    13.0.0
  -------------------- ------------ -------------- -------- --------- ----------------------------------------------------------------------- --------- ---------
  ...
  **Date**             **Meeting**   **TDoc**    **CR**   **Rev**   **Cat**   **Subject/Comment**                             **New version**
  ...
  2018-06              80            SP-180272   0015     \-        B         Support for SAND for MBMS                       15.0.0
