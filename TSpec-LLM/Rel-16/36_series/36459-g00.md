...
9.3.3 Elementary Procedure Definitions 9.3.4 PDU Definitions 9.3.5
...
The E-SMLC initiates the procedure by sending a MEASUREMENT ABORT
message.
...
The ASN.1 definition specifies the structure and content of SLmAP
...
UL-RTOAMeasurements ::= SEQUENCE (SIZE (1.. maxNoULRTOA)) OF
UL-RTOAMeasurement
...
ListOfRfBands ::= SEQUENCE (SIZE (1.. maxNoLMURfBands)) OF
FreqBandIndicator
...
SupportedBandwidthCombinationSet ::= SEQUENCE (SIZE (1.. maxBWCombSet))
OF
...
ProtocolIE-FieldPair { SLMAP-PROTOCOL-IES-PAIR : IEsSetParam} ::=
SEQUENCE {
...
SLMAP-PROTOCOL-IES : IEsSetParam} ::=
...
upperBound, SLMAP-PROTOCOL-IES-PAIR : IEsSetParam} ::=
...
ProtocolExtensionContainer { SLMAP-PROTOCOL-EXTENSION :
ExtensionSetParam} ::=
...
criticality SLMAP-PROTOCOL-EXTENSION.&criticality
({ExtensionSetParam}{\@id}),

extensionValue SLMAP-PROTOCOL-EXTENSION.&Extension
({ExtensionSetParam}{\@id})
...
SLmAP shall use the ASN.1 Basic Packed Encoding Rules (BASIC-PER)
...
Section 10 of TS 36.413 \[7\] is applicable for the purposes of the
...
groups, the *SLmAP* *Transaction ID* IE shall also be included;

\- In case of Logical Error, when reporting the *Criticality
Diagnostics* IE, the *SLmAP* *Transaction ID* IE shall also be included.
...
######## Annex A (informative): Change history
  ...
  2012-12          58       RP-121769                    Approved in RAN\#58 and put under change control                          11.0.0
  2013-03          59       RP-130209     0001     \-    Correction on Setup and Reset                                             11.1.0
  2013-03          59       RP-130237     0002     1     Extending maxEARFCN                                                       11.1.0
  *2013-03*        *59*     *RP-130209*   *0003*   *1*   *NBPS in LTE, UL RTOA Measurement Configuration in Measurement Request*   *11.1.0*
  *2013-03*        *59*     *RP-130316*   *0004*   *-*   *NBPS in LTE, Identifier for SLmAP*                                       *11.1.0*
  *2013-06*        *60*     *RP-130642*   *0005*   *3*   *Abnormal Conditions for Reset*                                           *11.2.0*
  *2013-09*        *61*     *RP-131182*   *0006*   *1*   *Correction on Measurement Abort*                                         *11.3.0*
  *2013-09*        *61*     *RP-131182*   *0007*   *1*   *Correction on Measurement Update*                                        *11.3.0*
  *2013-09*        *61*     *RP-131182*   *0008*   *1*   *ASN.1 correction Section 9.3.5 UL-RTOA Measurement Configuration*        *11.3.0*
  *2014-09*                                              Update to Rel-12 version (MCC)                                            *12.0.0*
  *2015-03*        *67*     *RP-150356*   *0009*   *-*   Correction of Error Indication                                            *12.1.0*
  *2015-12*                                              Update to Rel-13 version (MCC)                                            *13.0.0*
  *2016-03*        *71*     *RP-160449*   *0010*   *-*   Correction of tabular for Procedure Code in the Message Type IE           *13.1.0*
  ---------------- -------- ------------- -------- ----- ------------------------------------------------------------------------- ----------
